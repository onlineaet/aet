...
private:
  ...
  void merge_clobber_groups (clobber_info *, clobber_info *,
              def_info *);
  std::array<clobber_group *, 2> split_clobber_group (clobber_group *, insn_info *);
  ...
  HardRegSet/*!HARD_REG_SET*/ m_clobbered_by_calls;
};
...
void dump (FILE *, const mtcs_rtl_ssa::function_info *);

void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::function_info *);
