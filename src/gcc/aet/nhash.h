...
nboolean    n_hash_table_insert            (NHashTable     *hash_table,
                                            npointer        key,
                                            npointer        value);
nboolean    n_hash_table_replace           (NHashTable     *hash_table,  npointer key, npointer value);

nboolean    n_hash_table_add               (NHashTable     *hash_table, npointer key);
...
nboolean    n_hash_table_steal_extended    (NHashTable     *hash_table, nconstpointer lookup_key,npointer  *stolen_key, npointer *stolen_value);

void        n_hash_table_steal_all         (NHashTable     *hash_table);

npointer    n_hash_table_lookup            (NHashTable     *hash_table,nconstpointer key);

npointer    n_hash_table_lookup_by_hash    (NHashTable *hash_table,nconstpointer key,nuint hash);


nboolean    n_hash_table_contains          (NHashTable     *hash_table,nconstpointer   key);

nboolean    n_hash_table_lookup_extended   (NHashTable     *hash_table,nconstpointer lookup_key,npointer *orin_key,npointer *value);
