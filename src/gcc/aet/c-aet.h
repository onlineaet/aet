...
void c_aet_set_ctor(tree dest,tree ctor,tree sysClassName,location_t loc,tree mtcsPlatType);
tree c_aet_get_ctor_codes(tree dest);
location_t c_aet_get_ctor_location(tree dest);
tree c_aet_get_mtcs_plat_type(tree dest);
...
#define AET_LANG_FLAG_0(NODE)  (TREE_NOT_CHECK2 (NODE, TREE_VEC, SSA_NAME)->base.u.bits.lang_flag_0)
#define AET_LANG_FLAG_1(NODE)  (TREE_NOT_CHECK2 (NODE, TREE_VEC, SSA_NAME)->base.u.bits.lang_flag_1)
#define AET_LANG_FLAG_2(NODE)  (TREE_NOT_CHECK2 (NODE, TREE_VEC, SSA_NAME)->base.u.bits.lang_flag_2)
#define AET_LANG_FLAG_3(NODE)  (TREE_NOT_CHECK2 (NODE, TREE_VEC, SSA_NAME)->base.u.bits.lang_flag_3)
#define AET_LANG_FLAG_4(NODE)  (TREE_NOT_CHECK2 (NODE, TREE_VEC, SSA_NAME)->base.u.bits.lang_flag_4)
#define AET_LANG_FLAG_5(NODE)  (TREE_NOT_CHECK2 (NODE, TREE_VEC, SSA_NAME)->base.u.bits.lang_flag_5)
#define AET_LANG_FLAG_6(NODE)  (TREE_NOT_CHECK2 (NODE, TREE_VEC, SSA_NAME)->base.u.bits.lang_flag_6)
