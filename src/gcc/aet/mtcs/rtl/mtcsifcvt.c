...
/* Forward references.  */
static int count_bb_insns (MtcsIfcvt *self,const_basic_block);
static bool cheap_bb_rtx_cost_p (MtcsIfcvt *self,const_basic_block, profile_probability, int);
static rtx_insn *first_active_insn (MtcsIfcvt *self,basic_block);
static rtx_insn *last_active_insn (MtcsIfcvt *self,basic_block, bool);
static rtx_insn *find_active_insn_before (MtcsIfcvt *self,basic_block, rtx_insn *);
static rtx_insn *find_active_insn_after (MtcsIfcvt *self,basic_block, rtx_insn *);
static basic_block block_fallthru (MtcsIfcvt *self,basic_block);
static rtx cond_exec_get_condition (MtcsIfcvt *self,rtx_insn *, bool);
static rtx noce_get_condition (MtcsIfcvt *self,rtx_insn *, rtx_insn **, bool);
static bool noce_operand_ok (MtcsIfcvt *self,const_rtx);
static void merge_if_block (MtcsIfcvt *self,ce_if_block *);
static bool find_cond_trap (MtcsIfcvt *self,basic_block, edge, edge);
static basic_block find_if_header (MtcsIfcvt *self,basic_block, int);
static int block_jumps_and_fallthru (MtcsIfcvt *self,basic_block, basic_block);
static bool noce_find_if_block (MtcsIfcvt *self,basic_block, edge, edge, int);
static bool cond_exec_find_if_block (MtcsIfcvt *self,ce_if_block *);
static bool find_if_case_1 (MtcsIfcvt *self,basic_block, edge, edge);
static bool find_if_case_2 (MtcsIfcvt *self,basic_block, edge, edge);
static bool dead_or_predicable (MtcsIfcvt *self,basic_block, basic_block, basic_block,
            edge, bool);
static void noce_emit_move_insn (MtcsIfcvt *self,rtx, rtx);
static rtx_insn *block_has_only_trap (MtcsIfcvt *self,basic_block);
static void need_cmov_or_rewire (MtcsIfcvt *self,basic_block, hash_set<rtx_insn *> *,
             hash_map<rtx_insn *, int> *);
static bool noce_convert_multiple_sets_1 (MtcsIfcvt *self,struct noce_if_info *,
                 hash_set<rtx_insn *> *,
                 hash_map<rtx_insn *, int> *,
                 auto_vec<rtx> *,
                 auto_vec<rtx> *,
...
static int count_bb_insns (MtcsIfcvt *self,const_basic_block bb)
{
   int count = 0;
...
static bool cheap_bb_rtx_cost_p (MtcsIfcvt *self,const_basic_block bb, profile_probability prob, int max_cost)
{
   ...
   int scale = prob.initialized_p () ? prob.to_reg_br_prob_base () : REG_BR_PROB_BASE;
   ...
   if (!optimize_function_for_speed_p (cfun) && self->ifcvt_after_combine)
   ...
   while (1){
      if (NONJUMP_INSN_P (insn)){
         int cost = mtcs_rtlanal_insn_cost/*!insn_cost*/(mtcsRtlanal,insn, speed) * REG_BR_PROB_BASE;
         if (cost == 0)
            return false;
...
#define FIRST_STACK_REG 0
#define LAST_STACK_REG  0
...
static rtx_insn *first_active_insn (MtcsIfcvt *self,basic_block bb)
{
   rtx_insn *insn = BB_HEAD (bb);
   if (LABEL_P (insn)){
      if (insn == BB_END (bb))
...
static rtx_insn *last_active_insn (MtcsIfcvt *self,basic_block bb, bool skip_use_p)
{
   ...
   || JUMP_P (insn)
   || DEBUG_INSN_P (insn)
   || (skip_use_p   && NONJUMP_INSN_P (insn)  && GET_CODE (PATTERN (insn)) == USE)) {
      if (insn == head)
         return NULL;
      insn = PREV_INSN (insn);
   }
...
static rtx_insn *find_active_insn_before (MtcsIfcvt *self,basic_block curr_bb, rtx_insn *insn)
{
...
static rtx_insn *find_active_insn_after (MtcsIfcvt *self,basic_block curr_bb, rtx_insn *insn)
{
...
static basic_block block_fallthru (MtcsIfcvt *self,basic_block bb)
{
...
static bool rtx_interchangeable_p (MtcsIfcvt *self,const_rtx a, const_rtx b)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   ...
   memory attributes.  */
   return mem_attrs_eq_p (mtcs_rtl_get_mem_attrs/*!get_mem_attrs*/(mtcsRTL,a),
         mtcs_rtl_get_mem_attrs/*!get_mem_attrs*/(mtcsRTL,b));
}

/* Go through a bunch of insns, converting them to conditional
   execution format if possible.  Return TRUE if all of the non-note
   insns were processed.  */
static bool cond_exec_process_insns (MtcsIfcvt *self,ce_if_block *ce_info ATTRIBUTE_UNUSED,
          ...
          /* probability of branch taken. */bool mod_ok)
{
   ...
   for (insn = start; ; insn = NEXT_INSN (insn)){
      ...
      if (mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,test, insn)){
         if (!mod_ok)
            return false;
         must_be_last = true;
      }
      ...
      if (GET_CODE (pattern) == COND_EXEC){
         ...
         xtest = gen_rtx_AND (GET_MODE (xtest), xtest, COND_EXEC_TEST (pattern));
      ...
      register, do so here.  */
#ifdef IFCVT_MODIFY_INSN //host =0 nvptx=0
      IFCVT_MODIFY_INSN (ce_info, pattern, insn);
      if (! pattern)
         return false;
#endif
      mtcs_recog_validate_change/*!validate_change*/(mtcsRecog,insn, &PATTERN (insn), pattern, 1);
      if (CALL_P (insn) && prob_val.initialized_p ())
         mtcs_recog_validate_change/*!validate_change*/(mtcsRecog,insn, &REG_NOTES (insn),
               gen_rtx_INT_LIST ((machine_mode) REG_BR_PROB, prob_val.to_reg_br_prob_note (), REG_NOTES (insn)), 1);
...
static rtx cond_exec_get_condition (MtcsIfcvt *self,rtx_insn *jump, bool get_reversed = false)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   ...
   && label_ref_label (XEXP (test_if, 2)) == JUMP_LABEL (jump))){
      enum rtx_code rev = mtcs_dojump_reversed_comparison_code/*!reversed_comparison_code*/(mtcsDojump,cond, jump);
      if (rev == UNKNOWN)
         return NULL_RTX;
      cond = gen_rtx_fmt_ee (rev, GET_MODE (cond), XEXP (cond, 0), XEXP (cond, 1));
   }
...
static bool cond_exec_process_if_block (MtcsIfcvt *self,ce_if_block * ce_info,
             /* if block information */bool do_multiple_p)
{
   ...
   the test.  */
   test_expr = cond_exec_get_condition(self,BB_END (test_bb));
   if (! test_expr)
      return false;
   ...
   then_start = first_active_insn(self,then_bb);
   then_end = last_active_insn(self,then_bb, true);
   then_n_insns = ce_info->num_then_insns = count_bb_insns(self,then_bb);
   ...
   if (else_bb){
      ...
      max *= 2;
      else_start = first_active_insn(self,else_bb);
      else_end = last_active_insn(self,else_bb, true);
      else_n_insns = ce_info->num_else_insns = count_bb_insns(self,else_bb);
      ...
      n_matching = mtcs_cfg_cleanup_flow_find_cross_jump/*!flow_find_cross_jump*/(mtcsCfgCleanup,
            then_bb, else_bb,&then_first_tail, &else_first_tail,NULL);
      ...
      if (n_matching > 0){
         if (then_end)
            then_end = find_active_insn_before(self,then_bb, then_first_tail);
         if (else_end)
            else_end = find_active_insn_before(self,else_bb, else_first_tail);
         n_insns -= 2 * n_matching;
      }

      if (then_start  && else_start && then_n_insns > n_matching  && else_n_insns > n_matching){
         int longest_match = MIN (then_n_insns - n_matching,else_n_insns - n_matching);
         n_matching = mtcs_cfg_cleanup_flow_find_head_matching_sequence/*!flow_find_head_matching_sequence*/(mtcsCfgCleanup,then_bb, else_bb,
         &then_last_head,  &else_last_head,  longest_match);
         ...
         if (n_matching > 0){
            ...
            for (insn = BB_HEAD (then_bb); insn != NEXT_INSN (then_last_head); insn = NEXT_INSN (insn))
               if (!LABEL_P (insn) && !NOTE_P (insn)  && !DEBUG_INSN_P (insn)
               && mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,test_expr, insn))
                  return false;
         }
         ...
         if (n_matching > 0){
            if (then_start)
               then_start = find_active_insn_after(self,then_bb, then_last_head);
            if (else_start)
               else_start = find_active_insn_after(self,else_bb, else_last_head);
            n_insns -= 2 * n_matching;
         }
      }
   }
   ...
   true_expr = test_expr;
   false_code = mtcs_dojump_reversed_comparison_code/*!reversed_comparison_code*/(mtcsDojump,true_expr, BB_END (test_bb));
   if (false_code != UNKNOWN)
      false_expr = gen_rtx_fmt_ee (false_code, GET_MODE (true_expr),XEXP (true_expr, 0), XEXP (true_expr, 1));
   else
      false_expr = NULL_RTX;
   ...
   if (ce_info->num_multiple_test_blocks > 0){
      ...
      do{
         ...
         bb = block_fallthru(self,bb);
         start = first_active_insn(self,bb);
         end = last_active_insn(self,bb, true);
         if (start && ! cond_exec_process_insns(self,ce_info, start, end, false_expr,false_prob_val, false))
            goto fail;
         ...
         t = cond_exec_get_condition(self,BB_END (bb));
         if (! t)
            goto fail;

         f_code = mtcs_dojump_reversed_comparison_code/*!reversed_comparison_code*/(mtcsDojump,t, BB_END (bb));
         if (f_code == UNKNOWN)
            goto fail;
   ...
   if (then_end && (! false_expr
   || ! cond_exec_process_insns(self,ce_info, then_start, then_end,false_expr, false_prob_val,then_mod_ok)))
      goto fail;

   if (else_bb && else_end  && ! cond_exec_process_insns(self,ce_info, else_start, else_end,true_expr, true_prob_val, true))
      goto fail;
...
#ifdef IFCVT_MODIFY_CANCEL //host=0 nvptx=0
...
#ifdef IFCVT_MODIFY_FINAL //host=0 nvptx=0
   ...
   if (then_first_tail){
      ...
      if (!INSN_P (from))
         from = find_active_insn_after(self,then_bb, from);
      mtcs_cfg_rtl_delete_insn_chain/*!delete_insn_chain*/(mtcsCfgRtl,from, get_last_bb_insn (then_bb), false);
   }
   if (else_last_head)
      mtcs_cfg_rtl_delete_insn_chain/*!delete_insn_chain*/(mtcsCfgRtl,first_active_insn(self,else_bb), else_last_head, false);

   merge_if_block(self,ce_info);
   self->cond_exec_changed_p = true;
   return true;
...
static rtx noce_emit_store_flag (MtcsIfcvt *self,struct noce_if_info *, rtx, bool, int);
static bool noce_try_move (MtcsIfcvt *self,struct noce_if_info *);
static bool noce_try_ifelse_collapse (MtcsIfcvt *self,struct noce_if_info *);
static bool noce_try_store_flag (MtcsIfcvt *self,struct noce_if_info *);
static bool noce_try_addcc (MtcsIfcvt *self,struct noce_if_info *);
static bool noce_try_store_flag_constants (MtcsIfcvt *self,struct noce_if_info *);
static bool noce_try_store_flag_mask (MtcsIfcvt *self,struct noce_if_info *);
static rtx noce_emit_cmove (MtcsIfcvt *self,struct noce_if_info *, rtx, enum rtx_code, rtx,
             rtx, rtx, rtx, rtx = NULL, rtx = NULL);
static bool noce_try_cmove (MtcsIfcvt *self,struct noce_if_info *);
static bool noce_try_cmove_arith (MtcsIfcvt *self,struct noce_if_info *);
static rtx noce_get_alt_condition (MtcsIfcvt *self,struct noce_if_info *, rtx, rtx_insn **);
static bool noce_try_minmax (MtcsIfcvt *self,struct noce_if_info *);
static bool noce_try_abs (MtcsIfcvt *self,struct noce_if_info *);
static bool noce_try_sign_mask (MtcsIfcvt *self,struct noce_if_info *);
static int noce_try_cond_zero_arith (MtcsIfcvt *self,struct noce_if_info *);

/* Return the comparison code for reversed condition for IF_INFO,
   or UNKNOWN if reversing the condition is not possible.  */
static inline enum rtx_code noce_reversed_cond_code (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsDojump *mtcsDojump=mtcs_target_get_dojump(mtcsTarget);
   ...
   return mtcs_dojump_reversed_comparison_code/*!reversed_comparison_code*/(mtcsDojump,if_info->cond, if_info->jump);
}
                  ...
                  struct noce_if_info *if_info)
{
   ...
   unsigned int cost = mtcs_rtlanal_seq_cost/*!seq_cost*/(mtcsRtlanal,seq, speed_p);
...
static rtx noce_emit_store_flag (MtcsIfcvt *self,struct noce_if_info *if_info, rtx x, bool reversep,
            int normalize)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   ...
   cond_complex = (! mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,XEXP (cond, 0), VOIDmode)
            || ! mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,XEXP (cond, 1), VOIDmode));
   ...
   && if_info->rev_cond
   && mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,XEXP (if_info->rev_cond, 0), VOIDmode)
   && mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,XEXP (if_info->rev_cond, 1), VOIDmode)){
      cond = if_info->rev_cond;
      reversep = false;
   }

   if (reversep)
      code = mtcs_dojump_reversed_comparison_code/*!reversed_comparison_code*/(mtcsDojump,cond, if_info->jump);
   else
      code = GET_CODE (cond);
   ...
   && (normalize == 0 || STORE_FLAG_VALUE == normalize)){
      ...
      rtx_insn *insn = mtcs_emit_emit_insn/*!emit_insn*/(mtcsEmit,set);
   ...
   if (cond_complex || !mtcs_mode_is_scalar_int_p/*!SCALAR_INT_MODE_P*/(mtcsMode,GET_MODE (x)))
      return NULL_RTX;

   return mtcs_expmed_emit_store_flag/*!emit_store_flag*/(mtcsExpmed,x, code, XEXP (cond, 0),
         XEXP (cond, 1), VOIDmode,(code == LTU || code == LEU || code == GEU || code == GTU), normalize);
}

/* Return true if X can be safely forced into a register by copy_to_mode_reg
   / force_operand.  */
static bool noce_can_force_operand (MtcsIfcvt *self,rtx x)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsPreds *mtcsPreds=mtcs_target_get_preds(mtcsTarget);
   ...
   if (mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,x, VOIDmode))
      return true;
   if (SUBREG_P (x)){
      if (!noce_can_force_operand(self,SUBREG_REG (x)))
         return false;
      return true;
   }
   if (ARITHMETIC_P (x)){
      if (!noce_can_force_operand(self,XEXP (x, 0)) || !noce_can_force_operand(self,XEXP (x, 1)))
         return false;
      switch (GET_CODE (x)){
         case MULT:
         case DIV:
   ...
   if (UNARY_P (x)){
      if (!noce_can_force_operand(self,XEXP (x, 0)))
         return false;
      switch (GET_CODE (x)){
         case ZERO_EXTEND:
         case SIGN_EXTEND:
...
static void noce_emit_move_insn (MtcsIfcvt *self,rtx x, rtx y)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if (GET_CODE (x) != STRICT_LOW_PART){
      ...
      insn = (OBJECT_P (y) || CONSTANT_P (y) || GET_CODE (y) == SUBREG)
               ...
               : mtcs_emit_emit_insn/*!emit_insn*/(mtcsEmit,gen_rtx_SET (x, y));
      ...
      if (mtcs_recog_recog_memoized/*!recog_memoized*/(mtcsRecog,insn) <= 0){
         if (GET_CODE (x) == ZERO_EXTRACT){
            ...
            mtcs_expmed_store_bit_field/*!store_bit_field*/(mtcsExpmed,op, size, start, 0, 0, GET_MODE (x), y, false,false);
            return;
         }
         ...
         switch (GET_RTX_CLASS (GET_CODE (y))){
            case RTX_UNARY:
               ...
               if (ot && noce_can_force_operand(self,XEXP (y, 0))){
                  mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
                  target = mtcs_optabs_expand_unop/*!expand_unop*/(mtcsOptabs,GET_MODE (y), ot, XEXP (y, 0), x, 0);
                  if (target != NULL_RTX){
                     if (target != x)
                        mtcs_expr_emit_move_insn/*!emit_move_insn*/(mtcsExpr,x, target);
                     seq = mtcs_rtl_data_get_insns/*!get_insns*/(mtcsRtlData);
                  }
                  mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);
               }
            ...
            case RTX_COMM_ARITH:
               ot = code_to_optab (GET_CODE (y));
               if (ot
               && noce_can_force_operand(self,XEXP (y, 0))
               && noce_can_force_operand(self,XEXP (y, 1))){
                  mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
                  target = mtcs_optabs_expand_binop/*!expand_binop*/(mtcsOptabs,
                        GET_MODE (y), ot,XEXP (y, 0), XEXP (y, 1), x, 0, OPTAB_DIRECT);
                  if (target != NULL_RTX){
                     if (target != x)
                        mtcs_expr_emit_move_insn/*!emit_move_insn*/(mtcsExpr,x, target);
                     seq = mtcs_rtl_data_get_insns/*!get_insns*/(mtcsRtlData);
   ...
   mtcs_expmed_store_bit_field/*!store_bit_field*/(mtcsExpmed,inner,
         mtcs_mode_get_bitsize/*!GET_MODE_BITSIZE*/(mtcsMode,outmode), bitpos, 0, 0, outmode, y, false, false);
}

/* Return the CC reg if it is used in COND.  */
static rtx cc_in_cond (MtcsIfcvt *self,rtx cond)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   if (self->have_cbranchcc4 && cond && mtcs_mode_get_class/*!GET_MODE_CLASS*/(mtcsMode,GET_MODE (XEXP (cond, 0))) == MODE_CC)
      return XEXP (cond, 0);
   return NULL_RTX;
}
...
static rtx_insn *end_ifcvt_sequence (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   rtx_insn *insn;
   rtx_insn *seq = mtcs_rtl_data_get_insns/*!get_insns*/(mtcsRtlData);
   rtx cc = cc_in_cond(self,if_info->cond);
   ...
   for (insn = seq; insn; insn = NEXT_INSN (insn))
      if (JUMP_P (insn)
      || mtcs_recog_recog_memoized/*!recog_memoized*/(mtcsRecog,insn) == -1
      /* Make sure new generated code does not clobber CC.  */
      || (cc && mtcs_rtlanal_set_of/*!set_of*/(mtcsRtlanal,cc, insn)))
         return NULL;
...
static bool noce_simple_bbs (MtcsIfcvt *self,struct noce_if_info *if_info)
{
...
static bool noce_try_move (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if (!noce_simple_bbs(self,if_info))
      return false;
   /* This optimization isn't valid if either A or B could be a NaN
   or a signed zero.  */
   if (mtcs_mode_honor_nans/*!HONOR_NANS*/(mtcsMode,if_info->x)
   || mtcs_mode_honor_signed_zeros/*!HONOR_SIGNED_ZEROS*/(mtcsMode,if_info->x))
      return false;
   ...
   && rtx_equal_p (if_info->b, XEXP (cond, 0)))){
      if (!rtx_interchangeable_p(self,if_info->a, if_info->b))
         return false;
      ...
      if (! rtx_equal_p (if_info->x, y)){
         mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
         noce_emit_move_insn(self,if_info->x, y);
         seq = end_ifcvt_sequence(self,if_info);
         if (!seq)
            return false;

         mtcs_emit_emit_insn_before_setloc/*!emit_insn_before_setloc*/(mtcsEmit,seq, if_info->jump,
...
static bool noce_try_ifelse_collapse (MtcsIfcvt *self,struct noce_if_info * if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   rtx if_then_else =mtcs_simplify_rtx_gen_ternary/*!simplify_gen_ternary*/(mtcsSimplifyRtx,
         IF_THEN_ELSE, mode, mode,if_info->cond, if_info->b,if_info->a);
   ...
   rtx_insn *seq;
   mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
   noce_emit_move_insn(self,if_info->x, if_then_else);
   seq = end_ifcvt_sequence(self,if_info);
   if (!seq)
      return false;

   mtcs_emit_emit_insn_before_setloc/*!emit_insn_before_setloc*/(mtcsEmit,seq, if_info->jump,INSN_LOCATION (if_info->insn_a));
...
static bool noce_try_store_flag (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if (CONST_INT_P (if_info->b) && INTVAL (if_info->b) == STORE_FLAG_VALUE && if_info->a == const0_rtx)
      reversep = false;
   else if (if_info->b == const0_rtx  && CONST_INT_P (if_info->a)
   && INTVAL (if_info->a) == STORE_FLAG_VALUE
   && noce_reversed_cond_code(self,if_info) != UNKNOWN)
      reversep = true;
   else
      return false;

   mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
   target = noce_emit_store_flag(self,if_info, if_info->x, reversep, 0);
   if (target){
      if (target != if_info->x)
         noce_emit_move_insn(self,if_info->x, target);
      seq = end_ifcvt_sequence(self,if_info);
      if (! seq)
         return false;
      mtcs_emit_emit_insn_before_setloc/*!emit_insn_before_setloc*/(mtcsEmit,seq, if_info->jump,INSN_LOCATION (if_info->insn_a));
...
static bool noce_try_inverse_constants (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if (!CONST_INT_P (if_info->a) || !CONST_INT_P (if_info->b) || !REG_P (if_info->x))
      return false;
   ...
   noce_emit_move_insn(self,tmp, if_info->a);

   target = mtcs_optabs_emit_conditional_neg_or_complement/*!emit_conditional_neg_or_complement*/(mtcsOptabs,
         x, code, mode, cond, tmp, tmp);
...
/* Convert "if (test) x = a; else x = b", for A and B constant.
   ...
   and B.  */
static bool noce_try_store_flag_constants (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   && (REG_P (XEXP (a, 0)) || (noce_operand_ok(self,XEXP (a, 0))
   && ! mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,if_info->x, XEXP (a, 0))))){
      common = XEXP (a, 0);
      a = XEXP (a, 1);
      b = XEXP (b, 1);
   }
   ...
   if (CONST_INT_P (a)  && CONST_INT_P (b)){
      ...
      if ((diff > 0)  != ((ifalse < 0) != (itrue < 0) ? ifalse < 0 : ifalse < itrue))
         return false;

      diff = mtcs_mode_trunc_int_for_mode/*!trunc_int_for_mode*/(mtcsMode,diff, mode);

      can_reverse = noce_reversed_cond_code(self,if_info) != UNKNOWN;
      reversep = false;
      ...
      /* Is this (cond) ? 2^n : 0?  */
      else if (ifalse == 0 && pow2p_hwi (itrue)  && STORE_FLAG_VALUE == 1)
         normalize = 1;
      /* Is this (cond) ? 0 : 2^n?  */
      else if (itrue == 0 && pow2p_hwi (ifalse) && can_reverse  && STORE_FLAG_VALUE == 1){
         normalize = 1;
         reversep = true;
      }/* Is this (cond) ? -1 : x?  */else if (itrue == -1  && STORE_FLAG_VALUE == -1)
         normalize = -1;
      /* Is this (cond) ? x : -1?  */
      else if (ifalse == -1 && can_reverse  && STORE_FLAG_VALUE == -1){
         normalize = -1;
         reversep = true;
      }else
         return false;
      ...
      if (reversep){
         ...
         diff = mtcs_mode_trunc_int_for_mode/*!trunc_int_for_mode*/(mtcsMode,-(unsigned HOST_WIDE_INT) diff, mode);
      }
      ...
      if (common && rtx_equal_p (common, if_info->x)){
         common = mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,mode);
         noce_emit_move_insn(self,common, if_info->x);
      }

      target = noce_emit_store_flag(self,if_info, if_info->x, reversep, normalize);
      if (! target){
         mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);
         return false;
      }
      ...
      if (diff == STORE_FLAG_VALUE || diff == -STORE_FLAG_VALUE){
         ...
         if (common)
            target = mtcs_optabs_expand_simple_binop/*!expand_simple_binop*/(mtcsOptabs,mode, PLUS,target, common,target, 0, OPTAB_WIDEN);

         /* Always use ifalse here.  It should have been swapped with itrue
         when appropriate when reversep is true.  */
         target = mtcs_optabs_expand_simple_binop/*!expand_simple_binop*/(mtcsOptabs,mode, subtract_flag_p ? MINUS : PLUS,
               mtcs_rtl_gen_int_mode/*!gen_int_mode*/(mtcsRTL,ifalse, mode), target,if_info->x, 0, OPTAB_WIDEN);
      }
      ...
      =>   x = (test != 0) << 3;  */
         ...
         target = mtcs_optabs_expand_simple_binop/*!expand_simple_binop*/(mtcsOptabs,
               mode, ASHIFT,target, mtcs_rtl_GEN_INT/*!GEN_INT*/(mtcsRTL,tmp), if_info->x, 0, OPTAB_WIDEN);
      }
      /* if (test) x = -1; else x = b;
      =>   x = -(test != 0) | b;  */
      else if (itrue == -1){
         target = mtcs_optabs_expand_simple_binop/*!expand_simple_binop*/(mtcsOptabs,
               mode, IOR,target, mtcs_rtl_gen_int_mode/*!gen_int_mode*/(mtcsRTL,ifalse, mode),if_info->x, 0, OPTAB_WIDEN);
      }else{
         mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);
         return false;
      }
      ...
      seq = end_ifcvt_sequence(self,if_info);
      if (!seq || !mtcsTarget/*!targetm.noce_conversion_profitable_p*/->noce_conversion_profitable_p(mtcsTarget,seq, if_info))
         return false;
...
/* Convert "if (test) foo++" into "foo += (test != 0)", and
   similarly for "foo--".  */
static bool noce_try_addcc (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   && noce_reversed_cond_code(self,if_info) != UNKNOWN){
      ...
      if (mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,XEXP (cond, 0), VOIDmode)
      && mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,XEXP (cond, 1), VOIDmode)){
         mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
         target =mtcs_optabs_emit_conditional_add/*!emit_conditional_add*/(mtcsOptabs,if_info->x, code,
                  XEXP (cond, 0), XEXP (cond, 1),  VOIDmode,if_info->b,XEXP (if_info->a, 1), GET_MODE (if_info->x),
                  (code == LTU || code == GEU|| code == LEU || code == GTU));
         if (target){
            if (target != if_info->x)
               noce_emit_move_insn(self,if_info->x, target);
      ...
      an ADD/SUB.  */
      if (XEXP (if_info->a, 1) == const1_rtx || XEXP (if_info->a, 1) == constm1_rtx){
         mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
         ...
         target = noce_emit_store_flag(self,if_info,
         mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (if_info->x)),true, normalize);

         if (target)
            target = mtcs_optabs_expand_simple_binop/*!expand_simple_binop*/(mtcsOptabs,GET_MODE (if_info->x),
                  subtract ? MINUS : PLUS,if_info->b, target, if_info->x,0, OPTAB_WIDEN);
         if (target){
            if (target != if_info->x)
               noce_emit_move_insn(self,if_info->x, target);
...
static bool noce_try_store_flag_mask (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   || ((reversep = (noce_reversed_cond_code(self,if_info) != UNKNOWN))
   && if_info->b == const0_rtx
   && (REG_P (if_info->a) || rtx_equal_p (if_info->a, if_info->x)))){
      mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
      target = noce_emit_store_flag(self,if_info,
      mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (if_info->x)),reversep, -1);
      if (target)
         target = mtcs_optabs_expand_simple_binop/*!expand_simple_binop*/(mtcsOptabs,
               GET_MODE (if_info->x), AND,reversep ? if_info->a : if_info->b,target, if_info->x, 0,OPTAB_WIDEN);
...
static rtx noce_emit_cmove (MtcsIfcvt *self,struct noce_if_info *if_info, rtx x, enum rtx_code code,
       ...
       rtx rev_cc_cmp)
{
   ...
   unsignedp = (code == LTU || code == GEU || code == LEU || code == GTU);

   if (cc_cmp != NULL_RTX && rev_cc_cmp != NULL_RTX)
      target =mtcs_optabs_emit_conditional_move/*!emit_conditional_move*/(mtcsOptabs,
            x, cc_cmp, rev_cc_cmp,vtrue, vfalse, GET_MODE (x));
   else{
      /* Don't even try if the comparison operands are weird
      except that the target supports cbranchcc4.  */
      if (! mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,cmp_a, GET_MODE (cmp_a))
      || ! mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,cmp_b, GET_MODE (cmp_b))){
         if (!self->have_cbranchcc4
         || mtcs_mode_get_class/*!GET_MODE_CLASS*/(mtcsMode,GET_MODE (cmp_a)) != MODE_CC
         || cmp_b != const0_rtx)
            return NULL_RTX;
      }

      target = mtcs_optabs_emit_conditional_move/*!emit_conditional_move*/(mtcsOptabs,
            x, { code, cmp_a, cmp_b, VOIDmode },vtrue, vfalse, GET_MODE (x), unsignedp);
   }
   ...
   if (GET_CODE (vtrue) == SUBREG && GET_CODE (vfalse) == SUBREG){
      ...
      promoted_target = mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (reg_vtrue));

      target = mtcs_optabs_emit_conditional_move/*!emit_conditional_move*/(mtcsOptabs,
            promoted_target,{ code, cmp_a, cmp_b, VOIDmode },reg_vtrue, reg_vfalse, GET_MODE (reg_vtrue), unsignedp);
      /* Nope, couldn't do it in that mode either.  */
      if (!target)
         return NULL_RTX;

      target = mtcs_rtl_gen_rtx_SUBREG/*!gen_rtx_SUBREG*/(mtcsRTL,GET_MODE (vtrue), promoted_target, byte_vtrue);
...
static rtx noce_emit_czero (MtcsIfcvt *self,struct noce_if_info *if_info, enum rtx_code czero_code,
       rtx non_zero_op, rtx target)
{
   ...
   rtx czero_cond  = gen_rtx_fmt_ee (czero_code, GET_MODE (cond_op0), cond_op0, const0_rtx);
   rtx if_then_else  = gen_rtx_IF_THEN_ELSE (mode, czero_cond, const0_rtx, non_zero_op);
   rtx set = gen_rtx_SET (target, if_then_else);

   rtx_insn *insn = mtcs_emit_make_insn_raw/*!make_insn_raw*/(mtcsEmit,set);

   if (mtcs_recog_recog_memoized/*!recog_memoized*/(mtcsRecog,insn) >= 0){
      mtcs_emit_add_insn/*!add_insn*/(mtcsEmit,insn);
      return target;
   }
...
/* Try only simple constants and registers here.  More complex cases
   ...
   has had a go at it.  */
static bool noce_try_cmove (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if ((CONSTANT_P (if_info->a) || mtcs_preds_register_operand/*!register_operand*/(mtcsPreds,if_info->a, VOIDmode))
   && (CONSTANT_P (if_info->b) || mtcs_preds_register_operand/*!register_operand*/(mtcsPreds,if_info->b, VOIDmode))){
      mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);

      code = GET_CODE (if_info->cond);
      target = noce_emit_cmove(self,if_info, if_info->x, code,
            XEXP (if_info->cond, 0), XEXP (if_info->cond, 1),if_info->a, if_info->b);
      ...
      approach.  */
      else if (!mtcsTarget->have_conditional_execution/*!targetm.have_conditional_execution*/(mtcsTarget)
      && CONST_INT_P (if_info->a) && CONST_INT_P (if_info->b)){
         machine_mode mode = GET_MODE (if_info->x);
         HOST_WIDE_INT ifalse = INTVAL (if_info->a);
         HOST_WIDE_INT itrue = INTVAL (if_info->b);
         rtx target = noce_emit_store_flag(self,if_info, if_info->x, false, -1);
         if (!target){
            mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);
            return false;
         }
         ...
         diff = mtcs_mode_trunc_int_for_mode/*!trunc_int_for_mode*/(mtcsMode,diff, mode);
         target = mtcs_optabs_expand_simple_binop/*!expand_simple_binop*/(mtcsOptabs,
               mode, AND,target, mtcs_rtl_gen_int_mode/*!gen_int_mode*/(mtcsRTL,diff, mode),if_info->x, 0, OPTAB_WIDEN);
         if (target)
            target = mtcs_optabs_expand_simple_binop/*!expand_simple_binop*/(mtcsOptabs,
                  mode, PLUS,target, mtcs_rtl_gen_int_mode/*!gen_int_mode*/(mtcsRTL,ifalse, mode),
...
static bool contains_ccmode_rtx_p (MtcsIfcvt *self,rtx x)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   subrtx_iterator::array_type array;
   FOR_EACH_SUBRTX (iter, array, x, ALL)
      if (mtcs_mode_get_class/*!GET_MODE_CLASS*/(mtcsMode,GET_MODE (*iter)) == MODE_CC)
         return true;
...
/* Helper for bb_valid_for_noce_process_p.  Validate that
   ...
   if-conversion.  */
static bool insn_valid_noce_process_p (MtcsIfcvt *self,rtx_insn *insn, rtx cc)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlanal *mtcsRtlanal=mtcs_target_get_rtlanal(mtcsTarget);

   if (!insn || !NONJUMP_INSN_P (insn)  || (cc && mtcs_rtlanal_set_of/*!set_of*/(mtcsRtlanal,cc, insn)))
      return false;
   rtx sset = single_set (insn);
   /* Currently support only simple single sets in test_bb.  */
   if (!sset
         || !noce_operand_ok(self,SET_DEST (sset))
         || contains_ccmode_rtx_p(self,SET_DEST (sset))
         || !noce_operand_ok(self,SET_SRC (sset)))
      return false;
...
/* Return true iff the registers that the insns in BB_A set do not get
   ...
   in this function.  */
static bool bbs_ok_for_cmove_arith (MtcsIfcvt *self,basic_block bb_a, basic_block bb_b, rtx to_rename)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRTL *mtcsRTL=mtcs_target_get_rtl(mtcsTarget);
   ...
   FOR_BB_INSNS (bb_b, b_insn){
      ...
      if (MEM_P (SET_DEST (sset_b)))
         gcc_assert (rtx_equal_p (SET_DEST (sset_b), to_rename));
            ...
            && !mtcs_rtl_paradoxical_subreg_p/*!paradoxical_subreg_p*/(mtcsRTL,SET_DEST (sset_b))){
         BITMAP_FREE (bba_sets);
         return false;
      }
...
static void noce_emit_all_but_last (MtcsIfcvt *self,basic_block bb)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);

   rtx_insn *last = last_active_insn(self,bb, false);
   rtx_insn *insn;
   FOR_BB_INSNS (bb, insn){
      if (insn != last && active_insn_p (insn)){
         rtx_insn *to_emit = as_a <rtx_insn *> (copy_rtx (insn));
         mtcs_emit_emit_insn/*!emit_insn*/(mtcsEmit,PATTERN (to_emit));
      }
   }
}
...
static rtx_insn *noce_emit_insn (MtcsIfcvt *self,rtx to_emit)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   gcc_assert (to_emit);
   rtx_insn *insn = mtcs_emit_emit_insn/*!emit_insn*/(mtcsEmit,to_emit);
...
static bool noce_emit_bb (MtcsIfcvt *self,rtx last_insn, basic_block bb, bool simple)
{
   if (bb && !simple)
      noce_emit_all_but_last(self,bb);
   if (last_insn && !noce_emit_insn(self,last_insn))
      return false;
   return true;
}

/* Try more complex cases involving conditional_move.  */
static bool noce_try_cmove_arith (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if (cse_not_expected && MEM_P (a) && MEM_P (b) && mtcs_rtl_get_mem_addr_space/*!MEM_ADDR_SPACE*/(mtcsRTL,a)
         == mtcs_rtl_get_mem_addr_space/*!MEM_ADDR_SPACE*/(mtcsRTL,b)){
      machine_mode address_mode = get_address_mode (a);
      a = XEXP (a, 0);
      b = XEXP (b, 0);
      x = mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,address_mode);
      is_mem = true;
   }
   /* ??? We could handle this if we knew that a load from A or B could
   not trap or fault.  This is also true if we've already loaded
   from the address along the path from ENTRY.  */
   else if (mtcs_rtlanal_may_trap_or_fault_p/*!may_trap_or_fault_p*/(mtcsRtlanal,a)
         || mtcs_rtlanal_may_trap_or_fault_p/*!may_trap_or_fault_p*/(mtcsRtlanal,b))
      return false;
   ...
   */
   ...
   if (!mtcs_optabs_can_conditionally_move_p/*!can_conditionally_move_p*/(mtcsOptabs,x_mode))
      return false;

   /* Possibly rearrange operands to make things come out more natural.  */
   if (noce_reversed_cond_code(self,if_info) != UNKNOWN){
      bool reversep = false;
      if (rtx_equal_p (b, x))
         reversep = true;
      else if (mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,b, GET_MODE (b)))
         reversep = true;
   ...
   if (then_bb && else_bb
   && (!bbs_ok_for_cmove_arith(self,then_bb, else_bb,  if_info->orig_x)
   || !bbs_ok_for_cmove_arith(self,else_bb, then_bb,  if_info->orig_x)))
      return false;
   ...
   if (b_simple || !else_bb)
      tmp_b = mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,x_mode);

   if (a_simple || !then_bb)
      tmp_a = mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,x_mode);
   ...
   if (! mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,a, GET_MODE (a)) || tmp_a){
      if (is_mem){
         rtx reg = mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (a));
         emit_a = gen_rtx_SET (reg, a);
      }else{
         if (insn_a){
            a = tmp_a ? tmp_a : mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (a));
            ...
            rtx tmp_reg = tmp_a ? tmp_a : mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (a));
   ...
   if (! mtcs_preds_general_operand/*!general_operand*/(mtcsPreds,b, GET_MODE (b)) || tmp_b){
      if (is_mem){
         rtx reg = mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (b));
         emit_b = gen_rtx_SET (reg, b);
      }else{
         if (insn_b){
            b = tmp_b ? tmp_b : mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (b));
            ...
            rtx tmp_reg = tmp_b ? tmp_b : mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (b));
   ...
   modified_in_a = emit_a != NULL_RTX && mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,orig_b, emit_a);
   if (tmp_b && then_bb){
      FOR_BB_INSNS (then_bb, tmp_insn)
         ...
         if (!(insn_a && tmp_insn == insn_a)  && mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,orig_b, tmp_insn)){
            modified_in_a = true;
            break;
         }
   }

   modified_in_b = emit_b != NULL_RTX && mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,orig_a, emit_b);
   if (tmp_a && else_bb){
      FOR_BB_INSNS (else_bb, tmp_insn)
         /* Don't check inside insn_b.  We will have changed it to emit_b
         with a destination that doesn't conflict.  */
         if (!(insn_b && tmp_insn == insn_b)  && mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,orig_a, tmp_insn)){
            modified_in_b = true;
            break;
         }
   }
   ...
   if (modified_in_a && !modified_in_b){
      if (!noce_emit_bb(self,emit_b, else_bb, b_simple))
         goto end_seq_and_fail;

      if (!noce_emit_bb(self,emit_a, then_bb, a_simple))
         goto end_seq_and_fail;
   ...
   target = noce_emit_cmove(self,if_info, x, code, XEXP (cond, 0), XEXP (cond, 1),a, b);
   ...
   if (is_mem){
      ...
      if (mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,if_info->a) == mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,if_info->b))
         mtcs_rtl_set_mem_alias_set/*!set_mem_alias_set*/(mtcsRTL,mem, mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,if_info->a));

      set_mem_align (mem, MIN (mtcs_rtl_get_mem_align/*!MEM_ALIGN*/(mtcsRTL,if_info->a),
            mtcs_rtl_get_mem_align/*!MEM_ALIGN*/(mtcsRTL,if_info->b)));

      gcc_assert (mtcs_rtl_get_mem_addr_space/*!MEM_ADDR_SPACE*/(mtcsRTL,if_info->a)
            == mtcs_rtl_get_mem_addr_space/*!MEM_ADDR_SPACE*/(mtcsRTL,if_info->b));
      mtcs_rtl_set_mem_addr_space/*!set_mem_addr_space*/(mtcsRTL,
            mem, mtcs_rtl_get_mem_addr_space/*!MEM_ADDR_SPACE*/(mtcsRTL,if_info->a));

      noce_emit_move_insn(self,if_info->x, mem);
   }else if (target != x)
      noce_emit_move_insn(self,x, target);

   ifcvt_seq = end_ifcvt_sequence(self,if_info);
   if (!ifcvt_seq || !mtcsTarget/*!targetm.noce_conversion_profitable_p*/->noce_conversion_profitable_p(mtcsTarget,ifcvt_seq, if_info))
      return false;

   mtcs_emit_emit_insn_before_setloc/*!emit_insn_before_setloc*/(mtcsEmit,ifcvt_seq, if_info->jump,INSN_LOCATION (if_info->insn_a));
...
static rtx noce_get_alt_condition (MtcsIfcvt *self,struct noce_if_info *if_info, rtx target,
         rtx_insn **earliest)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   ...
   if (CONST_INT_P (target)){
      ...
      if (prev_insn  && BLOCK_FOR_INSN (prev_insn)  == BLOCK_FOR_INSN (if_info->cond_earliest)
      && INSN_P (prev_insn)  && GET_CODE (PATTERN (prev_insn)) == SET){
      ...
      if (CONST_INT_P (op_b)){
         ...
         switch (code){
            case LT:
               if (desired_val != HOST_WIDE_INT_MAX  && actual_val == desired_val + 1){
                  code = LE;
                  op_b = mtcs_rtl_GEN_INT/*!GEN_INT*/(mtcsRTL,desired_val);
               }
               break;
            case LE:
               if (desired_val != HOST_WIDE_INT_MIN  && actual_val == desired_val - 1){
                  code = LT;
                  op_b =mtcs_rtl_GEN_INT/*!GEN_INT*/(mtcsRTL,desired_val);
               }
               break;
      ...
      constants in it.  */
      if (code != GET_CODE (if_info->cond) || op_a != XEXP (if_info->cond, 0)  || op_b != XEXP (if_info->cond, 1)){
   ...
   cond = mtcs_rtlanal_canonicalize_condition/*!canonicalize_condition*/(mtcsRtlanal,
         if_info->jump, cond, reverse, earliest, target, self->have_cbranchcc4, true);
   ...
   for (insn = if_info->jump; insn != *earliest; insn = PREV_INSN (insn))
      if (INSN_P (insn) && mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,
            if_info->x, PATTERN (insn)))
         return NULL;

   /* A and B may not be modified in the range [cond_earliest, jump).  */
   for (insn = *earliest; insn != if_info->jump; insn = NEXT_INSN (insn))
      if (INSN_P (insn)
      && (mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,if_info->a, insn)
      || mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,if_info->b, insn)))
         return NULL;
...
static bool noce_try_minmax (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if (mtcs_mode_honor_signed_zeros/*!HONOR_SIGNED_ZEROS*/(mtcsMode,if_info->x)
   || mtcs_mode_honor_nans/*!HONOR_NANS*/(mtcsMode,if_info->x))
      return false;

   cond = noce_get_alt_condition(self,if_info, if_info->a, &earliest);
   if (!cond)
      return false;
   ...
   mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
   target = mtcs_optabs_expand_simple_binop/*!expand_simple_binop*/(mtcsOptabs,GET_MODE (if_info->x), op,
         if_info->a, if_info->b, if_info->x, unsignedp, OPTAB_WIDEN);
   if (! target){
      mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);
      return false;
   }
...
/* Convert "if (a < 0) x = -a; else x = a;" to "x = abs(a);",
   ...
   etc.  */
static bool noce_try_abs (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   cond = noce_get_alt_condition(self,if_info, b, &earliest);
   if (!cond)
      return false;
   ...
   if (REG_P (c)){
      ...
      if (insn   && BLOCK_FOR_INSN (insn) == BLOCK_FOR_INSN (earliest)
      && (set = single_set (insn))  && rtx_equal_p (SET_DEST (set), c)){
   ...
   if (MEM_P (c)  && GET_CODE (XEXP (c, 0)) == SYMBOL_REF  && CONSTANT_POOL_ADDRESS_P (XEXP (c, 0)))
   ...
   if (c == constm1_rtx && GET_CODE (cond) == GT)
      ...
      if (one_cmpl   && GET_CODE (cond) != GE  && GET_CODE (cond) != LT)
         return false;
   }else
      return false;
   ...
   mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
   if (one_cmpl)
      target = mtcs_optabs_expand_one_cmpl_abs_nojump/*!expand_one_cmpl_abs_nojump*/(mtcsOptabs,GET_MODE (if_info->x), b,if_info->x);
   else
      target = mtcs_optabs_expand_abs_nojump/*!expand_abs_nojump*/(mtcsOptabs,GET_MODE (if_info->x), b, if_info->x, 1);

   /* ??? It's a quandary whether cmove would be better here, especially
   for integers.  Perhaps combine will clean things up.  */
   if (target && negate){
      if (one_cmpl)
         target = mtcs_optabs_expand_simple_unop/*!expand_simple_unop*/(mtcsOptabs,GET_MODE (target), NOT, target,if_info->x, 0);
      else
         target =mtcs_optabs_expand_simple_unop/*!expand_simple_unop*/(mtcsOptabs,GET_MODE (target), NEG, target,if_info->x, 0);
   }
...
static bool noce_try_sign_mask (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   t = NULL_RTX;
   if (if_info->a == const0_rtx){
      if ((code == LT && c == const0_rtx) || (code == LE && c == constm1_rtx))
         t = if_info->b;
   }else if (if_info->b == const0_rtx){
      if ((code == GE && c == const0_rtx) || (code == GT && c == constm1_rtx))
         t = if_info->a;
   }
   ...
   t_unconditional = (t == if_info->b
         && (if_info->insn_b == NULL_RTX  || BLOCK_FOR_INSN (if_info->insn_b) == if_info->test_bb));
   if (!(t_unconditional || ((set_src_cost (t, mode, if_info->speed_p)< COSTS_N_INSNS (2))
   && !mtcs_rtlanal_may_trap_or_fault_p/*!may_trap_or_fault_p*/(mtcsRtlanal,t))))
      return false;

   if (!noce_can_force_operand(self,t))
      return false;
   ...
   m = mtcs_expmed_emit_store_flag/*!emit_store_flag*/(mtcsExpmed,
         mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,mode), LT, m, const0_rtx, mode, 0, -1);
   t = m ? mtcs_optabs_expand_binop/*!expand_binop*/(mtcsOptabs,mode, and_optab, m, t, NULL_RTX, 0, OPTAB_DIRECT) : NULL_RTX;
   ...
   noce_emit_move_insn(self,if_info->x, t);

   seq = end_ifcvt_sequence(self,if_info);
   if (!seq)
      return false;

   mtcs_emit_emit_insn_before_setloc/*!emit_insn_before_setloc*/(mtcsEmit,
         seq, if_info->jump, INSN_LOCATION (if_info->insn_a));
...
static bool noce_bbs_ok_for_cond_zero_arith (MtcsIfcvt *self,struct noce_if_info *if_info, rtx *common_ptr,
             rtx *bin_exp_ptr,
             ...
             rtx **to_replace)
{
   ...
   if (op0 && rtx_equal_p (op0, b)){
      ...
      czero_code = (reverse ^ (GET_CODE (bin_exp) == AND)) ? noce_reversed_cond_code(self,if_info): GET_CODE (cond);
   }else
      return false;
...
/*  Try to covert if-then-else with conditional zero,
    ...
    IF_INFO describes the if-conversion scenario under consideration.  */
static int noce_try_cond_zero_arith (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if (!noce_bbs_ok_for_cond_zero_arith(self,if_info, &common, &bin_exp, &czero_code, &a, &to_replace))
      return false;

   mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
   bin_code = GET_CODE (bin_exp);
   if (bin_code == AND){
      rtmp = mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,mode);
      noce_emit_move_insn(self,rtmp, a);

      target = noce_emit_czero(self,if_info, czero_code, common, if_info->x);
      if (!target){
         mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);
         return false;
      }
      target = mtcs_optabs_expand_simple_binop/*!expand_simple_binop*/(mtcsOptabs,mode, IOR, rtmp, target, if_info->x, 0,OPTAB_WIDEN);
      if (!target){
         mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);
         return false;
      }
      ...
      target = noce_emit_czero(self,if_info, czero_code, non_zero_op, target);
      ...
      *to_replace = target;
      noce_emit_move_insn(self,if_info->x, a);
   }
...
/* Optimize away "if (x & C) x |= C" and similar bit manipulation
   transformations.  */
static bool noce_try_bitop (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if (GET_CODE (cond) == ZERO_EXTRACT){
      if (XEXP (cond, 1) != const1_rtx  || !CONST_INT_P (XEXP (cond, 2)) || ! rtx_equal_p (x, XEXP (cond, 0)))
         return false;
      bitnum = INTVAL (XEXP (cond, 2));
      if (BITS_BIG_ENDIAN)
         bitnum = mtcs_mode_get_bitsize/*!GET_MODE_BITSIZE*/(mtcsMode,mode) - 1 - bitnum;
   ...
   if (GET_CODE (a) == IOR || GET_CODE (a) == XOR){
      ...
      if (! rtx_equal_p (x, XEXP (a, 0))  || !CONST_INT_P (XEXP (a, 1))
      || (INTVAL (XEXP (a, 1)) & GET_MODE_MASK (mode)) != HOST_WIDE_INT_1U << bitnum)
         return false;
      ...
      if (GET_CODE (a) == IOR)
         ...
         /* if ((x & C) == 0) x ^= C; is transformed to x |= C.   */
         result = mtcs_rtl_gen_int_mode/*!gen_int_mode*/(mtcsRTL,HOST_WIDE_INT_1 << bitnum, mode);
         result =  mtcs_simplify_rtx_gen_binary/*!simplify_gen_binary*/(mtcsSimplifyRtx,IOR, mode, x, result);
      }else{
         /* if ((x & C) != 0) x ^= C; is transformed to x &= ~C.  */
         result = mtcs_rtl_gen_int_mode/*!gen_int_mode*/(mtcsRTL,~(HOST_WIDE_INT_1 << bitnum), mode);
         result =  mtcs_simplify_rtx_gen_binary/*!simplify_gen_binary*/(mtcsSimplifyRtx,AND, mode, x, result);
      }
   }else if (GET_CODE (a) == AND){
      /* Check for "if (X & C) x &= ~C".  */
      if (! rtx_equal_p (x, XEXP (a, 0)) || !CONST_INT_P (XEXP (a, 1))
      || (INTVAL (XEXP (a, 1)) & mtcs_mode_get_mask/*!GET_MODE_MASK*/(mtcsMode,mode))
      != (~(HOST_WIDE_INT_1 << bitnum) & mtcs_mode_get_mask/*!GET_MODE_MASK*/(mtcsMode,mode)))
         return false;
   ...
   if (result){
      mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
      noce_emit_move_insn(self,x, result);
      seq = end_ifcvt_sequence(self,if_info);
      if (!seq)
         return false;
...
static rtx noce_get_condition (MtcsIfcvt *self,rtx_insn *jump, rtx_insn **earliest, bool then_else_reversed)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlanal *mtcsRtlanal=mtcs_target_get_rtlanal(mtcsTarget);
   ...
   cond = XEXP (SET_SRC (set), 0);
   tmp = XEXP (cond, 0);
   if (REG_P (tmp) && mtcs_mode_get_class/*!GET_MODE_CLASS*/(mtcsMode,GET_MODE (tmp)) == MODE_INT
   && (GET_MODE (tmp) != mtcsMode->modes.M_BImode
   || !mtcsTarget/*!targetm.small_register_classes_for_mode_p*/->small_register_classes_for_mode_p(mtcsTarget,
         mtcsMode->modes.M_BImode))){
      *earliest = jump;

      if (reverse)
         cond = gen_rtx_fmt_ee (reverse_condition (GET_CODE (cond)),GET_MODE (cond), tmp, XEXP (cond, 1));
      return cond;
   }
   /* Otherwise, fall back on canonicalize_condition to do the dirty
   work of manipulating MODE_CC values and COMPARE rtx codes.  */
   tmp = mtcs_rtlanal_canonicalize_condition/*!canonicalize_condition*/(mtcsRtlanal,
         jump, cond, reverse, earliest,NULL_RTX, self->have_cbranchcc4, true);
...
static bool noce_operand_ok (MtcsIfcvt *self,const_rtx op)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlanal *mtcsRtlanal=mtcs_target_get_rtlanal(mtcsTarget);
   ...
   return ! mtcs_rtlanal_may_trap_p/*!may_trap_p*/(mtcsRtlanal,op);
}
...
static bool bb_valid_for_noce_process_p (MtcsIfcvt *self,basic_block test_bb, rtx cond,
               unsigned int *cost, bool *simple_p)
{
   ...
   rtx_insn *last_insn = last_active_insn(self,test_bb, false);
   rtx last_set = NULL_RTX;
   rtx cc = cc_in_cond(self,cond);
   if (!insn_valid_noce_process_p(self,last_insn, cc))
      return false;
   ...
   rtx_insn *first_insn = first_active_insn(self,test_bb);
   ...
   if (first_insn == last_insn){
      *simple_p = noce_operand_ok(self,SET_DEST (first_set));
      *cost += mtcs_rtlanal_pattern_cost/*!pattern_cost*/(mtcsRtlanal,first_set, speed_p);
      return *simple_p;
   }
   ...
   int potential_cost = mtcs_rtlanal_pattern_cost/*!pattern_cost*/(mtcsRtlanal,last_set, speed_p);
   rtx_insn *insn;
   FOR_BB_INSNS (test_bb, insn){
      if (insn != last_insn){
         ...
         if (!insn_valid_noce_process_p(self,insn, cc))
         ...
         || !REG_P (dest)
         || mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,dest, cond))
            goto free_bitmap_and_fail;

         potential_cost += mtcs_rtlanal_pattern_cost/*!pattern_cost*/(mtcsRtlanal,sset, speed_p);
...
static rtx_insn* try_emit_cmove_seq (MtcsIfcvt *self,struct noce_if_info *if_info, rtx temp,
          ...
          rtx cc_cmp = NULL, rtx rev_cc_cmp = NULL)
{
   ...
   *cost = 0;
   ...
   mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
   if (need_cmov)
      *temp_dest = noce_emit_cmove(self,if_info, temp, cond_code, x, y, new_val, old_val, cc_cmp, rev_cc_cmp);
   else{
      *temp_dest = temp;
      if (if_info->then_else_reversed)
         noce_emit_move_insn(self,temp, old_val);
      else
         noce_emit_move_insn(self,temp, new_val);
   }
...
/* We have something like:
   ...
   jump instructions.  */
static bool noce_convert_multiple_sets (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   rtx cond = noce_get_condition(self,jump, &cond_earliest, false);
   rtx x = XEXP (cond, 0);
   rtx y = XEXP (cond, 1);
   ...
   need_cmov_or_rewire(self,then_bb, &need_no_cmov, &rewired_src);

   int last_needs_comparison = -1;

   bool ok = noce_convert_multiple_sets_1(self,if_info,
         &need_no_cmov, &rewired_src, &targets, &temporaries,&unmodified_insns, &last_needs_comparison);
   if (!ok)
      return false;
   ...
   if (last_needs_comparison != -1){
      mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);
      mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
      ok = noce_convert_multiple_sets_1(self,if_info,
            &need_no_cmov, &rewired_src, &targets, &temporaries,&unmodified_insns, &last_needs_comparison);
   ...
   for (unsigned i = 0; i < targets.length (); i++)
      if (targets[i] != temporaries[i])
         noce_emit_move_insn(self,targets[i], temporaries[i]);

   /* Actually emit the sequence if it isn't too expensive.  */
   rtx_insn *seq = mtcs_rtl_data_get_insns/*!get_insns*/(mtcsRtlData);

   if (!mtcsTarget/*!targetm.noce_conversion_profitable_p*/->noce_conversion_profitable_p(mtcsTarget,seq, if_info)){
      mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);
      return false;
   }
   ...
   for (insn = seq; insn; insn = NEXT_INSN (insn))
      if (JUMP_P (insn) || mtcs_recog_recog_memoized/*!recog_memoized*/(mtcsRecog,insn) == -1)
         return false;

   mtcs_emit_emit_insn_before_setloc/*!emit_insn_before_setloc*/(mtcsEmit,
         seq, if_info->jump,INSN_LOCATION (unmodified_insns.last ()));

   /* Clean up THEN_BB and the edges in and out of it.  */
   mtcs_cfg_context_remove_edge/*!remove_edge*/(mtcsCfgContext,find_edge (test_bb, join_bb));
   mtcs_cfg_context_remove_edge/*!remove_edge*/(mtcsCfgContext,find_edge (then_bb, join_bb));
   mtcs_cfg_context_redirect_edge_and_branch_force/*!redirect_edge_and_branch_force*/(mtcsCfgContext,
         single_succ_edge (test_bb), join_bb);
   mtcs_cfg_context_delete_basic_block/*!delete_basic_block*/(mtcsCfgContext,then_bb);
   self->num_true_changes++;

   /* Maybe merge blocks now the jump is simple enough.  */
   if (can_merge_blocks_p (test_bb, join_bb)){
      mtcs_cfg_context_merge_blocks/*!merge_blocks*/(mtcsCfgContext,test_bb, join_bb);
      self->num_true_changes++;
   }

   self->num_updated_if_blocks++;
   if_info->transform_name = "noce_convert_multiple_sets";
   return true;
}

typedef struct _CheckClobberData{
    MtcsIfcvt *mtcsIfcvt;
    rtx *data;
}CheckClobberData;
/* Helper function for noce_convert_multiple_sets_1.  If store to
   DEST can affect P[0] or P[1], clear P[0].  Called via note_stores.  */
static void checkForCCCmpClobbers_cb (rtx dest, const_rtx, void *userData)
{
   CheckClobberData *checkClobberInfo=(CheckClobberData *)userData;
   MtcsIfcvt *self=(MtcsIfcvt *)checkClobberInfo->mtcsIfcvt;
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlanal *mtcsRtlanal=mtcs_target_get_rtlanal(mtcsTarget);

   rtx *p = (rtx *) checkClobberInfo->data;
   if (p[0] == NULL_RTX)
      return;
   if (mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,dest, p[0])
   || (p[1] && mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,dest, p[1])))
      p[0] = NULL_RTX;
}
...
/* This goes through all relevant insns of IF_INFO->then_bb and tries to
   ...
   to this function..  */
static bool noce_convert_multiple_sets_1 (MtcsIfcvt *self,struct noce_if_info *if_info,
               hash_set<rtx_insn *> *need_no_cmov,
               hash_map<rtx_insn *, int> *rewired_src,
               auto_vec<rtx> *targets,
               auto_vec<rtx> *temporaries,
               ...
               int *last_needs_comparison)
{
   ...
   rtx cc_cmp = cond_exec_get_condition(self,jump);
   if (cc_cmp)
      cc_cmp = copy_rtx (cc_cmp);
   rtx rev_cc_cmp = cond_exec_get_condition(self,jump, /* get_reversed */ true);
   if (rev_cc_cmp)
   ...
   FOR_BB_INSNS (then_bb, insn){
      ...
      if (int *ii = rewired_src->get (insn))
         new_val = mtcs_simplify_rtx_simplify_replace_rtx/*!simplify_replace_rtx*/(mtcsSimplifyRtx,
               new_val, (*targets)[*ii],(*temporaries)[*ii]);
      rtx old_val = target;
      ...
      if (mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,target, cond)
      && (!second_try || count < *last_needs_comparison))
         temp = mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (target));
      else
         temp = target;
      ...
      seq1 = try_emit_cmove_seq(self,if_info, temp, cond,new_val, old_val, need_cmov, &cost1, &temp_dest1);
      ...
      if (cc_cmp)
         seq2 = try_emit_cmove_seq(self,if_info, temp, cond, new_val,
               old_val, need_cmov, &cost2, &temp_dest2, cc_cmp, rev_cc_cmp);
      ...
      while (walk){
         ...
         if (XEXP (set, 1) && GET_CODE (XEXP (set, 1)) == IF_THEN_ELSE)
            ...
            if (reg_mentioned_p (XEXP (cond, 0), src) || reg_mentioned_p (XEXP (cond, 1), src)){
      ...
      if (cc_cmp){
         ...
         CheckClobberData userData={self,cc_cmp_pair};
         for (walk = seq; walk; walk = NEXT_INSN (walk)){
            mtcs_rtlanal_note_stores/*!note_stores*/(mtcsRtlanal,walk, checkForCCCmpClobbers_cb, &userData/*!cc_cmp_pair*/);
...
static bool bb_ok_for_noce_convert_multiple_sets (MtcsIfcvt *self,basic_block test_bb, unsigned *cost)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsOptabs  *mtcsOptabs=mtcs_target_get_optabs(mtcsTarget);
   ...
   rtx_insn *insn;
   unsigned count = 0;
   unsigned param = mtcsOptionsItem->x_param_max_rtl_if_conversion_insns;
   bool speed_p = optimize_bb_for_speed_p (test_bb);
   ...
   FOR_BB_INSNS (test_bb, insn){
      ...
      if (!((REG_P (src) || CONSTANT_P (src)) || (GET_CODE (src) == SUBREG && REG_P (SUBREG_REG (src))
      && mtcs_rtl_subreg_lowpart_p/*!subreg_lowpart_p*/(mtcsRTL,src))))
         return false;

      /* Destination must be appropriate for a conditional write.  */
      if (!noce_operand_ok(self,dest))
         return false;
      /* We must be able to conditionally move in this mode.  */
      if (!mtcs_optabs_can_conditionally_move_p/*!can_conditionally_move_p*/(mtcsOptabs,GET_MODE (dest)))
         return false;
      potential_cost += mtcs_rtlanal_insn_cost/*!insn_cost*/(mtcsRtlanal,insn, speed_p);
      count++;
   }
...
static unsigned average_cost (MtcsIfcvt *self,unsigned then_cost, unsigned else_cost, edge e)
{
...
static bool noce_process_if_block (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if (!else_bb
   && mtcs_config_get_value/*!HAVE_conditional_move*/(mtcsConfig,MTCS_HAVE_conditional_move)
   && bb_ok_for_noce_convert_multiple_sets(self,then_bb, &potential_cost)){
      ...
      if (noce_convert_multiple_sets(self,if_info)){
   ...
   if (!bb_valid_for_noce_process_p(self,then_bb, cond, &then_cost, &if_info->then_simple))
   return false;

   if (else_bb  && !bb_valid_for_noce_process_p(self,else_bb, cond, &else_cost, &if_info->else_simple))
      return false;

   if (speed_p)
      if_info->original_cost += average_cost(self,then_cost, else_cost,find_edge (test_bb, then_bb));
   else
      if_info->original_cost += then_cost + else_cost;

   insn_a = last_active_insn(self,then_bb, false);
   ...
   set_b = NULL_RTX;
   if (else_bb){
      insn_b = last_active_insn(self,else_bb, false);
      set_b = single_set (insn_b);
      gcc_assert (set_b);

      if (!rtx_interchangeable_p(self,x, SET_DEST (set_b)))
         return false;
   }else{
      insn_b = if_info->cond_earliest;
      do
         insn_b = prev_nonnote_nondebug_insn (insn_b);
      while (insn_b  && (BLOCK_FOR_INSN (insn_b) == BLOCK_FOR_INSN (if_info->cond_earliest))
      && !mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,x, insn_b));
      ...
      || ! rtx_interchangeable_p(self,x, SET_DEST (set_b))
      || ! noce_operand_ok(self,SET_SRC (set_b))
      || mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,x, SET_SRC (set_b))
      || mtcs_rtlanal_modified_between_p/*!modified_between_p*/(mtcsRtlanal,SET_SRC (set_b), insn_b, jump)
      /* Avoid extending the lifetime of hard registers on small
      register class machines.  */
      || (REG_P (SET_SRC (set_b))
      && mtcs_reg_is_hard_rtx/*!HARD_REGISTER_P*/(mtcsReg,SET_SRC (set_b))
      && mtcsTarget/*!targetm.small_register_classes_for_mode_p*/->small_register_classes_for_mode_p(mtcsTarget,GET_MODE (SET_SRC (set_b))))
      /* Likewise with X.  In particular this can happen when
      noce_get_condition looks farther back in the instruction
      stream than one might expect.  */
      || mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,x, cond)
      || mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,x, a)
      || mtcs_rtlanal_modified_between_p/*!modified_between_p*/(mtcsRtlanal,x, insn_b, jump)){
         insn_b = NULL;
         set_b = NULL_RTX;
      }
   }
   ...
   && mtcsTarget/*!targetm.small_register_classes_for_mode_p*/->small_register_classes_for_mode_p(mtcsTarget,GET_MODE (x)))){
      if (GET_MODE (x) == mtcsMode->modes.M_BLKmode)
         return false;

      if (GET_CODE (x) == ZERO_EXTRACT  && (!CONST_INT_P (XEXP (x, 1)) || !CONST_INT_P (XEXP (x, 2))))
         return false;

      x = mtcs_emit_gen_reg_rtx/*!gen_reg_rtx*/(mtcsEmit,GET_MODE (GET_CODE (x) == STRICT_LOW_PART ? XEXP (x, 0) : x));
   }

   /* Don't operate on sources that may trap or are volatile.  */
   if (! noce_operand_ok(self,a) || ! noce_operand_ok(self,b))
      return false;
...
retry:
   ...
   if (noce_simple_bbs(self,if_info)  && rtx_interchangeable_p(self,a, b)) {
   ...
   if (insn_b && else_bb){
         ...
         mtcs_rtl_reorder_insns/*!reorder_insns*/(mtcsRTL,insn_b, insn_b, PREV_INSN (jump));

         /* If there was a REG_EQUAL note, delete it since it may have been
         true due to this insn being after a jump.  */
         if ((note = find_reg_note (insn_b, REG_EQUAL, NULL_RTX)) != 0)
            mtcs_rtlanal_remove_note/*!remove_note*/(mtcsRtlanal,insn_b, note);
   ...
   if (noce_try_move(self,if_info))
      goto success;
   if (noce_try_ifelse_collapse(self,if_info))
      goto success;
   if (noce_try_store_flag(self,if_info))
      goto success;
   if (noce_try_bitop(self,if_info))
      goto success;
   if (noce_try_minmax(self,if_info))
      goto success;
   if (noce_try_abs(self,if_info))
      goto success;
   if (noce_try_inverse_constants(self,if_info))
      goto success;
   if (!mtcsTarget->have_conditional_execution/*!targetm.have_conditional_execution*/(mtcsTarget)
         && noce_try_store_flag_constants(self,if_info))
      goto success;
   if ( mtcs_config_get_value/*!HAVE_conditional_move*/(mtcsConfig,MTCS_HAVE_conditional_move)
         && noce_try_cmove(self,if_info))
      goto success;
   if (! mtcsTarget->have_conditional_execution/*!targetm.have_conditional_execution*/(mtcsTarget)){
      if (noce_try_addcc(self,if_info))
         goto success;
      if (noce_try_store_flag_mask(self,if_info))
         goto success;
      if ( mtcs_config_get_value/*!HAVE_conditional_move*/(mtcsConfig,MTCS_HAVE_conditional_move)
            && noce_try_cond_zero_arith(self,if_info))
         goto success;
      if ( mtcs_config_get_value/*!HAVE_conditional_move*/(mtcsConfig,MTCS_HAVE_conditional_move)
            && noce_try_cmove_arith(self,if_info))
         goto success;
      if (noce_try_sign_mask(self,if_info))
         goto success;
   }
...
success:
   ...
   if (orig_x != x){
      ...
      mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
      noce_emit_move_insn(self,orig_x, x);
      seq = mtcs_rtl_data_get_insns/*!get_insns*/(mtcsRtlData);
      set_used_flags (orig_x);
      mtcs_rtl_unshare_all_rtl_in_chain/*!unshare_all_rtl_in_chain*/(mtcsRTL,seq);
      mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);

      mtcs_emit_emit_insn_before_setloc/*!emit_insn_before_setloc*/(mtcsEmit,seq, BB_END (test_bb), INSN_LOCATION (insn_a));
   }
   ...
   can be merged, do so.  */
   if (else_bb){
      mtcs_cfg_context_delete_basic_block/*!delete_basic_block*/(mtcsCfgContext,else_bb);
      self->num_true_changes++;
   }else
      mtcs_cfg_context_remove_edge/*!remove_edge*/(mtcsCfgContext,find_edge (test_bb, join_bb));
...
static bool check_cond_move_block (MtcsIfcvt *self,basic_block bb, hash_map<rtx, rtx> *vals, vec<rtx> *regs,rtx cond)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlanal *mtcsRtlanal=mtcs_target_get_rtlanal(mtcsTarget);
   ...
   FOR_BB_INSNS (bb, insn){
      ...
      && mtcsTarget/*!targetm.small_register_classes_for_mode_p*/->small_register_classes_for_mode_p(mtcsTarget,GET_MODE (dest))))
         return false;

      if (!CONSTANT_P (src) && !mtcs_preds_register_operand/*!register_operand*/(mtcsPreds,src, VOIDmode))
         return false;

      if (side_effects_p (src) || side_effects_p (dest))
         return false;

      if (mtcs_rtlanal_may_trap_p/*!may_trap_p*/(mtcsRtlanal,src)
            || mtcs_rtlanal_may_trap_p/*!may_trap_p*/(mtcsRtlanal,dest))
         return false;

      /* Don't try to handle this if the source register was
      modified earlier in the block.  */
      if ((REG_P (src)  && vals->get (src))
      || (GET_CODE (src) == SUBREG && REG_P (SUBREG_REG (src))    && vals->get (SUBREG_REG (src))))
         return false;
      ...
      if (mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,dest, cond))
         return false;

      /* Don't try to handle this if the source register is modified
      later in the block.  */
      if (!CONSTANT_P (src)  && mtcs_rtlanal_modified_between_p/*!modified_between_p*/(mtcsRtlanal,src, insn, NEXT_INSN (BB_END (bb))))
         return false;

      /* Skip it if the instruction to be moved might clobber CC.  */
      if (cc && mtcs_rtlanal_set_of/*!set_of*/(mtcsRtlanal,cc, insn))
         return false;
...
*/
static void need_cmov_or_rewire (MtcsIfcvt *self,basic_block bb,
           hash_set<rtx_insn *> *need_no_cmov, hash_map<rtx_insn *, int> *rewired_src)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlanal *mtcsRtlanal=mtcs_target_get_rtlanal(mtcsTarget);
   ...
   FOR_BB_INSNS (bb, insn){
      ...
      if (REG_P (src))
         for (int i = count - 1; i >= 0; --i)
            if (mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,src, dests[i])){
...
static bool cond_move_convert_if_block (MtcsIfcvt *self,struct noce_if_info *if_infop,
             basic_block bb, rtx cond,    hash_map<rtx, rtx> *then_vals,
             hash_map<rtx, rtx> *else_vals,       bool else_block_p)
{
   enum rtx_code code;
   rtx_insn *insn;
   ...
   FOR_BB_INSNS (bb, insn){
      ...
      target = noce_emit_cmove(self,if_infop, dest, code, cond_arg0, cond_arg1,t, e);
      if (!target)
         return false;

      if (target != dest)
         noce_emit_move_insn(self,dest, target);
   }
...
static bool cond_move_process_if_block (MtcsIfcvt *self,struct noce_if_info *if_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsOptions *mtcsOptions=mtcs_target_get_options(mtcsTarget);
   ...
   int limit = mtcsOptionsItem->x_param_max_rtl_if_conversion_insns;
   ...
   if (!check_cond_move_block(self,then_bb, &then_vals, &then_regs, cond)
   || (else_bb && !check_cond_move_block(self,else_bb, &else_vals, &else_regs, cond)))
      goto done;
   ...
   for (rtx reg : then_regs){
      ...
      if (!else_slot)
         ...
         if (!CONSTANT_P (then_val) && !CONSTANT_P (else_val)  && !rtx_equal_p (then_val, else_val))
            goto done;
      }
   }
   ...
   them.  */
   if (c > MAX_CONDITIONAL_EXECUTE || c > limit)
      goto done;

   /* Try to emit the conditional moves.  First do the then block,
   then do anything left in the else blocks.  */
   mtcs_emit_start_sequence/*!start_sequence*/(mtcsEmit);
   if (!cond_move_convert_if_block(self,if_info, then_bb, cond,
   &then_vals, &else_vals, false)
   || (else_bb  && !cond_move_convert_if_block(self,if_info, else_bb, cond, &then_vals, &else_vals, true))){
      mtcs_emit_end_sequence/*!end_sequence*/(mtcsEmit);
      goto done;
   }
   seq = end_ifcvt_sequence(self,if_info);
   ...
   loc_insn = first_active_insn(self,then_bb);
   if (!loc_insn){
      loc_insn = first_active_insn(self,else_bb);
      gcc_assert (loc_insn);
   }
   mtcs_emit_emit_insn_before_setloc/*!emit_insn_before_setloc*/(mtcsEmit,seq, jump, INSN_LOCATION (loc_insn));
...
static bool noce_find_if_block (MtcsIfcvt *self,basic_block test_bb, edge then_edge, edge else_edge,
          int pass)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   ...
   if (single_succ_edge (then_bb)->flags & EDGE_COMPLEX)
      return false;
   if (else_bb && single_succ_edge (else_bb)->flags & EDGE_COMPLEX)
      return false;

   self->num_possible_if_blocks++;

   if (dump_file){
      fprintf (dump_file,"\nIF-THEN%s-JOIN block found, pass %d, test %d, then %d",
      (else_bb) ? "-ELSE" : "",pass, test_bb->index, then_bb->index);
   ...
   if_info.cond = noce_get_condition(self,jump, &cond_earliest,then_else_reversed);
   rtx_insn *rev_cond_earliest;
   if_info.rev_cond = noce_get_condition(self,jump, &rev_cond_earliest,!then_else_reversed);
   ...
   if (GET_MODE (XEXP (if_info.cond, 0)) == mtcsMode->modes.M_BLKmode)
      return false;
   ...
   if_info.max_seq_cost = mtcsTarget/*!targetm.max_noce_ifcvt_seq_cost*/->max_noce_ifcvt_seq_cost(mtcsTarget,then_edge);
   ...
   inverted conditions.  */
   if (!if_info.cond_inverted && noce_process_if_block(self,&if_info))
      return true;

   if ( mtcs_config_get_value/*!HAVE_conditional_move*/(mtcsConfig,MTCS_HAVE_conditional_move)
   && cond_move_process_if_block(self,&if_info))
      return true;
...
static void merge_if_block (MtcsIfcvt *self,struct ce_if_block * ce_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsCfgContext *mtcsCfgContext=mtcs_target_get_cfg_context(mtcsTarget);
   ...
   combo_bb = test_bb;
   mtcs_dfcore_df_set_bb_dirty/*!df_set_bb_dirty*/(mtcsDfcore,test_bb);
   ...
   if (ce_info->num_multiple_test_blocks > 0){
      basic_block bb = test_bb;
      basic_block last_test_bb = ce_info->last_test_bb;
      basic_block fallthru = block_fallthru(self,bb);

      do{
         bb = fallthru;
         fallthru = block_fallthru(self,bb);
         mtcs_cfg_context_merge_blocks/*!merge_blocks*/(mtcsCfgContext,combo_bb, bb);
         self->num_true_changes++;
      }while (bb != last_test_bb);
   }
   ...
   if (then_bb){
      ...
      the insn stream.  */
      if (EDGE_COUNT (then_bb->succs) == 0 && EDGE_COUNT (combo_bb->succs) > 1){
         rtx_insn *end = NEXT_INSN (BB_END (then_bb));
         while (end && NOTE_P (end) && !NOTE_INSN_BASIC_BLOCK_P (end))
            end = NEXT_INSN (end);

         if (end && BARRIER_P (end))
            mtcs_cfg_rtl_delete_insn/*!delete_insn*/(mtcsCfgRtl,end);
      }
      mtcs_cfg_context_merge_blocks/*!merge_blocks*/(mtcsCfgContext,combo_bb, then_bb);
      self->num_true_changes++;
   }
   ...
   if (else_bb){
      ...
      is no longer needed, and in fact it is incorrect to leave it in
      the insn stream.  */
      if (EDGE_COUNT (else_bb->succs) == 0  && EDGE_COUNT (combo_bb->succs) > 1){
      ...
      mtcs_cfg_context_merge_blocks/*!merge_blocks*/(mtcsCfgContext,combo_bb, else_bb);
      self->num_true_changes++;
   }
   ...
   if (! join_bb){
      ...
      if (EDGE_COUNT (combo_bb->succs) == 0)
         gcc_assert (find_reg_note (last, REG_NORETURN, NULL) || (NONJUMP_INSN_P (last)
               && GET_CODE (PATTERN (last)) == TRAP_IF   && (TRAP_CONDITION (PATTERN (last)) == const_true_rtx)));
      else
         /* There should still be something at the end of the THEN or ELSE
         blocks taking us to our final destination.  */
         gcc_assert (JUMP_P (last) || (EDGE_SUCC (combo_bb, 0)->dest == EXIT_BLOCK_PTR_FOR_FN (cfun)
               && CALL_P (last) && SIBLING_CALL_P (last)) || ((EDGE_SUCC (combo_bb, 0)->flags & EDGE_EH)
   ...
   back up (as with a call to a non-return function).  */
   else if (EDGE_COUNT (join_bb->preds) < 2  && join_bb != EXIT_BLOCK_PTR_FOR_FN (cfun)){
      /* We can merge the JOIN cleanly and update the dataflow try
      again on this pass.*/
      mtcs_cfg_context_merge_blocks/*!merge_blocks*/(mtcsCfgContext,combo_bb, join_bb);
      self->num_true_changes++;
   }else{
      ...
      /* The outgoing edge for the current COMBO block should already
      be correct.  Verify this.  */
      gcc_assert (single_succ_p (combo_bb)  && single_succ (combo_bb) == join_bb);
...
static basic_block find_if_header (MtcsIfcvt *self,basic_block test_bb, int pass)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsDfcore *mtcsDfcore=mtcs_target_get_dfcore(mtcsTarget);
   ...
   if (mtcs_dfcore_df_get_bb_dirty/*!df_get_bb_dirty*/(mtcsDfcore,then_edge->dest))
      return NULL;
   if (mtcs_dfcore_df_get_bb_dirty/*!df_get_bb_dirty*/(mtcsDfcore,else_edge->dest))
      return NULL;

   /* Neither edge should be abnormal.  */
   if ((then_edge->flags & EDGE_COMPLEX) || (else_edge->flags & EDGE_COMPLEX))
      return NULL;

   /* Nor exit the loop.  */
   if ((then_edge->flags & EDGE_LOOP_EXIT) || (else_edge->flags & EDGE_LOOP_EXIT))
      return NULL;
   ...
   if (!reload_completed && noce_find_if_block(self,test_bb, then_edge, else_edge, pass))
      goto success;

   if (reload_completed  && mtcsTarget->have_conditional_execution/*!targetm.have_conditional_execution*/(mtcsTarget)
   && cond_exec_find_if_block(self,&ce_info))
      goto success;

   if (target_rtx_have_trap/*!targetm.have_trap*/(mtcsMachine->tmrtx)
   && mtcs_opinit_optab_handler/*!optab_handler*/(mtcsOpinit,ctrap_optab, word_mode) != CODE_FOR_nothing
   && find_cond_trap(self,test_bb, then_edge, else_edge))
      goto success;

   if (dom_info_state (CDI_POST_DOMINATORS) >= DOM_NO_FAST_QUERY
   && (reload_completed || !mtcsTarget->have_conditional_execution/*!targetm.have_conditional_execution*/(mtcsTarget))){
      if (find_if_case_1(self,test_bb, then_edge, else_edge))
         goto success;
      if (find_if_case_2(self,test_bb, then_edge, else_edge))
         goto success;
   }
...
static int block_jumps_and_fallthru (MtcsIfcvt *self,basic_block cur_bb, basic_block target_bb)
{
   edge cur_edge;
...
static bool cond_exec_find_if_block (MtcsIfcvt *self,struct ce_if_block * ce_info)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRecog *mtcsRecog=mtcs_target_get_recog(mtcsTarget);
   ...
   gcc_assert (reload_completed && mtcsTarget/*!targetm.have_conditional_execution*/->have_conditional_execution(mtcsTarget));

   /* Discover if any fall through predecessors of the current test basic block
   were && tests (which jump to the else block) or || tests (which jump to
   the then block).  */
   if (single_pred_p (test_bb)  && single_pred_edge (test_bb)->flags == EDGE_FALLTHRU){
      ...
      if ((n_insns = block_jumps_and_fallthru(self,bb, else_bb)) >= 0){
         ce_info->and_and_p = true;
         target_bb = else_bb;
      }else if ((n_insns = block_jumps_and_fallthru(self,bb, then_bb)) >= 0){
      ...
      if (target_bb && n_insns <= max_insns){
         ...
         do{
            ...
            bb = single_pred (bb);
            n_insns = block_jumps_and_fallthru(self,bb, target_bb);
   ...
   && (!single_succ_p (then_bb) || (single_succ_edge (then_bb)->flags & EDGE_COMPLEX)
   ...
   if (EDGE_COUNT (then_bb->succs) == 0){
      if (single_pred_p (else_bb) && else_bb != EXIT_BLOCK_PTR_FOR_FN (cfun)){
         ...
         while (last_insn && NOTE_P (last_insn) && last_insn != BB_HEAD (then_bb))
            last_insn = PREV_INSN (last_insn);

         if (last_insn && JUMP_P (last_insn) && ! simplejump_p (last_insn))
            return false;
   ...
   if (dump_file){
      fprintf (dump_file,"\nIF-THEN%s block found, pass %d, start block %d [insn %d], then %d [%d]",
               (else_bb) ? "-ELSE" : "", ce_info->pass, test_bb->index,
               BB_HEAD (test_bb) ? (int)INSN_UID (BB_HEAD (test_bb)) : -1,
               then_bb->index,
               BB_HEAD (then_bb) ? (int)INSN_UID (BB_HEAD (then_bb)) : -1);

      if (else_bb)
         fprintf (dump_file, ", else %d [%d]", else_bb->index, BB_HEAD (else_bb) ? (int)INSN_UID (BB_HEAD (else_bb)) : -1);

      fprintf (dump_file, ", join %d [%d]", join_bb->index, BB_HEAD (join_bb) ? (int)INSN_UID (BB_HEAD (join_bb)) : -1);
      ...
      if (ce_info->num_multiple_test_blocks > 0)
         fprintf (dump_file, ", %d %s block%s last test %d [%d]",
               ...
               ((BB_HEAD (ce_info->last_test_bb)) ? (int)INSN_UID (BB_HEAD (ce_info->last_test_bb)): -1));
   ...
   if (else_bb && (next = next->next_bb) != else_bb)
      return false;
   if ((next = next->next_bb) != join_bb && join_bb != EXIT_BLOCK_PTR_FOR_FN (cfun)){
      if (else_bb)
         join_bb = NULL;
      else
         return false;
   ...
   was no ELSE block.  */
   if (cond_exec_process_if_block(self,ce_info, true))
      return true;

   if (ce_info->num_multiple_test_blocks){
      mtcs_recog_cancel_changes/*!cancel_changes*/(mtcsRecog,0);

      if (cond_exec_process_if_block(self,ce_info, false))
         return true;
   }
...
static bool find_cond_trap (MtcsIfcvt *self,basic_block test_bb, edge then_edge, edge else_edge)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRecog *mtcsRecog=mtcs_target_get_recog(mtcsTarget);
   ...
   if ((trap = block_has_only_trap(self,then_bb)) != NULL)
      trap_bb = then_bb, other_bb = else_bb;
   else if ((trap = block_has_only_trap(self,else_bb)) != NULL)
   ...
   jump = BB_END (test_bb);
   cond = noce_get_condition(self,jump, &cond_earliest, then_bb == trap_bb);
   if (! cond)
      return false;
   ...
   /* We must be comparing objects whose modes imply the size.  */
   if (GET_MODE (XEXP (cond, 0)) ==mtcsMode->modes.M_BLKmode)
      return false;

   /* Attempt to generate the conditional trap.  */
   rtx_insn *seq = mtcs_optabs_gen_cond_trap/*!gen_cond_trap*/(mtcsOptabs,GET_CODE (cond), copy_rtx (XEXP (cond, 0)),
   copy_rtx (XEXP (cond, 1)),TRAP_CODE (PATTERN (trap)));
   if (seq == NULL)
      return false;
   ...
   for (rtx_insn *x = seq; x; x = NEXT_INSN (x))
      if (reload_completed
            ? !mtcs_recog_valid_insn_p/*!valid_insn_p*/(mtcsRecog,x)
            : mtcs_recog_recog_memoized/*!recog_memoized*/(mtcsRecog,x) < 0)
         return false;

   /* Emit the new insns before cond_earliest.  */
   mtcs_emit_emit_insn_before_setloc/*!emit_insn_before_setloc*/(mtcsEmit,seq, cond_earliest, INSN_LOCATION (trap));

   /* Delete the trap block if possible.  */
   mtcs_cfg_context_remove_edge/*!remove_edge*/(mtcsCfgContext,trap_bb == then_bb ? then_edge : else_edge);
   mtcs_dfcore_df_set_bb_dirty/*!df_set_bb_dirty*/(mtcsDfcore,test_bb);
   mtcs_dfcore_df_set_bb_dirty/*!df_set_bb_dirty*/(mtcsDfcore,then_bb);
   mtcs_dfcore_df_set_bb_dirty/*!df_set_bb_dirty*/(mtcsDfcore,else_bb);

   if (EDGE_COUNT (trap_bb->preds) == 0){
      mtcs_cfg_context_delete_basic_block/*!delete_basic_block*/(mtcsCfgContext,trap_bb);
      self->num_true_changes++;
   }
   ...
   if (mtcs_cfg_context_get_state/*!current_ir_type ()*/(mtcsCfgContext) == IR_RTL_CFGLAYOUT)
      ...
      rtx_insn *seq = target_rtx_gen_jump/*!targetm.gen_jump*/(mtcsMachine->tmrtx,lab);
      rtx_jump_insn *newjump = mtcs_emit_emit_jump_insn_after/*!emit_jump_insn_after*/(mtcsEmit,seq, jump);
      LABEL_NUSES (lab) += 1;
      JUMP_LABEL (newjump) = lab;
      mtcs_emit_emit_barrier_after/*!emit_barrier_after*/(mtcsEmit,newjump);
   }
   mtcs_cfg_rtl_delete_insn/*!delete_insn*/(mtcsCfgRtl,jump);

   if (can_merge_blocks_p (test_bb, other_bb)){
      mtcs_cfg_context_merge_blocks/*!merge_blocks*/(mtcsCfgContext,test_bb, other_bb);
      self->num_true_changes++;
   }
...
/* Subroutine of find_cond_trap: if BB contains only a trap insn,
   return it.  */
static rtx_insn *block_has_only_trap (MtcsIfcvt *self,basic_block bb)
{
   rtx_insn *trap;
   ...
   trap = first_active_insn(self,bb);
   if (! (trap == BB_END (bb)
...
static bool find_if_case_1 (MtcsIfcvt *self,basic_block test_bb, edge then_edge, edge else_edge)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsCfgContext *mtcsCfgContext=mtcs_target_get_cfg_context(mtcsTarget);
   ...
   if (! cheap_bb_rtx_cost_p(self,then_bb, then_prob,
   ...
   if (! dead_or_predicable(self,test_bb, then_bb, else_bb,single_succ_edge (then_bb), true))
      return false;
   ...
   if (then_bb->next_bb == else_bb  && then_bb->prev_bb == test_bb && else_bb != EXIT_BLOCK_PTR_FOR_FN (cfun)){
      mtcs_cfg_redirect_edge_succ/*!redirect_edge_succ*/(mtcsCfg,FALLTHRU_EDGE (test_bb), else_bb);
      new_bb = 0;
   }else if (else_bb == EXIT_BLOCK_PTR_FOR_FN (cfun))
      new_bb =mcs_cfg_rtl_force_nonfallthru_and_redirect/*!force_nonfallthru_and_redirect*/(mtcsCfgRtl,
            FALLTHRU_EDGE (test_bb),else_bb, else_target);
   else
   new_bb = mtcs_cfg_context_redirect_edge_and_branch_force/*!redirect_edge_and_branch_force*/(mtcsCfgContext,
         FALLTHRU_EDGE (test_bb),else_bb);
   ...
   block we removed.  */
   if (new_bb){
      mtcs_dfcore_df_bb_replace/*!df_bb_replace*/(mtcsDfcore,then_bb_index, new_bb);
...
static bool find_if_case_2 (MtcsIfcvt *self,basic_block test_bb, edge then_edge, edge else_edge)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsCfgContext *mtcsCfgContext=mtcs_target_get_cfg_context(mtcsTarget);
   ...
   if (current_loops && else_bb->loop_father->latch == else_bb)
      return false;
   ...
   if (else_prob > then_prob)
      ;
   else if (else_succ->dest->index < NUM_FIXED_BLOCKS || dominated_by_p (CDI_POST_DOMINATORS, then_bb,else_succ->dest))
      ;
   else
      return false;
   ...
   of speculation is within reason.  */
   if (! cheap_bb_rtx_cost_p(self,else_bb,
         else_prob,COSTS_N_INSNS (BRANCH_COST (optimize_bb_for_speed_p (else_edge->src), predictable_edge_p (else_edge)))))
      return false;

   /* Registers set are dead, or are predicable.  */
   if (! dead_or_predicable(self,test_bb, else_bb, then_bb, else_succ, false))
      return false;
...
static bool dead_or_predicable (MtcsIfcvt *self,basic_block test_bb, basic_block merge_bb,
          basic_block other_bb, edge dest_edge, bool reversep)
{
   ...
   if (mtcsTarget/*!targetm.have_conditional_execution*/->have_conditional_execution(mtcsTarget)){
      ...
      cond = cond_exec_get_condition(self,jump);
      if (! cond)
         goto nce;

      rtx note = find_reg_note (jump, REG_BR_PROB, NULL_RTX);
      profile_probability prob_val = (note ? profile_probability::from_reg_br_prob_note (XINT (note, 0))
      ...
      if (cond_exec_process_insns(self,NULL, head, end, cond, prob_val, false)
            && mtcs_recog_verify_changes/*!verify_changes*/(mtcsRecog,0))
         n_validated_changes = mtcs_recog_num_validated_changes/*!num_validated_changes*/(mtcsRecog);
      else
         mtcs_recog_cancel_changes/*!cancel_changes*/(mtcsRecog,0);
...
nce:
   ...
   array first.  */
   if (max_regno < mtcs_func_max_reg_num/*!max_reg_num*/(mtcsFunc))
   ...
   if (n_validated_changes == 0){
      ...
      cond = noce_get_condition(self,jump, &earliest, false);
      if (!cond)
         return false;

      live = BITMAP_ALLOC (&reg_obstack);
      mtcs_dfproblems_simulate_backwards_to_point/*!simulate_backwards_to_point*/(mtcsDfproblems,merge_bb, live, end);
      success = mtcs_dfproblems_can_move_insns_across/*!can_move_insns_across*/(mtcsDfproblems,
            head, end, earliest, jump,merge_bb, live, df_get_live_in (other_bb), NULL);
      BITMAP_FREE (live);
      if (!success)
         return false;
      ...
      FOR_BB_INSNS (merge_bb, insn)
         if (NONDEBUG_INSN_P (insn))
            mtcs_dfproblems_df_simulate_find_defs/*!df_simulate_find_defs*/(mtcsDfproblems,insn, merge_set);
      ...
      && bitmap_intersect_p (df_get_live_in (new_dest), merge_set)){
         ...
         for (i = 0; i < mtcs_reg_get_first_pseudo_register/*!FIRST_PSEUDO_REGISTER*/(mtcsReg); i++)
            if (mtcs_func_is_function_arg_regno/*!FUNCTION_ARG_REGNO_P*/(mtcsFunc,i)
                  && target_calls_function_value_regno_p/*!targetm.calls.function_value_regno_p*/(mtcsMachine->calls,i))
               bitmap_set_bit (return_regs, mtcs_reg_get_incoming_regno/*!INCOMING_REGNO*/(mtcsReg,i));
               ...
               if (NONDEBUG_INSN_P (insn)){
                  ...
                  FOR_EACH_INSN_DEF (def, insn)
                     if (bitmap_bit_p (return_regs, DF_REF_REGNO (def))){
                        mtcs_dfproblems_df_simulate_uses/*!df_simulate_uses*/(mtcsDfproblems,insn, return_regs);
                        break;
                     }
               }
...
no_body:
   ...
   if (other_bb != new_dest){
      ...
      if (JUMP_P (BB_END (dest_edge->src)))
         ...
         new_dest_label = mtcs_cfg_rtl_block_label/*!block_label*/(mtcsCfgRtl,new_dest);

      rtx_jump_insn *jump_insn = as_a <rtx_jump_insn *> (jump);
      if (reversep ? ! mtcs_dojump_invert_jump_1/*!invert_jump_1*/(mtcsDojump,jump_insn, new_dest_label) :
            ! mtcs_dojump_redirect_jump_1/*!redirect_jump_1*/(mtcsDojump,jump_insn, new_dest_label))
         goto cancel;
   }

   if (mtcs_recog_verify_changes/*!verify_changes*/(mtcsRecog,n_validated_changes))
      mtcs_recog_confirm_change_group/*!confirm_change_group*/(mtcsRecog);
   else
      goto cancel;

   if (other_bb != new_dest){
      mtcs_dojump_redirect_jump_2/*!redirect_jump_2*/(mtcsDojump,as_a <rtx_jump_insn *> (jump), old_dest, new_dest_label,0, reversep);

      mtcs_cfg_redirect_edge_succ/*!redirect_edge_succ*/(mtcsCfg,BRANCH_EDGE (test_bb), new_dest);
      if (reversep){
         std::swap (BRANCH_EDGE (test_bb)->probability,
         FALLTHRU_EDGE (test_bb)->probability);
         mtcs_cfg_rtl_update_br_prob_note/*!update_br_prob_note*/(mtcsCfgRtl,test_bb);
      }
   }
   ...
   if (head != NULL){
      ...
      if (merge_set){
         ...
         EXECUTE_IF_SET_IN_BITMAP (merge_set, 0, i, bi)
            mtcs_rtlanal_remove_reg_equal_equiv_notes_for_regno/*!remove_reg_equal_equiv_notes_for_regno*/(mtcsRtlanal,i);

         BITMAP_FREE (merge_set);
      }

       mtcs_rtl_reorder_insns/*!reorder_insns*/(mtcsRTL,head, end, PREV_INSN (earliest));
   }

   /* Remove the jump and edge if we can.  */
   if (other_bb == new_dest){
      mtcs_cfg_rtl_delete_insn/*!delete_insn*/(mtcsCfgRtl,jump);
      mtcs_cfg_context_remove_edge/*!remove_edge*/(mtcsCfgContext,BRANCH_EDGE (test_bb));
...
static void if_convert (MtcsIfcvt *self,bool after_combine)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsCfgContext *mtcsCfgContext=mtcs_target_get_cfg_context(mtcsTarget);
   ...
   self->ifcvt_after_combine = after_combine;
   self->have_cbranchcc4 = (mtcs_opinit_direct_optab_handler/*!direct_optab_handler*/(mtcsOpinit,
         cbranch_optab, CCmode) != CODE_FOR_nothing);
   self->num_possible_if_blocks = 0;
   self->num_updated_if_blocks = 0;
   self->num_true_changes = 0;
   ...
   do{
      ...
      self->cond_exec_changed_p = false;
      pass++;
      ...
      FOR_EACH_BB_FN (bb, cfun){
         basic_block new_bb;
         while (!mtcs_dfcore_df_get_bb_dirty/*!df_get_bb_dirty*/(mtcsDfcore,bb)
               && (new_bb = find_if_header(self,bb, pass)) != NULL)
         bb = new_bb;
      }

#ifdef IFCVT_MULTIPLE_DUMPS
      if (dump_file && self->cond_exec_changed_p)
         print_rtl_with_bb (dump_file, mtcs_rtl_data_get_insns/*!get_insns*/(mtcsRtlData), dump_flags);
#endif
   } while (self->cond_exec_changed_p);
   ...
   if (dump_file && self->num_possible_if_blocks > 0){
      fprintf (dump_file, "\n%d possible IF blocks searched.\n",self->num_possible_if_blocks);
      fprintf (dump_file, "%d IF blocks converted.\n", self->num_updated_if_blocks);
      fprintf (dump_file, "%d true changes made.\n\n\n", self->num_true_changes);
   }
...
static void rest_of_handle_if_conversion (MtcsIfcvt *self)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsOptions *mtcsOptions=mtcs_target_get_options(mtcsTarget);
   ...
   if (mtcsOptionsItem->x_flag_if_conversion){
      if (dump_file){
      ...
      if_convert(self,false);
      if (self->num_updated_if_blocks)
         /* Get rid of any dead CC-related instructions.  */
         flags |= CLEANUP_FORCE_FAST_DCE;
   }

   mtcs_cfg_cleanup_cleanup_cfg/*!cleanup_cfg*/(mtcsCfgCleanup,flags);
}

static void mtcsIfcvtInit(MtcsIfcvt *self)
{
...
{
   MtcsIfcvt *self = n_slice_alloc0 (sizeof(MtcsIfcvt));
   mtcs_component_set_mode((MtcsComponent*)self,mtcsMode);
   mtcsIfcvtInit(self);
   return self;
}

/************************以下是基于MtcsIfcvt的3个pass ce1 ce2 ce3 -----------------------------*/
//原型 NEXT_PASS (pass_rtl_ifcvt, 1); RTL_PASS ifcvt.cc ifcvt y 有条件执行 (optimize > 0) && dbg_cnt (if_conversion);  rest_of_handle_if_conversion ();
static nboolean ifcvt_gate_cb(MtcsPass *mtcsPass,function *fun)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(mtcsPass);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsOptions *mtcsOptions=mtcs_target_get_options(mtcsTarget);
   MtcsOptionsItem *mtcsOptionsItem=mtcsOptions->global_options;
   return mtcsOptionsItem->x_optimize > 0  && dbg_cnt (if_conversion);
}

static nuint ifcvt_execute_cb(MtcsPass *mtcsPass,function *func)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(mtcsPass);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlPassMgr *mtcsRtlPassMgr=mtcs_target_get_rtl_pass_mgr(mtcsTarget);
   MtcsIfcvt  *mtcsIfcvt =mtcs_rtl_pass_mgr_get_ifcvt(mtcsRtlPassMgr);
   rest_of_handle_if_conversion (mtcsIfcvt);
   return 0;
}

static void mtcsPassIfcvtInit(MtcsPassIfcvt *self)
{
   MtcsPass *mtcsPass= (MtcsPass *)self;
   mtcsPass->execute =ifcvt_execute_cb;
   mtcsPass->gate =ifcvt_gate_cb;
...
{
   MtcsPassIfcvt *self = n_slice_alloc0 (sizeof(MtcsPassIfcvt));
   mtcs_component_set_mode((MtcsComponent*)self,mtcsMode);
   mtcs_pass_init((MtcsPass *)self,RTL_PASS,"ce1");
   mtcsPassIfcvtInit(self);
   return self;
}

//原型 NEXT_PASS (pass_if_after_combine, 1); RTL_PASS ifcvt.cc ce2 y 有条件执行 optimize > 0 && flag_if_conversion.. if_convert(true);
static nboolean if_after_combine_gate_cb(MtcsPass *mtcsPass,function *fun)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(mtcsPass);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsOptions *mtcsOptions=mtcs_target_get_options(mtcsTarget);
   MtcsOptionsItem *mtcsOptionsItem=mtcsOptions->global_options;
   return mtcsOptionsItem->x_optimize > 0 && mtcsOptionsItem->x_flag_if_conversion && dbg_cnt (if_after_combine);
}

static nuint if_after_combine_execute_cb(MtcsPass *mtcsPass,function *func)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(mtcsPass);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlPassMgr *mtcsRtlPassMgr=mtcs_target_get_rtl_pass_mgr(mtcsTarget);
   MtcsIfcvt  *mtcsIfcvt =mtcs_rtl_pass_mgr_get_ifcvt(mtcsRtlPassMgr);
   if_convert(mtcsIfcvt,true);
   return 0;
}

static void mtcsPassIfAfterCombineInit(MtcsPassIfAfterCombine *self)
{
   MtcsPass *mtcsPass= (MtcsPass *)self;
   mtcsPass->execute =if_after_combine_execute_cb;
   mtcsPass->gate =if_after_combine_gate_cb;
   mtcs_pass_set_properties(mtcsPass,
      0,/* properties_required */
      0, /* properties_provided */
      0 /* properties_destroyed */);
...
{
   MtcsPassIfAfterCombine *self = n_slice_alloc0 (sizeof(MtcsPassIfAfterCombine));
   mtcs_component_set_mode((MtcsComponent*)self,mtcsMode);
   mtcs_pass_init((MtcsPass *)self,RTL_PASS,"ce2");
   mtcsPassIfAfterCombineInit(self);
   return self;
}

//原型 NEXT_PASS (pass_if_after_reload, 1); RTL_PASS ifcvt.cc ce3 y 有条件执行 optimize > 0 && flag_if_conversion.. if_convert(true);
static nboolean if_after_reload_gate_cb(MtcsPass *mtcsPass,function *fun)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(mtcsPass);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsOptions *mtcsOptions=mtcs_target_get_options(mtcsTarget);
   MtcsOptionsItem *mtcsOptionsItem=mtcsOptions->global_options;
   return mtcsOptionsItem->x_optimize > 0 && mtcsOptionsItem->x_flag_if_conversion2 && dbg_cnt (if_after_reload);
}

static nuint if_after_reload_execute_cb(MtcsPass *mtcsPass,function *func)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(mtcsPass);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlPassMgr *mtcsRtlPassMgr=mtcs_target_get_rtl_pass_mgr(mtcsTarget);
...
static void mtcsPassIfAfterReloadInit(MtcsPassIfAfterReload *self)
{
   MtcsPass *mtcsPass= (MtcsPass *)self;
   mtcsPass->execute =if_after_reload_execute_cb;
   mtcsPass->gate =if_after_reload_gate_cb;
   mtcs_pass_set_properties(mtcsPass,
      0,/* properties_required */
      0, /* properties_provided */
      0 /* properties_destroyed */);
...
{
   MtcsPassIfAfterReload *self = n_slice_alloc0 (sizeof(MtcsPassIfAfterReload));
   mtcs_component_set_mode((MtcsComponent*)self,mtcsMode);
   mtcs_pass_init((MtcsPass *)self,RTL_PASS,"ce3");
   mtcsPassIfAfterReloadInit(self);
   return self;
}
