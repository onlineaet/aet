...
extern void mtcs_dwarf2_codeview_abstract_function (MtcsDwarf2Codeview *self, tree t)
{

}


static void mtcsDwarf2CodeviewInit(MtcsDwarf2Codeview *self)
{
...
{
   MtcsDwarf2Codeview *self = n_slice_alloc0 (sizeof(MtcsDwarf2Codeview));
   mtcs_component_set_mode((MtcsComponent *)self,mtcsMode);
   mtcsDwarf2CodeviewInit(self);
   return self;
}
