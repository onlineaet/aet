...
#define PACKTAB_UINT8 nuint8
#define PACKTAB_UINT16 nuint16
#define PACKTAB_UINT32 nuint32
...
static const nint16 MirLev3[4*38] = {
...
#define NLIB_GET_MIRRORING_DELTA(x) \
	((x) >= 0x10000 ? 0 :  \
	MirLev3[((x) & 0x03) + \
	MirLev2[((x) >> 2 & 0x03) + \
	MirLev1[((x) >> 4 & 0x0f) + \
...
#define NLIB_GET_MIRRORING(x) ((x) + NLIB_GET_MIRRORING_DELTA(x))
