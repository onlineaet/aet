/*
   ...
   This program based on gcc/c/c-fold.h and gcc/c/c-fold.h.
...
static void c_disable_warnings (bool disable)
{
  if (disable)
    {
...
static void c_enable_warnings (bool enable)
{
  if (enable)
    {
      --c_inhibit_evaluation_warnings;
...
static tree c_fold_array_ref (tree type, tree ary, tree index)
{
...
tree aet_c_fully_fold (tree expr, bool in_init, bool *maybe_const, bool lval)
{
  tree ret;
...
static tree c_fully_fold_internal (tree expr, bool in_init, bool *maybe_const_operands,
