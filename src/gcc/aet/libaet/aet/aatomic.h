...
/*
atomic_add 原子变量加特定值，并返回原子变量新值
atomic_sub 原子变量减特定值，并返回原子变量新值
atomic_inc 原子变量加1，并返回原子变量新值
atomic_dec 原子变量减1，并返回原子变量新值

atomic_fetch_add  原子变量加特定值，并返回原子变量旧值
atomic_fetch_sub  原子变量减特定值，并返回原子变量旧值
atomic_fetch_inc  原子变量加1，并返回原子变量旧值
atomic_fetch_dec  原子变量减1，并返回原子变量旧值
*/
