...
static int compare_base_symbol_refs (MtcsAlias *self,const_rtx, const_rtx, HOST_WIDE_INT * = NULL);
...
#define SIZE_FOR_MODE(X) (mtcs_mode_get_size/*!GET_MODE_SIZE*/(mtcsMode,GET_MODE (X)))
...
#define static_reg_base_value  (mtcsRTL/*this_target_rtl*/->x_static_reg_base_value)

#define REG_BASE_VALUE(X)              \
  (REGNO (X) < vec_safe_length (self->reg_base_value)       \
   ? (*self->reg_base_value)[REGNO (X)] : 0)
...
static bool ao_ref_from_mem (MtcsAlias *self,ao_ref *ref, const_rtx mem)
{
   ...
   ref->ref_alias_set =mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,mem);

   /* If MEM_OFFSET or MEM_SIZE are unknown what we got from MEM_EXPR
   is conservative, so trust it.  */
   if (!mtcs_rtl_is_mem_offset_known_p/*!MEM_OFFSET_KNOWN_P*/(mtcsRTL,mem)
   || !mtcs_rtl_is_mem_size_known_p/*!MEM_SIZE_KNOWN_P*/(mtcsRTL,mem))
      return true;

   /* If MEM_OFFSET/MEM_SIZE get us outside of ref->offset/ref->max_size
   drop ref->ref.  */
   if (maybe_lt (mtcs_rtl_get_mem_offset/*!MEM_OFFSET*/(mtcsRTL,mem), 0)
   || (ref->max_size_known_p ()
   && maybe_gt ((mtcs_rtl_get_mem_offset/*!MEM_OFFSET*/(mtcsRTL,mem) +
         mtcs_rtl_get_mem_size/*!MEM_SIZE*/(mtcsRTL,mem)) * BITS_PER_UNIT,ref->max_size)))
      ref->ref = NULL_TREE;

   /* Refine size and offset we got from analyzing MEM_EXPR by using
   MEM_SIZE and MEM_OFFSET.  */

   ref->offset += mtcs_rtl_get_mem_offset/*!MEM_OFFSET*/(mtcsRTL,mem) * BITS_PER_UNIT;
   ref->size = mtcs_rtl_get_mem_size/*!MEM_SIZE*/(mtcsRTL,mem) * BITS_PER_UNIT;
   ...
   if (mtcs_rtl_get_mem_expr/*!MEM_EXPR*/(mtcsRTL,mem) != mtcs_rtl_get_spill_slot_decl/*!get_spill_slot_decl*/(mtcsRTL,false)
...
static bool rtx_refs_may_alias_p (MtcsAlias *self,const_rtx x, const_rtx mem, bool tbaa_p)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRTL *mtcsRTL=mtcs_target_get_rtl(mtcsTarget);
   ...
   if (!ao_ref_from_mem(self,&ref1, x)
   || !ao_ref_from_mem(self,&ref2, mem))
   return true;

   return refs_may_alias_p_1 (&ref1, &ref2,
     tbaa_p
     && mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,x) != 0
     && mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,mem) != 0);
}
...
bool mtcs_alias_refs_same_for_tbaa_p (MtcsAlias *self,tree earlier, tree later)
{
  ...
  if (!(earlier_set == later_set || mtcs_alias_alias_set_subset_of/*!alias_set_subset_of*/(self,later_set, earlier_set)))
    return false;
  ...
  return (earlier_base_set == later_base_set  || mtcs_alias_alias_set_subset_of/*!alias_set_subset_of*/(self,
        later_base_set, earlier_base_set));
}
...
bool mtcs_alias_mems_same_for_tbaa_p (MtcsAlias *self,rtx earlier, rtx later)
{
   ...
   return ((mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,earlier) == mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,later)
   || mtcs_alias_alias_set_subset_of/*!alias_set_subset_of*/(self,mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,later),
   mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,earlier)))
   && (!mtcs_rtl_get_mem_expr/*!MEM_EXPR*/(mtcsRTL,earlier)
   || mtcs_alias_refs_same_for_tbaa_p/*!refs_same_for_tbaa_p*/(self,
         mtcs_rtl_get_mem_expr/*!MEM_EXPR*/(mtcsRTL,earlier), mtcs_rtl_get_mem_expr/*!MEM_EXPR*/(mtcsRTL,later))));
}

/* Returns a pointer to the alias set entry for ALIAS_SET, if there is
   such an entry, or NULL otherwise.  */
static inline alias_set_entry * get_alias_set_entry (MtcsAlias *self,alias_set_type alias_set)
{
   //fprintf(stderr,"mtcsalias.c get_alias_set_entry  00 %d\n",alias_set);
   return (*self->alias_sets)[alias_set];
}

/* Returns true if the alias sets for MEM1 and MEM2 are such that
   the two MEMs cannot alias each other.  */
static inline bool mems_in_disjoint_alias_sets_p (MtcsAlias *self,const_rtx mem1, const_rtx mem2)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRTL *mtcsRTL=mtcs_target_get_rtl(mtcsTarget);
   ...
   return (mtcsOptionsItem->x_flag_strict_aliasing
         && ! mtcs_alias_alias_sets_conflict_p/*!alias_sets_conflict_p*/(self,
               mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,mem1),
            mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,mem2)));
}
...
bool mtcs_alias_alias_set_subset_of (MtcsAlias *self,alias_set_type set1, alias_set_type set2)
{
   ...
   if (!mtcsOptionsItem->x_flag_strict_aliasing)
      return true;
   ...
   ase2 = get_alias_set_entry(self,set2);
   if (ase2 != 0 && (ase2->has_zero_child || (ase2->children && ase2->children->get (set1))))
      return true;
   ...
   *ptr2 = ...
   ...
   if (ase2 && ase2->has_pointer){
      alias_set_entry *ase1 = get_alias_set_entry(self,set1);
      ...
      if (ase1 && ase1->is_pointer){
         ...
         if (ase2->children && set1 != voidptr_set && ase2->children->get (voidptr_set))
            return true;
      }
   }
   return false;
...
bool mtcs_alias_alias_sets_conflict_p (MtcsAlias *self,alias_set_type set1, alias_set_type set2)
{
   ...
   alias_set_entry *ase2;
  // fprintf(stderr,"mtcsalias.c mtcs_alias_alias_sets_conflict_p 00 %d %d len:%d %d\n",
        // set1,set2,self->alias_sets->length(),vec_safe_length(self->alias_sets));
   /* The easy case.  */
   if (mtcs_alias_alias_sets_must_conflict_p/*!alias_sets_must_conflict_p*/(self,set1, set2))
      return true;
   fprintf(stderr,"mtcsalias.c mtcs_alias_alias_sets_conflict_p 11 %d %d\n",set1,set2);

   /* See if the first alias set is a subset of the second.  */
   ase1 = get_alias_set_entry(self,set1);
   if (ase1 != 0  && ase1->children && ase1->children->get (set2)){
      ++self->alias_stats.num_dag;
      return true;
   }
   ...
   if (ase1 && ase2 && ase1->has_pointer && ase2->has_pointer){
      ...
      or contains pointer.  */
      if (set1 == voidptr_set || set2 == voidptr_set){
         ++self->alias_stats.num_universal;
         return true;
      }
      /* If one of sets is (non-universal) pointer and the other
      contains universal pointer, we also get conflict.  */
      if (ase1->is_pointer && set2 != voidptr_set && ase2->children && ase2->children->get (voidptr_set)){
         ++self->alias_stats.num_universal;
         return true;
      }
      if (ase2->is_pointer && set1 != voidptr_set && ase1->children && ase1->children->get (voidptr_set)){
         ++self->alias_stats.num_universal;
         return true;
      }
   }

   ++self->alias_stats.num_disambiguated;
...
bool mtcs_alias_alias_sets_must_conflict_p (MtcsAlias *self,alias_set_type set1, alias_set_type set2)
{
   ...
   if (!mtcsOptionsItem->x_flag_strict_aliasing)
      return true;
   if (set1 == 0 || set2 == 0){
      ++self->alias_stats.num_alias_zero;
      return true;
   }
   if (set1 == set2){
      ++self->alias_stats.num_same_alias_set;
      return true;
   }
...
bool mtcs_alias_objects_must_conflict_p (MtcsAlias *self,tree t1, tree t2)
{
   ...
   if (t1 == t2){
      ++self->alias_stats.num_same_objects;
      return true;
   }
   /* Likewise if both are volatile.  */
   if (t1 != 0 && TYPE_VOLATILE (t1) && t2 != 0 && TYPE_VOLATILE (t2)){
      ++self->alias_stats.num_volatile;
      return true;
   }

   set1 = t1 ? mtcs_alias_get_alias_set/*!get_alias_set*/(self,t1) : 0;
   set2 = t2 ? mtcs_alias_get_alias_set/*!get_alias_set*/(self,t2) : 0;
   ...
   return mtcs_alias_alias_sets_must_conflict_p/*!alias_sets_must_conflict_p*/(self,set1, set2);
}
...
tree mtcs_alias_component_uses_parent_alias_set_from (MtcsAlias *self,const_tree t)
{
   ...
   while (handled_component_p (t)){
      if (mtcs_alias_ends_tbaa_access_path_p/*!ends_tbaa_access_path_p*/(self,t))
         found = t;
...
{
   return (VOID_TYPE_P (TREE_TYPE (t))  || TYPE_REF_CAN_ALIAS_ALL (t));
}
...
alias_set_type mtcs_alias_get_deref_alias_set (MtcsAlias *self,tree t)
{
   ...
   if (set == -1){
      if (! TYPE_P (t))
         t = TREE_TYPE (t);
      set = mtcs_alias_get_alias_set/*!get_alias_set*/(self,TREE_TYPE (t));
   }
...
tree mtcs_alias_reference_alias_ptr_type_1 (MtcsAlias *self,tree *t)
{
   ...
   a pointer to.  */
   tree tem = mtcs_alias_component_uses_parent_alias_set_from/*!component_uses_parent_alias_set_from*/(self,*t);
   if (tem)
      *t = tem;
...
tree mtcs_alias_reference_alias_ptr_type (MtcsAlias *self,tree t)
{
  ...
  tree ptype = mtcs_alias_reference_alias_ptr_type_1/*!reference_alias_ptr_type_1*/(self,&t);
  ...
  if (TREE_CODE (t) == MEM_REF
    ...
    return mtcs_tree_build_pointer_type/*!build_pointer_type*/(mtcsTree,TYPE_MAIN_VARIANT (TREE_TYPE (t)));
}
...
bool mtcs_alias_alias_ptr_types_compatible_p (MtcsAlias *self,tree t1, tree t2)
{
   ...
   if (ref_all_alias_ptr_type_p (t1) || ref_all_alias_ptr_type_p (t2))
      return false;
   ...
   */
   if (mtcsOptionsItem->x_in_lto_p)
      return mtcs_alias_get_deref_alias_set/*!get_deref_alias_set*/(self,t1)
            == mtcs_alias_get_deref_alias_set/*!get_deref_alias_set*/(self,t2);
   else
      return (TYPE_MAIN_VARIANT (TREE_TYPE (t1))  == TYPE_MAIN_VARIANT (TREE_TYPE (t2)));
}
...
alias_set_entry * mtcs_alias_init_alias_set_entry (MtcsAlias *self,alias_set_type set)
{
   ...
   gcc_checking_assert (!get_alias_set_entry(self,set));
   //fprintf(stderr,"mtcsalias.c mtcs_alias_init_alias_set_entry set:%d %d %d\n",
    //     set,self->alias_sets->length (),vec_safe_length(self->alias_sets));
   (*self->alias_sets)[set] = ase;
   return ase;
}
...
alias_set_type mtcs_alias_get_alias_set (MtcsAlias *self,tree t)
{
   ...
   MtcsOptions *mtcsOptions=mtcs_target_get_options(mtcsTarget);
   MtcsOptionsItem *mtcsOptionsItem=mtcsOptions->global_options;
   //MtcsIpaDevirt *mtcsIpaDevirt=(MtcsIpaDevirt *)mtcs_target_get_pass(mtcsTarget,IPA_PASS,"devirt");
   ...
   if (! TYPE_P (t)){
      ...
      STRIP_NOPS (t);
      set = mtcsLang/*!lang_hooks.get_alias_set*/->hook.get_alias_set(mtcsLang,t);
      if (set != -1)
         return set;
      ...
      tree ptype = mtcs_alias_reference_alias_ptr_type_1/*!reference_alias_ptr_type_1*/(self,&t);
      if (ptype != NULL)
         return mtcs_alias_get_deref_alias_set/*!get_deref_alias_set*/(self,ptype);

      /* If we've already determined the alias set for a decl, just return
      it.  This is necessary for C++ anonymous unions, whose component
      variables don't look like union members (boo!).  */
      if (VAR_P (t)  && DECL_RTL_SET_P (t) && MEM_P (DECL_RTL (t)))
         return mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,DECL_RTL (t));
   ...
   if (AGGREGATE_TYPE_P (t) && TYPE_TYPELESS_STORAGE (t))
      return 0;
   ...
   if (TYPE_STRUCTURAL_EQUALITY_P (t)){
      ...
      if (canonical_type_used_p (t)){
         ...
         gcc_checking_assert (!mtcsOptionsItem->x_in_lto_p || !type_with_alias_set_p (t));
         return 0;
      }
   }else{
      t = TYPE_CANONICAL (t);
   ...
   if (!COMPLETE_TYPE_P (t)){
      ...
      if (TREE_CODE (t) == ARRAY_TYPE)
         return mtcs_alias_get_alias_set/*!get_alias_set*/(self,TREE_TYPE (t));
   ...
   else if (TREE_CODE (t) == ARRAY_TYPE  && (!TYPE_NONALIASED_COMPONENT (t) || TYPE_STRUCTURAL_EQUALITY_P (t)))
      set = mtcs_alias_get_alias_set/*!get_alias_set*/(self,TREE_TYPE (t));
   ...
   disambiguations in the program.  */
      ...
      if (in_lto_p && TYPE_STRUCTURAL_EQUALITY_P (p) && odr_type_p (p)){
         //应该不会进入这里，因为mtcs不需要in_lto_p,所以需要mtcs_ipa_devirt_prevailing_odr_type
         //恢复原来的 prevailing_odr_type
         //p = mtcs_ipa_devirt_prevailing_odr_type/*!prevailing_odr_type*/(mtcsIpaDevirt,p);
         n_error("不应该进入这里。mtcs_alias_get_alias_set\n");
      ...
      if (TREE_CODE (p) == VOID_TYPE || TYPE_STRUCTURAL_EQUALITY_P (p))
         set = mtcs_alias_get_alias_set/*!get_alias_set*/(self,ptr_type_node);
      else{
         ...
         while (!reference.is_empty ()){
            if (reference.pop ())
               p =mtcs_tree_build_reference_type/*!build_reference_type*/(mtcsTree,p);
            else
               p =mtcs_tree_build_pointer_type/*!build_pointer_type*/(mtcsTree,p);
            ...
            in all other cases.  */
            gcc_checking_assert (!TYPE_CANONICAL (p) || p == TYPE_CANONICAL (p));
         }
         ...
         if (TYPE_ALIAS_SET_KNOWN_P (p))
            ...
            set = mtcs_alias_new_alias_set/*!new_alias_set*/(self);
   ...
   if (AGGREGATE_TYPE_P (t) || TREE_CODE (t) == COMPLEX_TYPE)
      mtcs_alias_record_component_aliases/*!record_component_aliases*/(self,t);

   /* We treat pointer types specially in alias_set_subset_of.  */
   if (POINTER_TYPE_P (t) && set){
      alias_set_entry *ase = get_alias_set_entry(self,set);
      if (!ase)
         ase = mtcs_alias_init_alias_set_entry/*!init_alias_set_entry*/(self,set);
      ase->is_pointer = true;
...
{
   //fprintf(stderr,"mtcsalias.c mtcs_alias_new_alias_set 00-- %p\n",self->alias_sets);
   if (self->alias_sets == 0){
      //fprintf(stderr,"mtcsalias.c mtcs_alias_new_alias_set 11-- %p\n",self->alias_sets);
      vec_safe_push (self->alias_sets, (alias_set_entry *) NULL);
   }
   vec_safe_push (self->alias_sets, (alias_set_entry *) NULL);
   //fprintf(stderr,"mtcsalias.c mtcs_alias_new_alias_set 22-- %d\n",self->alias_sets->length ());
   return self->alias_sets->length () - 1;
}
...
void mtcs_alias_record_alias_subset (MtcsAlias *self,alias_set_type superset, alias_set_type subset)
{
   ...
   superset_entry = get_alias_set_entry(self,superset);
   if (superset_entry == 0){
      /* Create an entry for the SUPERSET, so that we have a place to
      attach the SUBSET.  */
      superset_entry = mtcs_alias_init_alias_set_entry/*!init_alias_set_entry*/(self,superset);
   }
   ...
   if (subset == 0)
      ...
      if (!superset_entry->children)
         superset_entry->children  = hash_map<alias_set_hash, int>::create_ggc (64);
      ...
      subset_entry = get_alias_set_entry(self,subset);
      ...
      if (subset_entry){
         ...
         if (subset_entry->children){
            hash_map<alias_set_hash, int>::iterator iter  = subset_entry->children->begin ();
...
static void record_component_aliases_1 (MtcsAlias *self,tree type, alias_set_type superset)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsOptions *mtcsOptions=mtcs_target_get_options(mtcsTarget);
   ...
   switch (TREE_CODE (type)){
      ...
      type.  */
      bool void_pointers = mtcsOptionsItem->x_in_lto_p  && (!odr_type_p (type) || !odr_based_tbaa_p (type));
      for (field = TYPE_FIELDS (type); field != 0; field = DECL_CHAIN (field))
         if (TREE_CODE (field) == FIELD_DECL && !DECL_NONADDRESSABLE_P (field)){
            ...
            if (void_pointers){
               ...
               if (POINTER_TYPE_P (t))
                  t = ptr_type_node;
               else if (mtcsOptionsItem->x_flag_checking)
                  gcc_checking_assert (mtcs_alias_get_alias_set/*!get_alias_set*/(self,t)
                        == mtcs_alias_get_alias_set/*!get_alias_set*/(self,TREE_TYPE (field)));
            }

            alias_set_type set = mtcs_alias_get_alias_set/*!get_alias_set*/(self,t);
            mtcs_alias_record_alias_subset/*!record_alias_subset*/(self,superset, set);
            ...
            'int' as subset.  */
            if (set == 0)
               record_component_aliases_1(self,t, superset);
         }
      }
         break;

      case COMPLEX_TYPE:
         mtcs_alias_record_alias_subset/*!record_alias_subset*/(self,
               superset, mtcs_alias_get_alias_set/*!get_alias_set*/(self,TREE_TYPE (type)));
         break;
...
{
   alias_set_type superset = mtcs_alias_get_alias_set/*!get_alias_set*/(self,type);
   record_component_aliases_1 (self,type, superset);
}
...
alias_set_type mtcs_alias_get_varargs_alias_set (MtcsAlias *self)
{
  ...
  return 0;
#else
  if (self->varargs_set == -1)
    self->varargs_set = mtcs_alias_new_alias_set/*!new_alias_set*/(self);

  return self->varargs_set;
#endif
}
...
{
  if (self->frame_set == -1)
    self->frame_set = mtcs_alias_new_alias_set/*!new_alias_set*/(self);

  return self->frame_set;
}

/* Create a new, unique base with id ID.  */
static rtx unique_base_value (MtcsAlias *self,HOST_WIDE_INT id)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   return gen_rtx_ADDRESS (mtcs_mode_get_Pmode(mtcsMode), id);
}

/* Return true if accesses based on any other base value cannot alias
   those based on X.  */

static bool unique_base_value_p (MtcsAlias *self,rtx x)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   return GET_CODE (x) == ADDRESS && GET_MODE (x) == mtcs_mode_get_Pmode(mtcsMode);
}

/* Inside SRC, the source of a SET, find a base address.  */

static rtx find_base_value (MtcsAlias *self,rtx src)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRTL *mtcsRTL=mtcs_target_get_rtl(mtcsTarget);
   ...
   switch (GET_CODE (src)){
      ...
      case REG:
         ...
         if (regno < firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/ && self->copying_arguments)
            return self->new_reg_base_value[regno];
         ...
         if ((regno >= firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/
               ...
               && regno < vec_safe_length (self->reg_base_value)){
            /* If we're inside init_alias_analysis, use new_reg_base_value
            to reduce the number of relaxation iterations.  */
            if (self->new_reg_base_value && self->new_reg_base_value[regno] && DF_REG_DEF_COUNT (regno) == 1)
               return self->new_reg_base_value[regno];

            if ((*self->reg_base_value)[regno])
               return (*self->reg_base_value)[regno];
         }
      ...
      case MEM:
         ...
         otherwise.  */
         if (self->copying_arguments
         && (XEXP (src, 0) ==mtcs_rtl_get_arg_pointer_rtx/*!arg_pointer_rtx*/(mtcsRTL)
         || (GET_CODE (XEXP (src, 0)) == PLUS
         && XEXP (XEXP (src, 0), 0) == mtcs_rtl_get_arg_pointer_rtx/*!arg_pointer_rtx*/(mtcsRTL))))
            return self->arg_base_value;
         return 0;
      ...
      case MINUS:
      {
         ...
         if (CONST_INT_P (src_1))
            return find_base_value(self,src_0);
         else if (CONST_INT_P (src_0))
            return find_base_value(self,src_1);
      ...
      case LO_SUM:
         ...
         second operand.  */
         return find_base_value(self,XEXP (src, 1));
      ...
      case AND:
         ...
         && (INTVAL (XEXP (src, 1)) & 1) == 0)
            return find_base_value(self,XEXP (src, 0));
         return 0;
      ...
      case TRUNCATE:
         ...
         if (!mtcs_target_target_default_pointer_address_modes_p/*!target_default_pointer_address_modes_p*/(mtcsTarget))
            break;
         if (!mtcs_mode_is_a <scalar_int_mode>(mtcsMode,GET_MODE (src), &int_mode)
         || mtcs_mode_get_precision/*!GET_MODE_PRECISION*/(mtcsMode,int_mode)
         < mtcs_mode_get_precision/*!GET_MODE_PRECISION*/(mtcsMode,mtcs_mode_get_Pmode(mtcsMode)))
         break;
      /* Fall through.  */
      case HIGH:
      case PRE_INC:
      ...
      case SIGN_EXTEND:   /* used for NT/Alpha pointers */
         ...
         {
            rtx temp = find_base_value(self,XEXP (src, 0));

            if (temp != 0 && CONSTANT_P (temp))
               temp = mtcs_explow_convert_memory_address/*!convert_memory_address*/(mtcsExplow,mtcs_mode_get_Pmode(mtcsMode), temp);
...
static void record_set (MtcsAlias *self,rtx dest, const_rtx set, void *data ATTRIBUTE_UNUSED)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsReg *mtcsReg=mtcs_target_get_reg(mtcsTarget);
   ...
   gcc_checking_assert (regno < self->reg_base_value->length ());

   n = REG_NREGS (dest);
   if (n != 1){
      while (--n >= 0){
         bitmap_set_bit (self->reg_seen, regno + n);
         self->new_reg_base_value[regno + n] = 0;
      }
      return;
   }
   ...
   if (set){
      ...
      if (GET_CODE (set) == CLOBBER){
         self->new_reg_base_value[regno] = 0;
         return;
      }
      ...
      if (bitmap_bit_p (self->reg_seen, regno)){
         self->new_reg_base_value[regno] = 0;
         return;
      }
      bitmap_set_bit (self->reg_seen, regno);
      self->new_reg_base_value[regno] = unique_base_value(self,self->unique_id++);
      return;
   }
   ...
   if (self->new_reg_base_value[regno] != 0 && find_base_value(self,src) != self->new_reg_base_value[regno])
      switch (GET_CODE (src)){
         case LO_SUM:
         case MINUS:
         ...
         an index.  */
         {
            ...
            if (! other || find_base_value(self,other))
               self->new_reg_base_value[regno] = 0;
            break;
         }
         case AND:
   ...
   else if ((regno >= mtcs_reg_get_first_pseudo_register/*!FIRST_PSEUDO_REGISTER*/(mtcsReg)
         || ! mtcsReg->hardRegs.x_fixed_regs/*!fixed_regs*/[regno])
   && ! bitmap_bit_p (self->reg_seen, regno) && self->new_reg_base_value[regno] == 0)
      self->new_reg_base_value[regno] = find_base_value(self,src);
...
rtx mtcs_alias_get_reg_known_value (MtcsAlias *self,unsigned int regno)
{
   ...
   if (regno >= firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/){
      regno -= firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/;
      if (regno < vec_safe_length (self->reg_known_value))
         return (*self->reg_known_value)[regno];
   }
   return NULL;
}

/* Set it.  */
static void set_reg_known_value (MtcsAlias *self,unsigned int regno, rtx val)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsReg *mtcsReg=mtcs_target_get_reg(mtcsTarget);
   ...
   if (regno >= firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/){
      regno -= firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/;
      if (regno < vec_safe_length (self->reg_known_value))
         (*self->reg_known_value)[regno] = val;
   }
}
...
bool mtcs_alias_get_reg_known_equiv_p (MtcsAlias *self,unsigned int regno)
{
   ...
   if (regno >= firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/){
      regno -= firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/;
      if (regno < vec_safe_length (self->reg_known_value))
         return bitmap_bit_p (self->reg_known_equiv_p, regno);
   }
   return false;
}

static void set_reg_known_equiv_p (MtcsAlias *self,unsigned int regno, bool val)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsReg *mtcsReg=mtcs_target_get_reg(mtcsTarget);
   ...
   if (regno >= firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/){
      ...
      if (regno < vec_safe_length (self->reg_known_value)){
         if (val)
            bitmap_set_bit (self->reg_known_equiv_p, regno);
         else
            bitmap_clear_bit (self->reg_known_equiv_p, regno);
      }
   }
}
...
rtx mtcs_alias_canon_rtx (MtcsAlias *self,rtx x)
{
   ...
   if (REG_P (x) && REGNO (x) >=  firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/){
      rtx t = mtcs_alias_get_reg_known_value/*!get_reg_known_value*/(self,REGNO (x));
      if (t == x)
         return x;
      if (t)
         return mtcs_alias_canon_rtx/*!canon_rtx*/(self,t);
   }

   if (GET_CODE (x) == PLUS){
      rtx x0 = mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 0));
      rtx x1 = mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 1));

      if (x0 != XEXP (x, 0) || x1 != XEXP (x, 1))
         return mtcs_simplify_rtx_gen_binary/*!simplify_gen_binary*/(mtcsSimplifyRtx,PLUS, GET_MODE (x), x0, x1);
   }
   ...
   all the flags with their original values.  */
      ...
      x = mtcs_rtl_replace_equiv_address_nv/*!replace_equiv_address_nv*/(mtcsRTL,
            x, mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 0)));
...
static bool rtx_equal_for_memref_p (MtcsAlias *self,const_rtx x, const_rtx y)
{
   int i;
   int j;
   enum rtx_code code;
   ...
   switch (code){
      ...
      case SYMBOL_REF:
      {
         ...
         return (compare_base_symbol_refs(self,x, y, &distance) == 1  && distance == 0);
      }
   ...
   if (code == PLUS)
      return ((rtx_equal_for_memref_p(self,XEXP (x, 0), XEXP (y, 0))
         && rtx_equal_for_memref_p(self,XEXP (x, 1), XEXP (y, 1)))
         || (rtx_equal_for_memref_p(self,XEXP (x, 0), XEXP (y, 1))
         && rtx_equal_for_memref_p(self,XEXP (x, 1), XEXP (y, 0))));
   /* For commutative operations, the RTX match if the operand match in any
   order.  Also handle the simple binary and unary cases without a loop.  */
   if (COMMUTATIVE_P (x)){
      rtx xop0 = mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 0));
      rtx yop0 = mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (y, 0));
      rtx yop1 = mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (y, 1));

      return ((rtx_equal_for_memref_p(self,xop0, yop0)
            && rtx_equal_for_memref_p(self,mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 1)), yop1))
            || (rtx_equal_for_memref_p(self,xop0, yop1)
            && rtx_equal_for_memref_p(self,mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 1)), yop0)));
   }else if (NON_COMMUTATIVE_P (x)){
      return (rtx_equal_for_memref_p(self,mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 0)),
            mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (y, 0)))
            && rtx_equal_for_memref_p(self,mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 1)),
            mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (y, 1))));
   }else if (UNARY_P (x))
      return rtx_equal_for_memref_p(self,mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 0)),
            mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (y, 0)));
      ...
      switch (fmt[i]){
         ...
         case 'E':
            ...
            for (j = 0; j < XVECLEN (x, i); j++)
               if (rtx_equal_for_memref_p(self,mtcs_alias_canon_rtx/*!canon_rtx*/(self,XVECEXP (x, i, j)),
                     mtcs_alias_canon_rtx/*!canon_rtx*/(self,XVECEXP (y, i, j))) == 0)
                  return false;
            break;

         case 'e':
            if (rtx_equal_for_memref_p(self,mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, i)),
                  mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (y, i))) == 0)
               return false;
            break;
...
static rtx find_base_term (MtcsAlias *self,rtx x, vec<std::pair<cselib_val *,
                 struct elt_loc_list *> > &visited_vals)
{
   ...
   switch (GET_CODE (x)){
      ...
      case TRUNCATE:
         ...
         if (!mtcs_target_target_default_pointer_address_modes_p/*!target_default_pointer_address_modes_p*/(mtcsTarget))
            return 0;
         if (!mtcs_mode_is_a<scalar_int_mode>(mtcsMode,GET_MODE (x), &int_mode)
         || mtcs_mode_get_precision/*!GET_MODE_PRECISION*/(mtcsMode,int_mode)
         < mtcs_mode_get_precision/*!GET_MODE_PRECISION*/(mtcsMode,mtcs_mode_get_Pmode(mtcsMode)))
            return 0;
      /* Fall through.  */
      ...
      case PRE_MODIFY:
      case POST_MODIFY:
         return find_base_term(self,XEXP (x, 0), visited_vals);
      ...
      case SIGN_EXTEND:   /* Used for Alpha/NT pointers */
         ...
         {
            rtx temp = find_base_term(self,XEXP (x, 0), visited_vals);
      ...
      case VALUE:
         ...
         if (mtcs_cse_lib_cselib_sp_based_value_p/*!cselib_sp_based_value_p*/(mtcsCseLib,val))
            return static_reg_base_value[mtcs_reg_get_stack_pointer_regnum/*!STACK_POINTER_REGNUM*/(mtcsReg)];

         if (visited_vals.length () > (unsigned) mtcsOptionsItem->x_param_max_find_base_term_values)
            return ret;
         ...
         for (l = f; l; l = l->next)
            ...
            && CSELIB_VAL_PTR (l->loc)->locs->loc == x)
               continue;
            else if ((ret = find_base_term(self,l->loc, visited_vals)) != 0)
               break;
      ...
      case LO_SUM:
         /* The standard form is (lo_sum reg sym) so look only at the
         second operand.  */
         return find_base_term(self,XEXP (x, 1), visited_vals);
      ...
      case MINUS:
      {
         ...
         if (tmp1 == mtcs_rtl_get_pic_offset_table_rtx/*!pic_offset_table_rtx*/(mtcsRTL) && CONSTANT_P (tmp2))
            return find_base_term(self,tmp2, visited_vals);
         ...
         if (CONST_INT_P (tmp2))
            return find_base_term(self,tmp1, visited_vals);
...
static rtx find_base_term (MtcsAlias *self,rtx x)
{
  auto_vec<std::pair<cselib_val *, struct elt_loc_list *>, 32> visited_vals;
  rtx res = find_base_term(self,x, visited_vals);
...
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;// static_reg_base_value 需要mtcsRTL
   MtcsRTL *mtcsRTL=mtcs_target_get_rtl(mtcsTarget);//
   MtcsReg *mtcsReg=mtcs_target_get_reg(mtcsTarget);

   rtx base = find_base_term(self,x);
   return !base || base == static_reg_base_value[mtcs_reg_get_stack_pointer_regnum/*!STACK_POINTER_REGNUM*/(mtcsReg)];
}
...
int mtcs_alias_compare_base_decls (MtcsAlias *self,tree base1, tree base2)
{
   ...
   decls are unique.  */
   if (!decl_in_symtab_p (base1)  || !decl_in_symtab_p (base2))
      return 0;
...
static int compare_base_symbol_refs (MtcsAlias *self,const_rtx x_base, const_rtx y_base,
           HOST_WIDE_INT *distance)
{
   ...
   if (XSTR (x_base, 0) == XSTR (y_base, 0))
      return 1;
   if (x_decl && y_decl)
      return mtcs_alias_compare_base_decls/*!compare_base_decls*/(self,x_decl, y_decl);
   if (x_decl || y_decl){
      if (!x_decl){
         swap = true;
      ...
      if (!VAR_P (x_decl) || (!TREE_STATIC (x_decl) && !TREE_PUBLIC (x_decl)))
         return 0;

      symtab_node *x_node = symtab_node::get_create (x_decl)->ultimate_alias_target ();
      /* External variable cannot be in section anchor.  */
      if (!x_node->definition)
         return 0;
      x_base = XEXP (mtcs_asm_decl_rtl/*!DECL_RTL*/(mtcsAsm,x_node->decl), 0);
   ...
   if (SYMBOL_REF_HAS_BLOCK_INFO_P (x_base)  && SYMBOL_REF_HAS_BLOCK_INFO_P (y_base)){
      if (SYMBOL_REF_BLOCK (x_base) != SYMBOL_REF_BLOCK (y_base))
         return 0;
      if (distance)
         *distance += (swap ? -1 : 1) * (SYMBOL_REF_BLOCK_OFFSET (y_base) - SYMBOL_REF_BLOCK_OFFSET (x_base));
...
static bool base_alias_check (MtcsAlias *self,rtx x, rtx x_base, rtx y, rtx y_base,
        machine_mode x_mode, machine_mode y_mode)
{
   ...
   if (x_base == 0){
      ...
      if (! mtcsOptionsItem->x_flag_expensive_optimizations || (x_c = mtcs_alias_canon_rtx/*!canon_rtx*/(self,x)) == x)
         return true;

      x_base = find_base_term(self,x_c);
      if (x_base == 0)
         return true;
   }
   ...
   if (y_base == 0) {
      rtx y_c;
      if (! mtcsOptionsItem->x_flag_expensive_optimizations || (y_c = mtcs_alias_canon_rtx/*!canon_rtx*/(self,y)) == y)
         return true;

      y_base = find_base_term(self,y_c);
      if (y_base == 0)
         return true;
   }
   ...
   || (int) mtcs_mode_get_unit_size/*!GET_MODE_UNIT_SIZE*/(mtcsMode,y_mode) < -INTVAL (XEXP (x, 1))))
      return true;
   if (GET_CODE (y) == AND  && (!CONST_INT_P (XEXP (y, 1))
   || (int) mtcs_mode_get_unit_size/*!GET_MODE_UNIT_SIZE*/(mtcsMode,x_mode) < -INTVAL (XEXP (y, 1))))
      return true;

   /* Differing symbols not accessed via AND never alias.  */
   if (GET_CODE (x_base) == SYMBOL_REF && GET_CODE (y_base) == SYMBOL_REF)
      return compare_base_symbol_refs(self,x_base, y_base) != 0;

   if (GET_CODE (x_base) != ADDRESS && GET_CODE (y_base) != ADDRESS)
      return false;

   if (unique_base_value_p(self,x_base) || unique_base_value_p(self,y_base))
      return false;
...
rtx mtcs_alias_get_addr (MtcsAlias *self,rtx x)
{
   ...
   if (GET_CODE (x) != VALUE){
      ...
      && CONST_SCALAR_INT_P (XEXP (x, 1))){
         rtx op0 = mtcs_alias_get_addr/*!get_addr*/(self,XEXP (x, 0));
         if (op0 != XEXP (x, 0)){
            poly_int64 c;
            if (GET_CODE (x) == PLUS && poly_int_rtx_p (XEXP (x, 1), &c))
               return mtcs_rtl_plus_constant/*!plus_constant*/(mtcsRTL,GET_MODE (x), op0, c);
            return mtcs_simplify_rtx_gen_binary/*!simplify_gen_binary*/(mtcsSimplifyRtx,GET_CODE (x),
                  GET_MODE (x),op0, XEXP (x, 1));
         }
      }
      return x;
   }
   v = CSELIB_VAL_PTR (x);
   if (v){
      bool have_equivs = mtcs_cse_lib_cselib_have_permanent_equivalences/*!cselib_have_permanent_equivalences*/(mtcsCseLib);
      if (have_equivs)
      ...
      if (have_equivs){
         for (l = v->locs; l; l = l->next)
            if (REG_P (l->loc) || (GET_CODE (l->loc) != VALUE && !refs_newer_value_p (l->loc, x)))
               return l->loc;
...
static rtx addr_side_effect_eval (MtcsAlias *self,rtx addr, poly_int64 size, int n_refs)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRTL *mtcsRTL=mtcs_target_get_rtl(mtcsTarget);
   ...
   addr = mtcs_rtl_plus_constant/*!plus_constant*/(mtcsRTL,GET_MODE (addr), XEXP (addr, 0), offset);
   addr = mtcs_alias_canon_rtx/*!canon_rtx*/(self,addr);
...
//不移植
static inline bool offset_overlap_p (poly_int64 c, poly_int64 xsize, poly_int64 ysize)
{
...
static int memrefs_conflict_p (MtcsAlias *self,poly_int64 xsize, rtx x, poly_int64 ysize, rtx y,
          poly_int64 c)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   ...
   if (GET_CODE (x) == VALUE){
      if (REG_P (y)){
         ...
         if (CSELIB_VAL_PTR (x))
            for (l = canonical_cselib_val (CSELIB_VAL_PTR (x))->locs; l; l = l->next)
               if (REG_P (l->loc) && rtx_equal_for_memref_p(self,l->loc, y))
                  break;
         if (l)
            x = y;
         else
            x = mtcs_alias_get_addr/*!get_addr*/(self,x);
      }
   ...
   if (GET_CODE (y) == VALUE){
      if (REG_P (x)){
         struct elt_loc_list *l = NULL;
         if (CSELIB_VAL_PTR (y))
            for (l = canonical_cselib_val (CSELIB_VAL_PTR (y))->locs; l; l = l->next)
               if (REG_P (l->loc) && rtx_equal_for_memref_p(self,l->loc, x))
                  break;
         if (l)
            y = x;
         else
            y = mtcs_alias_get_addr/*!get_addr*/(self,y);
      }
   ...
   if (GET_CODE (x) == HIGH)
      ...
      x = addr_side_effect_eval(self,x, maybe_lt (xsize, 0) ? -xsize : xsize, 0);
   if (GET_CODE (y) == HIGH)
      y = XEXP (y, 0);
   else if (GET_CODE (y) == LO_SUM)
      y = XEXP (y, 1);
   else
      y = addr_side_effect_eval(self,y, maybe_lt (ysize, 0) ? -ysize : ysize, 0);

   if (GET_CODE (x) == SYMBOL_REF && GET_CODE (y) == SYMBOL_REF){
      HOST_WIDE_INT distance = 0;
      int cmp = compare_base_symbol_refs(self,x, y, &distance);
      ...
      return -1;
   }else if (rtx_equal_for_memref_p(self,x, y)){
   ...
   if (x0 == y)
      return memrefs_conflict_p(self,xsize, x1, ysize, const0_rtx, c);
   else if (x1 == y)
      return memrefs_conflict_p(self,xsize, x0, ysize, const0_rtx, c);
   ...
   if (GET_CODE (y) == PLUS){
      ...
      if (x0 == y1)
         return memrefs_conflict_p(self,xsize, x1, ysize, y0, c);
      if (x1 == y0)
         return memrefs_conflict_p(self,xsize, x0, ysize, y1, c);

      if (rtx_equal_for_memref_p(self,x1, y1))
         return memrefs_conflict_p(self,xsize, x0, ysize, y0, c);
      if (rtx_equal_for_memref_p(self,x0, y0))
         return memrefs_conflict_p(self,xsize, x1, ysize, y1, c);
      if (poly_int_rtx_p (x1, &cx1)){
         if (poly_int_rtx_p (y1, &cy1))
            return memrefs_conflict_p(self,xsize, x0, ysize, y0, c - cx1 + cy1);
         else
            return memrefs_conflict_p(self,xsize, x0, ysize, y, c - cx1);
      }else if (poly_int_rtx_p (y1, &cy1))
         return memrefs_conflict_p(self,xsize, x, ysize, y0, c + cy1);
      ...
      if (x == y0)
         return memrefs_conflict_p(self,xsize, const0_rtx, ysize, y1, c);
      if (x == y1)
         return memrefs_conflict_p(self,xsize, const0_rtx, ysize, y0, c);
   ...
   if (GET_CODE (x) == GET_CODE (y))
      switch (GET_CODE (x)){
         case MULT:
         {
            ...
            rtx x0, y0;
            rtx x1 = mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 1));
            rtx y1 = mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (y, 1));
            if (! rtx_equal_for_memref_p(self,x1, y1))
               return -1;
            x0 = mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 0));
            y0 = mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (y, 0));
            if (rtx_equal_for_memref_p(self,x0, y0))
               return offset_overlap_p (c, xsize, ysize);
   ...
   if (GET_CODE (x) == AND && CONST_INT_P (XEXP (x, 1))){
      ...
      if (sc < 0 && pow2_or_zerop (-uc)){
         ...
         if (maybe_ne (xsize, 0))
            xsize += sc + 1;
         c -= sc + 1;
         return memrefs_conflict_p(self,xsize, mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 0)),ysize, y, c);
      }
   }
   ...
   if (GET_CODE (y) == AND && CONST_INT_P (XEXP (y, 1))){
      ...
      if (sc < 0 && pow2_or_zerop (-uc)){
         ...
         if (maybe_ne (ysize, 0))
            ysize += sc + 1;
         c += sc + 1;
         return memrefs_conflict_p(self,xsize, x,ysize, mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (y, 0)), c);
      }
   }
   ...
   if (CONSTANT_P (x)){
      ...
      if (GET_CODE (x) == CONST){
         if (GET_CODE (y) == CONST)
            return memrefs_conflict_p(self,xsize, mtcs_alias_canon_rtx/*!canon_rtx*/(self,
                  XEXP (x, 0)),ysize, mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (y, 0)), c);
         else
            return memrefs_conflict_p(self,xsize, mtcs_alias_canon_rtx/*!canon_rtx*/(self,XEXP (x, 0)),ysize, y, c);
      }
      if (GET_CODE (y) == CONST)
      ...
      other.  */
      if (CONSTANT_P (y))
         return (maybe_lt (xsize, 0) || maybe_lt (ysize, 0) || offset_overlap_p (c, xsize, ysize));
...
bool mtcs_alias_read_dependence (MtcsAlias *self,const_rtx mem, const_rtx x)
{
   ...
   if (MEM_VOLATILE_P (x) && MEM_VOLATILE_P (mem))
      return true;
   if (mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,x) == ALIAS_SET_MEMORY_BARRIER
         || mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,mem) == ALIAS_SET_MEMORY_BARRIER)
      return true;
   return false;
}
...
static void adjust_offset_for_component_ref (tree x, bool *known_p,poly_int64 *offset)
{
   ...
   do{
      ...
      poly_offset_int woffset= (wi::to_poly_offset (xoffset)
            + (wi::to_offset (DECL_FIELD_BIT_OFFSET (field)) >> LOG2_BITS_PER_UNIT) + *offset);
...
bool mtcs_alias_nonoverlapping_memrefs_p (MtcsAlias *self,const_rtx x, const_rtx y, bool loop_invariant)
{
   ...
   tree exprx = mtcs_rtl_get_mem_expr/*!MEM_EXPR*/(mtcsRTL,x), expry = mtcs_rtl_get_mem_expr/*!MEM_EXPR*/(mtcsRTL,y);
   rtx rtlx, rtly;
   rtx basex, basey;
   ...
   if ((exprx == mtcs_rtl_get_spill_slot_decl/*!get_spill_slot_decl*/(mtcsRTL,false)
   && ! mtcs_rtl_is_mem_offset_known_p/*!MEM_OFFSET_KNOWN_P*/(mtcsRTL,x))
   || (expry ==mtcs_rtl_get_spill_slot_decl/*!get_spill_slot_decl*/(mtcsRTL,false)
   && ! mtcs_rtl_is_mem_offset_known_p/*!MEM_OFFSET_KNOWN_P*/(mtcsRTL,y)))
      return false;

   /* If the field reference test failed, look at the DECLs involved.  */
   moffsetx_known_p = mtcs_rtl_is_mem_offset_known_p/*!MEM_OFFSET_KNOWN_P*/(mtcsRTL,x);
   if (moffsetx_known_p)
      moffsetx = mtcs_rtl_get_mem_offset/*!MEM_OFFSET*/(mtcsRTL,x);
   if (TREE_CODE (exprx) == COMPONENT_REF){
      tree t = decl_for_component_ref (exprx);//不移植
      if (! t)
         return false;
   ...
   moffsety_known_p = mtcs_rtl_is_mem_offset_known_p/*!MEM_OFFSET_KNOWN_P*/(mtcsRTL,y);
   if (moffsety_known_p)
      moffsety = mtcs_rtl_get_mem_offset/*!MEM_OFFSET*/(mtcsRTL,y);
   ...
   if (mtcs_gimple_expr_is_gimple_reg/*!is_gimple_reg*/(mtcsGimpleExpr,exprx)
         || mtcs_gimple_expr_is_gimple_reg/*!is_gimple_reg*/(mtcsGimpleExpr,expry))
      return exprx != expry
         || (moffsetx_known_p && moffsety_known_p
         && mtcs_rtl_is_mem_size_known_p/*!MEM_SIZE_KNOWN_P*/(mtcsRTL,x)
         && mtcs_rtl_is_mem_size_known_p/*!MEM_SIZE_KNOWN_P*/(mtcsRTL,y)
         && !offset_overlap_p (moffsety - moffsetx,
         mtcs_rtl_get_mem_size/*!MEM_SIZE*/(mtcsRTL,x), mtcs_rtl_get_mem_size/*!MEM_SIZE*/(mtcsRTL,y)));

   /* With invalid code we can end up storing into the constant pool.
   Bail out to avoid ICEing when creating RTL for this.
   See gfortran.dg/lto/20091028-2_0.f90.  */
   if (TREE_CODE (exprx) == CONST_DECL || TREE_CODE (expry) == CONST_DECL)
      return true;
   ...
   rtlx = mtcs_asm_decl_rtl/*!DECL_RTL*/(mtcsAsm,exprx);
   rtly = mtcs_asm_decl_rtl/*!DECL_RTL*/(mtcsAsm,expry);
   ...
   if ((!MEM_P (rtlx) || !MEM_P (rtly))  && ! rtx_equal_p (rtlx, rtly))
      return true;
   ...
   && mtcs_rtl_get_mem_addr_space/*!MEM_ADDR_SPACE*/(mtcsRTL,rtlx) != mtcs_rtl_get_mem_addr_space/*!MEM_ADDR_SPACE*/(mtcsRTL,rtly))
      return false;
   ...
   overlap or not.  */
   if (mtcs_alias_compare_base_decls/*!compare_base_decls*/(self,exprx, expry) == 0)
   ...
   sizex = (!MEM_P (rtlx) ? poly_int64 (mtcs_mode_get_size/*!GET_MODE_SIZE*/(mtcsMode,GET_MODE (rtlx)))
            : mtcs_rtl_is_mem_size_known_p/*!MEM_SIZE_KNOWN_P*/(mtcsRTL,rtlx) ? mtcs_rtl_get_mem_size/*!MEM_SIZE*/(mtcsRTL,rtlx)
            : -1);
   sizey = (!MEM_P (rtly) ? poly_int64 (mtcs_mode_get_size/*!GET_MODE_SIZE*/(mtcsMode,GET_MODE (rtly)))
            : mtcs_rtl_is_mem_size_known_p/*!MEM_SIZE_KNOWN_P*/(mtcsRTL,rtly) ? mtcs_rtl_get_mem_size/*!MEM_SIZE*/(mtcsRTL,rtly)
            : -1);
   ...
   if (mtcs_rtl_is_mem_size_known_p/*!MEM_SIZE_KNOWN_P*/(mtcsRTL,x) && moffsetx_known_p)
      sizex = mtcs_rtl_get_mem_size/*!MEM_SIZE*/(mtcsRTL,x);
   if (mtcs_rtl_is_mem_size_known_p/*!MEM_SIZE_KNOWN_P*/(mtcsRTL,y) && moffsety_known_p)
      sizey = mtcs_rtl_get_mem_size/*!MEM_SIZE*/(mtcsRTL,y);
...
static bool true_dependence_1 (MtcsAlias *self,const_rtx mem, machine_mode mem_mode, rtx mem_addr,
         const_rtx x, rtx x_addr, bool mem_canonicalized)
{
   ...
   gcc_checking_assert (mem_canonicalized ? (mem_addr != NULL_RTX): (mem_addr == NULL_RTX && x_addr == NULL_RTX));
   ...
   if (GET_MODE (x) == mtcsMode->modes.M_BLKmode && GET_CODE (XEXP (x, 0)) == SCRATCH)
      return true;
   if (GET_MODE (mem) == mtcsMode->modes.M_BLKmode && GET_CODE (XEXP (mem, 0)) == SCRATCH)
      return true;
   if (mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,x) == ALIAS_SET_MEMORY_BARRIER
   || mtcs_rtl_get_mem_alias/*!MEM_ALIAS_SET*/(mtcsRTL,mem) == ALIAS_SET_MEMORY_BARRIER)
      return true;
   ...
   if (! x_addr)
      x_addr = XEXP (x, 0);
   x_addr = mtcs_alias_get_addr/*!get_addr*/(self,x_addr);
   ...
   true_mem_addr = mtcs_alias_get_addr/*!get_addr*/(self,mem_addr);
   ...
   if (MEM_READONLY_P (x)  && GET_CODE (x_addr) != AND  && GET_CODE (true_mem_addr) != AND)
      return false;

   /* If we have MEMs referring to different address spaces (which can
   potentially overlap), we cannot easily tell from the addresses
   whether the references overlap.  */
   if (mtcs_rtl_get_mem_addr_space/*!MEM_ADDR_SPACE*/(mtcsRTL,mem) != mtcs_rtl_get_mem_addr_space/*!MEM_ADDR_SPACE*/(mtcsRTL,x))
      return true;

   base = find_base_term(self,x_addr);
   if (base && (GET_CODE (base) == LABEL_REF || (GET_CODE (base) == SYMBOL_REF  && CONSTANT_POOL_ADDRESS_P (base))))
      return false;

   rtx mem_base = find_base_term(self,true_mem_addr);
   if (! base_alias_check(self,x_addr, base, true_mem_addr, mem_base,GET_MODE (x), mem_mode))
      return false;

   x_addr = mtcs_alias_canon_rtx/*!canon_rtx*/(self,x_addr);
   if (!mem_canonicalized)
      mem_addr = mtcs_alias_canon_rtx/*!canon_rtx*/(self,true_mem_addr);

   if ((ret = memrefs_conflict_p(self,mtcs_mode_get_size/*!GET_MODE_SIZE*/(mtcsMode,mem_mode),
         mem_addr,SIZE_FOR_MODE (x), x_addr, 0)) != -1)
      return !!ret;
   n_debug("mtcsalias.c true_dependence_1 flag_strict_aliasing:%d\n",mtcsOptionsItem->x_flag_strict_aliasing);
   mtcs_print_rtl_single(stderr,x);
   if (mems_in_disjoint_alias_sets_p(self,x, mem))
      return false;

   if (mtcs_alias_nonoverlapping_memrefs_p/*!nonoverlapping_memrefs_p*/(self,mem, x, false))
      return false;

   return rtx_refs_may_alias_p(self,x, mem, true);
}
...
{
   return true_dependence_1(self,mem, mem_mode, NULL_RTX,x, NULL_RTX, /*mem_canonicalized=*/false);
}
...
{
   return true_dependence_1(self,mem, mem_mode, mem_addr,x, x_addr, /*mem_canonicalized=*/true);
}
...
static bool write_dependence_p (MtcsAlias *self,const_rtx mem,const_rtx x, machine_mode x_mode, rtx x_addr,
          bool mem_canonicalized, bool x_canonicalized, bool writep)
{
   ...
   gcc_checking_assert (x_canonicalized
      ? (x_addr != NULL_RTX && (x_mode != VOIDmode || GET_MODE (x) == VOIDmode))
   ...
   if (!x_addr)
      x_addr = XEXP (x, 0);
   true_x_addr = mtcs_alias_get_addr/*!get_addr*/(self,x_addr);
   ...
   if (!writep && MEM_READONLY_P (mem) && GET_CODE (true_x_addr) != AND && GET_CODE (true_mem_addr) != AND)
      return false;
   ...
   base = find_base_term(self,true_mem_addr);
   if (! writep   && base && (GET_CODE (base) == LABEL_REF || (GET_CODE (base) == SYMBOL_REF  && CONSTANT_POOL_ADDRESS_P (base))))
      return false;

   rtx x_base = find_base_term(self,true_x_addr);
   if (! base_alias_check(self,true_x_addr, x_base, true_mem_addr, base, GET_MODE (x), GET_MODE (mem)))
   return false;

   if (!x_canonicalized){
      x_addr = mtcs_alias_canon_rtx/*!canon_rtx*/(self,true_x_addr);
      x_mode = GET_MODE (x);
   }
   if (!mem_canonicalized)
      mem_addr = mtcs_alias_canon_rtx/*!canon_rtx*/(self,true_mem_addr);

   if ((ret = memrefs_conflict_p(self,SIZE_FOR_MODE (mem), mem_addr,
            mtcs_mode_get_size/*!GET_MODE_SIZE*/(mtcsMode,x_mode), x_addr, 0)) != -1)
      return !!ret;

   if (mtcs_alias_nonoverlapping_memrefs_p/*!nonoverlapping_memrefs_p*/(self,x, mem, false))
      return false;

   return rtx_refs_may_alias_p(self,x, mem, false);
}
...
{
   return write_dependence_p(self,mem, x, VOIDmode, NULL_RTX,
              /*mem_canonicalized=*/false,/*x_canonicalized*/false, /*writep=*/false);
}
...
{
   return write_dependence_p(self,mem, x, x_mode, x_addr,
              mem_canonicalized, /*x_canonicalized=*/true,/*writep=*/false);
}
...
{
   return write_dependence_p(self,mem, x, VOIDmode, NULL_RTX,
              /*mem_canonicalized=*/false, /*x_canonicalized*/false, /*writep=*/true);
}
...
{
   return write_dependence_p(self,mem, x, x_mode, x_addr,
              mem_canonicalized, /*x_canonicalized=*/true,/*writep=*/true);
}
...
bool mtcs_alias_may_alias_p (MtcsAlias *self,const_rtx mem, const_rtx x)
{
  ...
  mem_addr = XEXP (mem, 0);
  mem_addr = mtcs_alias_get_addr/*!get_addr*/(self,mem_addr);
  ...
  /* Read-only memory is by definition never modified, and therefore can't
     ...
     dependence.  We don't expect to find read-only set on MEM, but
     stupid user tricks can produce them, so don't die.  */
  if (MEM_READONLY_P (x)  && GET_CODE (x_addr) != AND  && GET_CODE (mem_addr) != AND)
    return false;
  ...
  rtx x_base = find_base_term(self,x_addr);
  rtx mem_base = find_base_term(self,mem_addr);
  if (! base_alias_check(self,x_addr, x_base, mem_addr, mem_base, GET_MODE (x), GET_MODE (mem_addr)))
    return false;

  if (mtcs_alias_nonoverlapping_memrefs_p/*!nonoverlapping_memrefs_p*/(self,mem, x, true))
    return false;
...
//原型 init_alias_target rtl.h alias.cc
void  mtcs_alias_init_alias_target (MtcsAlias *self)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRTL *mtcsRTL=mtcs_target_get_rtl(mtcsTarget);
   ...
   if (!self->arg_base_value)
      self->arg_base_value = gen_rtx_ADDRESS (VOIDmode, 0);
   ...
   for (i = 0; i < firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/; i++)
      ...
      if (mtcs_func_is_function_arg_regno/*!FUNCTION_ARG_REGNO_P*/(mtcsFunc,OUTGOING_REGNO (i))
      && mtcsTarget/*!targetm.hard_regno_mode_ok*/->hard_regno_mode_ok(mtcsTarget,i, mtcs_mode_get_Pmode(mtcsMode)))
         static_reg_base_value[i] = self->arg_base_value;
   ...
   static_reg_base_value[mtcs_reg_get_stack_pointer_regnum/*!STACK_POINTER_REGNUM*/(mtcsReg)]
                         = unique_base_value(self,UNIQUE_BASE_VALUE_SP);
   static_reg_base_value[mtcs_reg_get_arg_pointer_regnum/*!ARG_POINTER_REGNUM*/(mtcsReg)]
                         = unique_base_value(self,UNIQUE_BASE_VALUE_ARGP);
   static_reg_base_value[mtcs_reg_get_frame_pointer_regnum/*!FRAME_POINTER_REGNUM*/(mtcsReg)]
                         = unique_base_value(self,UNIQUE_BASE_VALUE_FP);
   ...
   if (!mtcs_reg_hard_frame_pointer_is_frame_pointer/*!HARD_FRAME_POINTER_IS_FRAME_POINTER*/(mtcsReg))
      static_reg_base_value[mtcs_reg_get_hard_frame_pointer_regnum/*!HARD_FRAME_POINTER_REGNUM*/(mtcsReg)]
                            = unique_base_value(self,UNIQUE_BASE_VALUE_HFP);
}
...
static void memory_modified_1 (rtx x, const_rtx pat ATTRIBUTE_UNUSED, void *userData)
{
   AliasData *data=(AliasData *)userData;
   MtcsAlias *self=data->mtcsAlias;
   const_rtx y=data->value;
   if (MEM_P (x)){
      if (mtcs_alias_anti_dependence/*!anti_dependence*/(self,x,  y/*!(const_rtx)data*/)
            || mtcs_alias_output_dependence/*!output_dependence*/(self,x, y/*!(const_rtx)data*/))
         *data->memory_modified = true;
   }
}
...
bool mtcs_alias_memory_modified_in_insn_p (MtcsAlias *self,const_rtx mem, const_rtx insn)
{
   ...
   AliasData userData={CONST_CAST_RTX(mem),self,&memory_modified};
   mtcs_rtlanal_note_stores/*!note_stores*/(mtcsRtlanal,as_a<const rtx_insn *> (insn),
         memory_modified_1,(void*)&userData/*!CONST_CAST_RTX(mem)*/);
   return memory_modified;
}

static void record_set_cb (rtx dest, const_rtx set, void *data ATTRIBUTE_UNUSED)
{
   MtcsAlias *self=(MtcsAlias *)data;
   record_set(self,dest,set,NULL);
}
...
void mtcs_alias_init_alias_analysis (MtcsAlias *self)
{
   ...
   int firstPseudoRegister = mtcs_reg_get_first_pseudo_register/*!FIRST_PSEUDO_REGISTER*/(mtcsReg);
   const bool frame_pointer_eliminated  = reload_completed
            && !mtcsRtlData->x_frame_pointer_needed/*!frame_pointer_needed*/
            && mtcsTarget/*!targetm.can_eliminate*/->can_eliminate(mtcsTarget,
   ...
   unsigned int maxreg = mtcs_func_max_reg_num/*!max_reg_num*/(mtcsFunc);
   bool changed;
   int pass, i;
   unsigned int ui;
   rtx_insn *insn;
   ...
   vec_safe_grow_cleared (self->reg_known_value, maxreg - firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/,true);
   self->reg_known_equiv_p = sbitmap_alloc (maxreg - firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/);
   bitmap_clear (self->reg_known_equiv_p);

   /* If we have memory allocated from the previous run, use it.  */
   if (self->old_reg_base_value)
      self->reg_base_value = self->old_reg_base_value;

   if (self->reg_base_value)
      self->reg_base_value->truncate (0);

   vec_safe_grow_cleared (self->reg_base_value, maxreg, true);

   self->new_reg_base_value = XNEWVEC (rtx, maxreg);
   self->reg_seen = sbitmap_alloc (maxreg);
   ...
   do{
      ...
      self->copying_arguments = true;

      /* Wipe the potential alias information clean for this pass.  */
      memset (self->new_reg_base_value, 0, maxreg * sizeof (rtx));

      /* Wipe the reg_seen array clean.  */
      bitmap_clear (self->reg_seen);
      ...
      for (i = 0; i < firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/; i++)
         ...
         && !(i ==mtcs_reg_get_hard_frame_pointer_regnum/*!HARD_FRAME_POINTER_REGNUM*/(mtcsReg) && frame_pointer_eliminated)){
            self->new_reg_base_value[i] = static_reg_base_value[i];
            bitmap_set_bit (self->reg_seen, i);
         }
      ...
      for (i = 0; i < rpo_cnt; i++){
         ...
         FOR_BB_INSNS (bb, insn){
            if (NONDEBUG_INSN_P (insn)){
               ...
               eliminated the frame pointer to the stack pointer.  */
               if (!frame_pointer_eliminated  && mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,
                     mtcs_rtl_get_hard_frame_pointer_rtx/*!hard_frame_pointer_rtx*/(mtcsRTL), insn))
                  continue;

               /* If this insn has a noalias note, process it,  Otherwise,
               scan for sets.  A simple set will have no side effects
               which could change the base value of any other register.  */
               if (GET_CODE (PATTERN (insn)) == SET && REG_NOTES (insn) != 0  && find_reg_note (insn, REG_NOALIAS, NULL_RTX))
                  record_set(self,SET_DEST (PATTERN (insn)), NULL_RTX, NULL);
               else
                  mtcs_rtlanal_note_stores/*!note_stores*/(mtcsRtlanal,insn, record_set_cb, (void *)self/*!NULL*/);

               set = single_set (insn);

               if (set != 0   && REG_P (SET_DEST (set)) && REGNO (SET_DEST (set)) >= firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/){
                  unsigned int regno = REGNO (SET_DEST (set));
                  rtx src = SET_SRC (set);
                  rtx t;

                  note = find_reg_equal_equiv_note (insn);
                  if (note && REG_NOTE_KIND (note) == REG_EQUAL   && DF_REG_DEF_COUNT (regno) != 1)
                     note = NULL_RTX;

                  poly_int64 offset;
                  if (note != NULL_RTX
                  && GET_CODE (XEXP (note, 0)) != EXPR_LIST
                  && ! mtcs_rtlanal_rtx_varies_p/*!rtx_varies_p*/(mtcsRtlanal,XEXP (note, 0), 1)
                  && ! reg_overlap_mentioned_p (SET_DEST (set),XEXP (note, 0))){
                     set_reg_known_value(self,regno, XEXP (note, 0));
                     set_reg_known_equiv_p(self,regno,REG_NOTE_KIND (note) == REG_EQUIV);
                  }else if (DF_REG_DEF_COUNT (regno) == 1
                  && GET_CODE (src) == PLUS
                  && REG_P (XEXP (src, 0))
                  && (t = mtcs_alias_get_reg_known_value/*!get_reg_known_value*/(self,REGNO (XEXP (src, 0))))
                  && poly_int_rtx_p (XEXP (src, 1), &offset)){
                     t = mtcs_rtl_plus_constant/*!plus_constant*/(mtcsRTL,GET_MODE (src), t, offset);
                     set_reg_known_value(self,regno, t);
                     set_reg_known_equiv_p(self,regno, false);
                  }else if (DF_REG_DEF_COUNT (regno) == 1  && ! mtcs_rtlanal_rtx_varies_p/*!rtx_varies_p*/(mtcsRtlanal,src, 1)){
                     set_reg_known_value(self,regno, src);
                     set_reg_known_equiv_p(self,regno, false);
                  }
               }
            }else if (NOTE_P (insn)  && NOTE_KIND (insn) == NOTE_INSN_FUNCTION_BEG)
               self->copying_arguments = false;
         }
      }

      /* Now propagate values from new_reg_base_value to reg_base_value.  */
      gcc_assert (maxreg == (unsigned int)mtcs_func_max_reg_num/*!max_reg_num*/(mtcsFunc));

      for (ui = 0; ui < maxreg; ui++){
         if (self->new_reg_base_value[ui]
         && self->new_reg_base_value[ui] != (*self->reg_base_value)[ui]
         && ! rtx_equal_p (self->new_reg_base_value[ui], (*self->reg_base_value)[ui])){
            (*self->reg_base_value)[ui] = self->new_reg_base_value[ui];
            changed = true;
         }
      }
   ...
   FOR_EACH_VEC_ELT (*self->reg_known_value, i, val){
      int regno = i + firstPseudoRegister/*!FIRST_PSEUDO_REGISTER*/;
      if (! val)
         set_reg_known_value(self,regno, mtcsRtlData->regno_reg_rtx/*!regno_reg_rtx*/[regno]);
   }

   /* Clean up.  */
   free (self->new_reg_base_value);
   self->new_reg_base_value = 0;
   sbitmap_free (self->reg_seen);
   self->reg_seen = 0;
}
...
{
  (*self->reg_base_value)[REGNO (reg1)] = REG_BASE_VALUE (reg2);
}

//原型 end_alias_analysis rtl.h alias.cc
void mtcs_alias_end_alias_analysis (MtcsAlias *self)
{
  self->old_reg_base_value = self->reg_base_value;
  vec_free (self->reg_known_value);
  sbitmap_free (self->reg_known_equiv_p);
}
...
void mtcs_alias_dump_alias_stats_in_alias_c (MtcsAlias *self,FILE *s)
{
  fprintf (s, "  TBAA oracle: %llu disambiguations %llu queries\n"
      ...
      self->alias_stats.num_disambiguated,
      self->alias_stats.num_alias_zero + self->alias_stats.num_same_alias_set
      + self->alias_stats.num_same_objects + self->alias_stats.num_volatile
      + self->alias_stats.num_dag + self->alias_stats.num_disambiguated
      + self->alias_stats.num_universal,
      self->alias_stats.num_alias_zero, self->alias_stats.num_same_alias_set,
      self->alias_stats.num_same_objects, self->alias_stats.num_volatile,
      self->alias_stats.num_dag, self->alias_stats.num_universal);
}

static void mtcsAliasInit(MtcsAlias *self)
{
   self->varargs_set = -1;
   self->frame_set=-1;
}
...
{
    MtcsAlias *self = n_slice_alloc0 (sizeof(MtcsAlias));
