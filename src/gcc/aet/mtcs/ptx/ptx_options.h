...
#endif
#ifdef GENERATOR_FILE
extern int nvptx_alias;
#else
  int x_nvptx_alias;
#define nvptx_alias global_options.x_nvptx_alias
#endif
#ifdef GENERATOR_FILE
extern int nvptx_experimental;
#else
  int x_nvptx_experimental;
#define nvptx_experimental global_options.x_nvptx_experimental
#endif
#ifdef GENERATOR_FILE
extern int fake_exceptions;
#else
  int x_fake_exceptions;
#define fake_exceptions global_options.x_fake_exceptions
#endif
#ifdef GENERATOR_FILE
extern int nvptx_fake_ptx_alloca;
#else
  int x_nvptx_fake_ptx_alloca;
#define nvptx_fake_ptx_alloca global_options.x_nvptx_fake_ptx_alloca
#endif
#ifdef GENERATOR_FILE
extern int nvptx_init_regs;
#else
  int x_nvptx_init_regs;
#define nvptx_init_regs global_options.x_nvptx_init_regs
#endif
#ifdef GENERATOR_FILE
extern enum ptx_isa ptx_isa_option;
#else
  enum ptx_isa x_ptx_isa_option;
#define ptx_isa_option global_options.x_ptx_isa_option
#endif
#ifdef GENERATOR_FILE
extern int nvptx_optimize;
#else
  int x_nvptx_optimize;
#define nvptx_optimize global_options.x_nvptx_optimize
#endif
#ifdef GENERATOR_FILE
extern int nvptx_comment;
#else
  int x_nvptx_comment;
#define nvptx_comment global_options.x_nvptx_comment
#endif
#ifdef GENERATOR_FILE
extern enum ptx_version ptx_version_option;
#else
  enum ptx_version x_ptx_version_option;
#define ptx_version_option global_options.x_ptx_version_option
#endif
#ifdef GENERATOR_FILE
extern int nvptx_softstack_size;
#else
  int x_nvptx_softstack_size;
#define nvptx_softstack_size global_options.x_nvptx_softstack_size
#endif
#ifdef GENERATOR_FILE
...
#define x_VAR_mmainkernel do_not_use
#endif
#ifndef GENERATOR_FILE
...
/* ABI64 mask */
#define TARGET_ABI64 ((target_flags & MASK_ABI64) != 0)
#define TARGET_ABI64_P(target_flags) (((target_flags) & MASK_ABI64) != 0)
#define TARGET_ABI64_OPTS_P(opts) (((opts->x_target_flags) & MASK_ABI64) != 0)
#define TARGET_EXPLICIT_ABI64_P(opts) ((opts->x_target_flags_explicit & MASK_ABI64) != 0)
#define SET_TARGET_ABI64(opts) opts->x_target_flags |= MASK_ABI64
/* GOMP mask */
#define TARGET_GOMP ((target_flags & MASK_GOMP) != 0)
#define TARGET_GOMP_P(target_flags) (((target_flags) & MASK_GOMP) != 0)
#define TARGET_GOMP_OPTS_P(opts) (((opts->x_target_flags) & MASK_GOMP) != 0)
#define TARGET_EXPLICIT_GOMP_P(opts) ((opts->x_target_flags_explicit & MASK_GOMP) != 0)
#define SET_TARGET_GOMP(opts) opts->x_target_flags |= MASK_GOMP
/* SOFT_STACK mask */
#define TARGET_SOFT_STACK ((target_flags & MASK_SOFT_STACK) != 0)
#define TARGET_SOFT_STACK_P(target_flags) (((target_flags) & MASK_SOFT_STACK) != 0)
#define TARGET_SOFT_STACK_OPTS_P(opts) (((opts->x_target_flags) & MASK_SOFT_STACK) != 0)
#define TARGET_EXPLICIT_SOFT_STACK_P(opts) ((opts->x_target_flags_explicit & MASK_SOFT_STACK) != 0)
#define SET_TARGET_SOFT_STACK(opts) opts->x_target_flags |= MASK_SOFT_STACK
/* UNIFORM_SIMT mask */
#define TARGET_UNIFORM_SIMT ((target_flags & MASK_UNIFORM_SIMT) != 0)
#define TARGET_UNIFORM_SIMT_P(target_flags) (((target_flags) & MASK_UNIFORM_SIMT) != 0)
#define TARGET_UNIFORM_SIMT_OPTS_P(opts) (((opts->x_target_flags) & MASK_UNIFORM_SIMT) != 0)
#define TARGET_EXPLICIT_UNIFORM_SIMT_P(opts) ((opts->x_target_flags_explicit & MASK_UNIFORM_SIMT) != 0)
...
enum opt_code
{
  ...
  /* OPT__pass_exit_codes = 370, */          /* --pass-exit-codes */
  /* OPT__pedantic = 371, */                 /* --pedantic */
  /* OPT__pedantic_errors = 372, */          /* --pedantic-errors */
  /* OPT__pie = 373, */                      /* --pie */
  /* OPT__pipe = 374, */                     /* --pipe */
  /* OPT__prefix = 375, */                   /* --prefix */
  /* OPT__prefix_ = 376, */                  /* --prefix= */
  /* OPT__preprocess = 377, */               /* --preprocess */
  /* OPT__print_file_name = 378, */          /* --print-file-name */
  /* OPT__print_file_name_ = 379, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 380, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 381, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 382, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 383, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 384, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 385, */          /* --print-multiarch */
  /* OPT__print_prog_name = 386, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 387, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 388, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 389, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 390, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 391, */                  /* --profile */
  /* OPT__save_temps = 392, */               /* --save-temps */
  /* OPT__shared = 393, */                   /* --shared */
  /* OPT__specs = 394, */                    /* --specs */
  /* OPT__specs_ = 395, */                   /* --specs= */
  /* OPT__static = 396, */                   /* --static */
  /* OPT__static_pie = 397, */               /* --static-pie */
  /* OPT__symbolic = 398, */                 /* --symbolic */
  /* OPT__sysroot = 399, */                  /* --sysroot */
  OPT__sysroot_ = 400,                       /* --sysroot= */
  OPT__target_help = 401,                    /* --target-help */
  /* OPT__time = 402, */                     /* --time */
  /* OPT__trace_includes = 403, */           /* --trace-includes */
  /* OPT__traditional = 404, */              /* --traditional */
  /* OPT__traditional_cpp = 405, */          /* --traditional-cpp */
  /* OPT__trigraphs = 406, */                /* --trigraphs */
  /* OPT__undefine_macro = 407, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 408, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 409, */        /* --user-dependencies */
  /* OPT__verbose = 410, */                  /* --verbose */
  OPT__version = 411,                        /* --version */
  /* OPT__write_dependencies = 412, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 413, */  /* --write-user-dependencies */
  OPT_A = 414,                               /* -A */
  OPT_B = 415,                               /* -B */
  OPT_C = 416,                               /* -C */
  OPT_CC = 417,                              /* -CC */
  ...
  OPT_MQ = 434,                              /* -MQ */
  OPT_MT = 435,                              /* -MT */
  OPT_Mmodules = 436,                        /* -Mmodules */
  OPT_Mno_modules = 437,                     /* -Mno-modules */
  OPT_N = 438,                               /* -N */
  OPT_O = 439,                               /* -O */
  OPT_Ofast = 440,                           /* -Ofast */
  OPT_Og = 441,                              /* -Og */
  ...
  OPT_Tbss_ = 452,                           /* -Tbss= */
  OPT_Tdata = 453,                           /* -Tdata */
  OPT_Tdata_ = 454,                          /* -Tdata= */
  OPT_Ttext = 455,                           /* -Ttext */
  OPT_Ttext_ = 456,                          /* -Ttext= */
  OPT_U = 457,                               /* -U */
  /* OPT_W = 458, */                         /* -W */
  OPT_WNSObject_attribute = 459,             /* -WNSObject-attribute */
  OPT_Wa_ = 460,                             /* -Wa, */
  OPT_Wabi = 461,                            /* -Wabi */
  OPT_Wabi_tag = 462,                        /* -Wabi-tag */
  OPT_Wabi_ = 463,                           /* -Wabi= */
  OPT_Wabsolute_value = 464,                 /* -Wabsolute-value */
  ...
  OPT_Wmudflap = 745,                        /* -Wmudflap */
  OPT_Wmultichar = 746,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 747,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 748,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 749,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 750,                     /* -Wnamespaces */
  OPT_Wnarrowing = 751,                      /* -Wnarrowing */
  OPT_Wnested_externs = 752,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 753, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 754, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 755, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 756, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 757, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 758, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 759,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 760,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 761,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 762,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 763,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 764,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 765, */               /* -Wnormalized */
  OPT_Wnormalized_ = 766,                    /* -Wnormalized= */
  OPT_Wnrvo = 767,                           /* -Wnrvo */
  OPT_Wnull_dereference = 768,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 769,                /* -Wobjc-root-class */
  OPT_Wodr = 770,                            /* -Wodr */
  OPT_Wold_style_cast = 771,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 772,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 773,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 774,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 775,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 776,                    /* -Wopenmp-simd */
  OPT_Woverflow = 777,                       /* -Woverflow */
  OPT_Woverlength_strings = 778,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 779, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 780,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 781,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 782,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 783,            /* -Woverwrite-recursive */
  OPT_Wp_ = 784,                             /* -Wp, */
  OPT_Wpacked = 785,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 786,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 787,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 788,                         /* -Wpadded */
  OPT_Wparentheses = 789,                    /* -Wparentheses */
  OPT_Wpedantic = 790,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 791,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 792,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 793,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 794, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 795,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 796,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 797,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 798,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 799,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 800,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 801,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 802,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 803,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 804,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 805,                       /* -Wprotocol */
  OPT_Wpsabi = 806,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 807,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 808,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 809,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 810,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 811,                /* -Wredundant-decls */
  OPT_Wredundant_move = 812,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 813,                 /* -Wredundant-tags */
  OPT_Wregister = 814,                       /* -Wregister */
  OPT_Wreorder = 815,                        /* -Wreorder */
  OPT_Wrestrict = 816,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 817,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 818,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 819,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 820,           /* -Wscalar-storage-order */
  OPT_Wselector = 821,                       /* -Wselector */
  OPT_Wself_move = 822,                      /* -Wself-move */
  OPT_Wsequence_point = 823,                 /* -Wsequence-point */
  OPT_Wshadow = 824,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 825, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 826,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 827, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 828,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 829, */            /* -Wshadow=global */
  OPT_Wshadow_local = 830,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 831,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 832,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 833,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 834, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 835,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 836,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 837,                /* -Wsign-conversion */
  OPT_Wsign_promo = 838,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 839,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 840,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 841,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 842,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 843,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 844,                    /* -Wspeculative */
  OPT_Wstack_protector = 845,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 846,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 847,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 848,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 849,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 850,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 851,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 852,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 853,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 854,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 855,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 856, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 857,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 858,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 859,            /* -Wstringop-truncation */
  OPT_Wstyle = 860,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 861,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 862,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 863,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 864,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 865,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 866,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 867,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 868,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 869,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 870,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 871,               /* -Wsuggest-override */
  OPT_Wsurprising = 872,                     /* -Wsurprising */
  OPT_Wswitch = 873,                         /* -Wswitch */
  OPT_Wswitch_bool = 874,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 875,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 876,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 877,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 878,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 879,                      /* -Wsync-nand */
  OPT_Wsynth = 880,                          /* -Wsynth */
  OPT_Wsystem_headers = 881,                 /* -Wsystem-headers */
  OPT_Wtabs = 882,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 883,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 884,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 885,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 886,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 887,        /* -Wtemplate-names-tu-local */
  ...
  OPT_copyext = 958,                         /* -copyext */
  OPT_coverage = 959,                        /* -coverage */
  OPT_cpp = 960,                             /* -cpp */
  OPT_cpp_ = 961,                            /* -cpp= */
  OPT_d = 962,                               /* -d */
  OPT_debuglib_ = 963,                       /* -debuglib= */
  OPT_defaultlib_ = 964,                     /* -defaultlib= */
  OPT_defined_only = 965,                    /* -defined-only */
  OPT_demangle = 966,                        /* -demangle */
  OPT_dialect = 967,                         /* -dialect */
  OPT_dstartfiles = 968,                     /* -dstartfiles */
  OPT_dump_body_ = 969,                      /* -dump-body= */
  OPT_dump_level_ = 970,                     /* -dump-level= */
  OPT_dumpbase = 971,                        /* -dumpbase */
  OPT_dumpbase_ext = 972,                    /* -dumpbase-ext */
  OPT_dumpdir = 973,                         /* -dumpdir */
  OPT_dumpfullversion = 974,                 /* -dumpfullversion */
  OPT_dumpmachine = 975,                     /* -dumpmachine */
  OPT_dumpspecs = 976,                       /* -dumpspecs */
  OPT_dumpversion = 977,                     /* -dumpversion */
  OPT_e = 978,                               /* -e */
  OPT_export_dynamic = 979,                  /* -export-dynamic */
  OPT_fPIC = 980,                            /* -fPIC */
  OPT_fPIE = 981,                            /* -fPIE */
  OPT_fRTS_ = 982,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 983,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 984,                   /* -fabi-version= */
  OPT_faccess_control = 985,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 986,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 987,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 988,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 989,                  /* -falign-commons */
  OPT_falign_functions = 990,                /* -falign-functions */
  OPT_falign_functions_ = 991,               /* -falign-functions= */
  OPT_falign_jumps = 992,                    /* -falign-jumps */
  OPT_falign_jumps_ = 993,                   /* -falign-jumps= */
  OPT_falign_labels = 994,                   /* -falign-labels */
  OPT_falign_labels_ = 995,                  /* -falign-labels= */
  OPT_falign_loops = 996,                    /* -falign-loops */
  OPT_falign_loops_ = 997,                   /* -falign-loops= */
  /* OPT_faligned_new = 998, */              /* -faligned-new */
  OPT_faligned_new_ = 999,                   /* -faligned-new= */
  OPT_fall_instantiations = 1000,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1001,                /* -fall-intrinsics */
  OPT_fall_virtual = 1002,                   /* -fall-virtual */
  OPT_fallocation_dce = 1003,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1004,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1005,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1006,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1007, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1008,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1009,        /* -falt-external-templates */
  OPT_fanalyzer = 1010,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1011,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1012,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1013,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1014,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1015,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1016, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1017,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1018,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1019,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1020,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1021,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1022,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1023,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1024,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1025,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1026, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1027, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1028, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1029, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1030,           /* -fasan-shadow-offset= */
  OPT_fasm = 1031,                           /* -fasm */
  OPT_fassert = 1032,                        /* -fassert */
  OPT_fassociative_math = 1033,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1034,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1035,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1036,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1037,                     /* -fauto-init */
  OPT_fauto_profile = 1038,                  /* -fauto-profile */
  OPT_fauto_profile_ = 1039,                 /* -fauto-profile= */
  OPT_fautomatic = 1040,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1041,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1042,                     /* -fbackslash */
  OPT_fbacktrace = 1043,                     /* -fbacktrace */
  OPT_fbit_tests = 1044,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1045,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1046,                        /* -fbounds */
  OPT_fbounds_check = 1047,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1048,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1049,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1050,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1051, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1052, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1053, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1054,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1055,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1056,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1057,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1058,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1059,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1060,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1061,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1062,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1063,                    /* -fcall-used- */
  OPT_fcaller_saves = 1064,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1065,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1066,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1067,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1068,      /* -fcanonical-system-headers */
  OPT_fcase = 1069,                          /* -fcase */
  /* OPT_fcf_protection = 1070, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1071,                /* -fcf-protection= */
  OPT_fchar8_t = 1072,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1073,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1074, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1075,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1076,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1077,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1078, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1079, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1080, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1081, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1082, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1083, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1084,                  /* -fcheckaction= */
  OPT_fchecking = 1085,                      /* -fchecking */
  OPT_fchecking_ = 1086,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1087,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1088,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1089,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1090,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1091,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1092,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1093,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1094,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1095,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1096,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1097,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1098,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1099,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1100,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1101,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1102,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1103,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1104,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1105, */                /* -fcilkplus */
  OPT_fcoarray_ = 1106,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1107,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1108,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1109,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1110,                        /* -fcommon */
  OPT_fcompare_debug = 1111,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1112,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1113,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1114,                  /* -fcompare-elim */
  OPT_fconcepts = 1115,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1116,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1117,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1118,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1119,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1120, */          /* -fconserve-space */
  OPT_fconserve_stack = 1121,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1122,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1123,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1124,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1125,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1126,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1127,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1128,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1129,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1130,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1131,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1132,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1133,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1134, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1135,                     /* -fcontracts */
  OPT_fconvert_ = 1136,                      /* -fconvert= */
  OPT_fcoroutines = 1137,                    /* -fcoroutines */
  OPT_fcpp = 1138,                           /* -fcpp */
  OPT_fcpp_begin = 1139,                     /* -fcpp-begin */
  OPT_fcpp_end = 1140,                       /* -fcpp-end */
  OPT_fcprop_registers = 1141,               /* -fcprop-registers */
  OPT_fcray_pointer = 1142,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1143,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1144,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1145, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1146,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1147,              /* -fcx-limited-range */
  OPT_fd = 1148,                             /* -fd */
  OPT_fd_lines_as_code = 1149,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1150,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1151,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1152,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1153,                      /* -fdbg-cnt= */
  OPT_fdce = 1154,                           /* -fdce */
  OPT_fdebug = 1155,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1156,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1157,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1158,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1159,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1160,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1161,           /* -fdebug-types-section */
  OPT_fdebug_ = 1162,                        /* -fdebug= */
  OPT_fdec = 1163,                           /* -fdec */
  OPT_fdec_blank_format_item = 1164,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1165,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1166,           /* -fdec-format-defaults */
  OPT_fdec_include = 1167,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1168,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1169,                      /* -fdec-math */
  OPT_fdec_static = 1170,                    /* -fdec-static */
  OPT_fdec_structure = 1171,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1172,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1173, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1174,                          /* -fdef= */
  OPT_fdefault_double_8 = 1175,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1176, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1177,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1178,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1179,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1180,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1181,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1182,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1183,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1184,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1185,    /* -fdelete-null-pointer-checks */
  OPT_fdeps_file_ = 1186,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1187,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1188,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1189,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1190,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1191,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1192,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1193,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1194, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1195,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1196,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1197,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1198,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1199,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1200,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1201,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1202,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1203,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1204,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1205,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1206,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1207,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1208,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1209,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1210,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1211,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1212, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1213,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1214,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1215,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1216,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1217,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1218, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1219,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1220,               /* -fdirectives-only */
  OPT_fdisable_ = 1221,                      /* -fdisable- */
  OPT_fdoc = 1222,                           /* -fdoc */
  OPT_fdoc_dir_ = 1223,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1224,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1225,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1226,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1227,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1228,                      /* -fdruntime */
  OPT_fdse = 1229,                           /* -fdse */
  OPT_fdump_ = 1230,                         /* -fdump- */
  OPT_fdump_ada_spec = 1231,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1232,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1233,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1234,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1235,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1236,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1237,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1238,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1239,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1240,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1241,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1242,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1243,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1244,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1245,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1246,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1247,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1248,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1249, */               /* -fdump-core */
  OPT_fdump_d_original = 1250,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1251,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1252,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1253,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1254,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1255,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1256,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1257,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1258,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1259, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1260,                   /* -fdump-passes */
  OPT_fdump_scos = 1261,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1262,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1263,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1264,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1265,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1266,                /* -fearly-inlining */
  OPT_felide_constructors = 1267,            /* -felide-constructors */
  OPT_felide_type = 1268,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1269, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1270,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1271,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1272,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1273,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1274,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1275,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1276,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1277,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1278,                /* -fenum-int-equiv */
  OPT_fexceptions = 1279,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1280,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1281,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1282,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1283,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1284,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1285,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1286,               /* -fextended-opaque */
  OPT_fextern_std_ = 1287,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1288,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1289,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1290,            /* -fexternal-templates */
  OPT_ff2c = 1291,                           /* -ff2c */
  OPT_ffast_math = 1292,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1293,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1294,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1295,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1296,              /* -ffinite-math-only */
  OPT_ffixed_ = 1297,                        /* -ffixed- */
  OPT_ffixed_form = 1298,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1299,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1300,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1301,                    /* -fflex-debug */
  OPT_ffloat_store = 1302,                   /* -ffloat-store */
  OPT_ffloatvalue = 1303,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1304,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1305,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1306,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1307, */              /* -fforce-addr */
  OPT_fforward_propagate = 1308,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1309,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1310,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1311,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1312,                     /* -ffpe-trap= */
  OPT_ffree_form = 1313,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1314,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1315,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1316,                  /* -ffreestanding */
  OPT_ffriend_injection = 1317,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1318,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1319,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1320,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1321,             /* -ffunction-sections */
  OPT_fgcse = 1322,                          /* -fgcse */
  OPT_fgcse_after_reload = 1323,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1324,                      /* -fgcse-las */
  OPT_fgcse_lm = 1325,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1326,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1327,              /* -fgen-module-list= */
  OPT_fgimple = 1328,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1329,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1330,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1331,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1332,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1333,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1334,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1335,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1336,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1337,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1338,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1339,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1340,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1341,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1342,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1343,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1344,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1345,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1346,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1347,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1348,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1349,                      /* -fgraphite */
  OPT_fgraphite_identity = 1350,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1351,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1352,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1353, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1354,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1355, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1356, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1357,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1358,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1359,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1360,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1361,                      /* -fhardened */
  /* OPT_fhelp = 1362, */                    /* -fhelp */
  /* OPT_fhelp_ = 1363, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1364,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1365,                     /* -fhonor-std */
  OPT_fhosted = 1366,                        /* -fhosted */
  OPT_fhuge_objects = 1367,                  /* -fhuge-objects */
  OPT_fident = 1368,                         /* -fident */
  OPT_fif_conversion = 1369,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1370,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1371,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1372,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1373,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1374,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1375,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1376,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1377,            /* -fimplicit-templates */
  OPT_finclude_imports = 1378,               /* -finclude-imports */
  OPT_findex = 1379,                         /* -findex */
  OPT_findicator_column = 1380,              /* -findicator-column */
  OPT_findirect_inlining = 1381,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1382,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1383,               /* -finit-character= */
  OPT_finit_derived = 1384,                  /* -finit-derived */
  OPT_finit_integer_ = 1385,                 /* -finit-integer= */
  OPT_finit_local_zero = 1386,               /* -finit-local-zero */
  OPT_finit_logical_ = 1387,                 /* -finit-logical= */
  OPT_finit_real_ = 1388,                    /* -finit-real= */
  OPT_finline = 1389,                        /* -finline */
  OPT_finline_arg_packing = 1390,            /* -finline-arg-packing */
  OPT_finline_atomics = 1391,                /* -finline-atomics */
  OPT_finline_functions = 1392,              /* -finline-functions */
  OPT_finline_functions_called_once = 1393,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1394,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1395,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1396, */           /* -finline-limit- */
  OPT_finline_limit_ = 1397,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1398,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1399,        /* -finline-small-functions */
  OPT_finline_stringops = 1400,              /* -finline-stringops */
  OPT_finline_stringops_ = 1401,             /* -finline-stringops= */
  OPT_finput_charset_ = 1402,                /* -finput-charset= */
  OPT_finstrument_functions = 1403,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1404,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1405,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1406,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1407,           /* -finteger-4-integer-8 */
  OPT_finternal_ebcdic = 1408,               /* -finternal-ebcdic */
  OPT_fintrinsic_modules_path = 1409,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1410,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1411,                    /* -finvariants */
  OPT_fipa_bit_cp = 1412,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1413,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1414, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1415,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1416,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1417,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1418,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1419, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1420,                    /* -fipa-modref */
  OPT_fipa_profile = 1421,                   /* -fipa-profile */
  OPT_fipa_pta = 1422,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1423,                /* -fipa-pure-const */
  OPT_fipa_ra = 1424,                        /* -fipa-ra */
  OPT_fipa_reference = 1425,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1426,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1427,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1428,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1429,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1430,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1431, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1432,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1433,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1434,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1435,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1436,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1437,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1438,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1439,                  /* -fira-verbose= */
  OPT_fiso = 1440,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1441,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1442,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1443,              /* -fivar-visibility= */
  OPT_fivopts = 1444,                        /* -fivopts */
  OPT_fjump_tables = 1445,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1446,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1447,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1448,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1449,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1450,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1451,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1452,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1453,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1454,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1455,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1456,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1457, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1458,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1459,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1460,            /* -fleading-underscore */
  OPT_flibs_ = 1461,                         /* -flibs= */
  OPT_flifetime_dse = 1462,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1463,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1464,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1465,                /* -flinker-output= */
  /* OPT_flive_patching = 1466, */           /* -flive-patching */
  OPT_flive_patching_ = 1467,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1468,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1469,                   /* -flocal-ivars */
  OPT_flocation_ = 1470,                     /* -flocation= */
  /* OPT_floop_block = 1471, */              /* -floop-block */
  /* OPT_floop_flatten = 1472, */            /* -floop-flatten */
  OPT_floop_interchange = 1473,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1474,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1475, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1476,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1477, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1478,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1479,                     /* -flra-remat */
  OPT_flto = 1480,                           /* -flto */
  OPT_flto_compression_level_ = 1481,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1482,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1483,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1484, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1485,                /* -flto-partition= */
  OPT_flto_report = 1486,                    /* -flto-report */
  OPT_flto_report_wpa = 1487,                /* -flto-report-wpa */
  OPT_flto_ = 1488,                          /* -flto= */
  OPT_fltrans = 1489,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1490,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1491,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1492,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1493,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1494,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1495,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1496,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1497,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1498,                          /* -fm2-g */
  OPT_fm2_lower_case = 1499,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1500,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1501,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1502,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1503,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1504,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1505,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1506,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1507,             /* -fmacro-prefix-map= */
  OPT_fmain = 1508,                          /* -fmain */
  OPT_fmalloc_dce = 1509,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1510,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1511,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1512,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1513,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1514,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1515,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1516,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1517,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1518,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1519,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1520,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1521,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1522,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1523,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1524,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1525,                          /* -fmod= */
  OPT_fmodule_file_ = 1526,                  /* -fmodule-file= */
  OPT_fmodule_header = 1527,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1528,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1529,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1530,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1531,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1532,                   /* -fmodule-only */
  OPT_fmodule_private = 1533,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1534,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1535,                    /* -fmoduleinfo */
  OPT_fmodules = 1536,                       /* -fmodules */
  /* OPT_fmodules_ts = 1537, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1538,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1539,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1540,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1541,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1542,                 /* -fms-extensions */
  OPT_fmudflap = 1543,                       /* -fmudflap */
  OPT_fmudflapir = 1544,                     /* -fmudflapir */
  OPT_fmudflapth = 1545,                     /* -fmudflapth */
  OPT_fmultiflags = 1546,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1547,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1548,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1549,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1550,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1551,                  /* -fnext-runtime */
  OPT_fnil = 1552,                           /* -fnil */
  OPT_fnil_receivers = 1553,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1554,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1555,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1556,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1557,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1558,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1559,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1560,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1561,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1562,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1563,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1564,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1565,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1566,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1567,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1568,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1569,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1570,              /* -foffload-options= */
  OPT_foffload_ = 1571,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1572,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1573,                         /* -fonly= */
  OPT_fopenacc = 1574,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1575,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1576,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1577,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1578,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1579, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1580,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1581,                /* -foperator-names */
  OPT_fopt_info = 1582,                      /* -fopt-info */
  OPT_fopt_info_ = 1583,                     /* -fopt-info- */
  OPT_foptimize_crc = 1584,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1585, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1586,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1587,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1588, */          /* -foptional-diags */
  OPT_fpack_derived = 1589,                  /* -fpack-derived */
  OPT_fpack_struct = 1590,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1591,                  /* -fpack-struct= */
  OPT_fpad_source = 1592,                    /* -fpad-source */
  OPT_fpartial_inlining = 1593,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1594,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1595,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1596,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1597,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1598,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1599,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1600,                    /* -fpeel-loops */
  OPT_fpeephole = 1601,                      /* -fpeephole */
  OPT_fpeephole2 = 1602,                     /* -fpeephole2 */
  OPT_fpermissive = 1603,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1604,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1605,                           /* -fpic */
  OPT_fpie = 1606,                           /* -fpie */
  OPT_fpim = 1607,                           /* -fpim */
  OPT_fpim2 = 1608,                          /* -fpim2 */
  OPT_fpim3 = 1609,                          /* -fpim3 */
  OPT_fpim4 = 1610,                          /* -fpim4 */
  OPT_fplan9_extensions = 1611,              /* -fplan9-extensions */
  OPT_fplt = 1612,                           /* -fplt */
  OPT_fplugin_arg_ = 1613,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1614,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1615,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1616,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1617,                /* -fpostconditions */
  OPT_fpre_include_ = 1618,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1619,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1620,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1621,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1622,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1623,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1624,              /* -fpretty-templates */
  OPT_fpreview_all = 1625,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1626,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1627,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1628,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1629,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1630,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1631,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1632,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1633,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1634,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1635,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1636,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1637,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1638,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1639,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1640,           /* -fprintf-return-value */
  OPT_fprofile = 1641,                       /* -fprofile */
  OPT_fprofile_abs_path = 1642,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1643,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1644,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1645,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1646,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1647,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1648,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1649,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1650,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1651,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1652,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1653,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1654,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1655,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1656,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1657,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1658,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1659,               /* -fprofile-update= */
  OPT_fprofile_use = 1660,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1661,                  /* -fprofile-use= */
  OPT_fprofile_values = 1662,                /* -fprofile-values */
  OPT_fprotect_parens = 1663,                /* -fprotect-parens */
  OPT_fpthread = 1664,                       /* -fpthread */
  OPT_fq = 1665,                             /* -fq */
  OPT_frandom_seed = 1666,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1667,                  /* -frandom-seed= */
  OPT_frange = 1668,                         /* -frange */
  OPT_frange_check = 1669,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1670,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1671,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1672,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1673,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1674,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1675,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1676,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1677,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1678,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1679,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1680,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1681,               /* -frecord-marker=8 */
  OPT_frecursive = 1682,                     /* -frecursive */
  OPT_free = 1683,                           /* -free */
  /* OPT_freg_struct_return = 1684, */       /* -freg-struct-return */
  /* OPT_fregmove = 1685, */                 /* -fregmove */
  OPT_frelease = 1686,                       /* -frelease */
  OPT_frename_registers = 1687,              /* -frename-registers */
  OPT_freorder_blocks = 1688,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1689,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1690,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1691,             /* -freorder-functions */
  OPT_frepack_arrays = 1692,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1693,          /* -freplace-objc-classes */
  OPT_frepo = 1694,                          /* -frepo */
  OPT_freport_bug = 1695,                    /* -freport-bug */
  OPT_frequire_return_statement = 1696,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1697,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1698, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1699,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1700,                   /* -fresolution= */
  OPT_freturn = 1701,                        /* -freturn */
  OPT_frevert_all = 1702,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1703,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1704,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1705,             /* -frevert=intpromote */
  OPT_frounding_math = 1706,                 /* -frounding-math */
  OPT_frtti = 1707,                          /* -frtti */
  OPT_fruntime_modules_ = 1708,              /* -fruntime-modules= */
  OPT_frust_borrowcheck = 1709,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1710,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1711,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1712,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1713,                   /* -frust-crate= */
  OPT_frust_debug = 1714,                    /* -frust-debug */
  OPT_frust_dump_ = 1715,                    /* -frust-dump- */
  OPT_frust_edition_ = 1716,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1717,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1718,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1719,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1720,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1721,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1722,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1723,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1724,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1725,                   /* -frust-panic= */
  OPT_fsanitize_address_use_after_scope = 1726,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1727,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1728,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1729,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1730,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1731,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1732,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1733, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1734,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1735,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1736,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1737,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1738,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1739,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1740,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1741,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1742, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1743,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1744,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1745,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1746,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1747,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1748,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1749,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1750,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1751,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1752,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1753,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1754,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1755,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1756,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1757,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1758,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1759, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1760,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1761,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1762,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1763,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1764,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1765,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1766,               /* -fsection-anchors */
  /* OPT_fsee = 1767, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1768,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1769,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1770,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1771,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1772,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1773,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1774,        /* -fsemantic-interposition */
  OPT_fshared = 1775,                        /* -fshared */
  OPT_fshort_enums = 1776,                   /* -fshort-enums */
  OPT_fshort_wchar = 1777,                   /* -fshort-wchar */
  OPT_fshow_column = 1778,                   /* -fshow-column */
  OPT_fshrink_wrap = 1779,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1780,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1781,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1782,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1783,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1784,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1785,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1786,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1787,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1788,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1789,                /* -fsoft-check-all */
  OPT_fsources = 1790,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1791,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1792,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1793,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1794,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1795,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1796,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1797,                      /* -fsquangle */
  OPT_fssa_backprop = 1798,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1799,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1800,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1801,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1802, */             /* -fstack-check */
  OPT_fstack_check_ = 1803,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1804,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1805,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1806,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1807,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1808,               /* -fstack-protector */
  OPT_fstack_protector_all = 1809,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1810,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1811,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1812,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1813,                   /* -fstack-usage */
  OPT_fstatic_call = 1814,                   /* -fstatic-call */
  OPT_fstats = 1815,                         /* -fstats */
  OPT_fstdarg_opt = 1816,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1817,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1818, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1819,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1820,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1821, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1822,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1823,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1824,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1825,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1826, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1827,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1828,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1829,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1830,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1831,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1832,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1833,                  /* -fstrub=strict */
  OPT_fswig = 1834,                          /* -fswig */
  OPT_fswitch_errors = 1835,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1836,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1837,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1838,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1839, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1840,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1841, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1842,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1843, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1844,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1845,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1846,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1847,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1848,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1849,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1850,                   /* -ftime-report */
  OPT_ftime_report_details = 1851,           /* -ftime-report-details */
  OPT_ftls_model_ = 1852,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1853,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1854,                   /* -ftrace-debug */
  OPT_ftracer = 1855,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1856,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1857,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1858,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1859,                   /* -ftrampolines */
  OPT_ftransition_all = 1860,                /* -ftransition=all */
  OPT_ftransition_field = 1861,              /* -ftransition=field */
  OPT_ftransition_in = 1862,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1863,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1864,          /* -ftransition=templates */
  OPT_ftransition_tls = 1865,                /* -ftransition=tls */
  OPT_ftrapping_math = 1866,                 /* -ftrapping-math */
  OPT_ftrapv = 1867,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1868,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1869,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1870,                      /* -ftree-ccp */
  OPT_ftree_ch = 1871,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1872, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1873,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1874,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1875, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1876,                   /* -ftree-cselim */
  OPT_ftree_dce = 1877,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1878,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1879,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1880,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1881,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1882, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1883,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1884,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1885, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1886,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1887,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1888, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1889,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1890,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1891,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1892,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1893,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1894,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1895,                      /* -ftree-pre */
  OPT_ftree_pta = 1896,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1897,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1898, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1899,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1900,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1901,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1902,                     /* -ftree-slsr */
  OPT_ftree_sra = 1903,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1904, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1905, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1906,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1907,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1908,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1909, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1910,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1911, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1912,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1913,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1914,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1915,         /* -funconstrained-commons */
  OPT_funderscoring = 1916,                  /* -funderscoring */
  OPT_funit_at_a_time = 1917,                /* -funit-at-a-time */
  OPT_funittest = 1918,                      /* -funittest */
  OPT_funreachable_traps = 1919,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1920,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1921,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1922,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1923, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1924,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1925,                      /* -funsigned */
  OPT_funsigned_bitfields = 1926,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1927,                 /* -funsigned-char */
  OPT_funswitch_loops = 1928,                /* -funswitch-loops */
  OPT_funwind_tables = 1929,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1930,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1931,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1932,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1933,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1934,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1935,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1936,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1937,                     /* -fuse-list= */
  OPT_fvar_tracking = 1938,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1939,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1940,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1941,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1942,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1943, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1944,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1945,                   /* -fverbose-asm */
  /* OPT_fversion = 1946, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1947,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1948,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1949,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1950,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1951,                   /* -fvisibility= */
  OPT_fvpt = 1952,                           /* -fvpt */
  OPT_fvtable_gc = 1953,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1954,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1955,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1956,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1957,                     /* -fvtv-debug */
  OPT_fweak = 1958,                          /* -fweak */
  OPT_fweak_templates = 1959,                /* -fweak-templates */
  OPT_fweb = 1960,                           /* -fweb */
  /* OPT_fwhole_file = 1961, */              /* -fwhole-file */
  OPT_fwhole_program = 1962,                 /* -fwhole-program */
  OPT_fwholediv = 1963,                      /* -fwholediv */
  OPT_fwholevalue = 1964,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1965,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1966,             /* -fworking-directory */
  OPT_fwpa = 1967,                           /* -fwpa */
  OPT_fwpa_ = 1968,                          /* -fwpa= */
  OPT_fwrapv = 1969,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1970,                 /* -fwrapv-pointer */
  OPT_fxref = 1971,                          /* -fxref */
  OPT_fyacc_debug = 1972,                    /* -fyacc-debug */
  /* OPT_fzee = 1973, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1974,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 1975,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 1976,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1977,                     /* -fzero-link */
  OPT_g = 1978,                              /* -g */
  OPT_gant = 1979,                           /* -gant */
  OPT_gas_loc_support = 1980,                /* -gas-loc-support */
  OPT_gas_locview_support = 1981,            /* -gas-locview-support */
  OPT_gbtf = 1982,                           /* -gbtf */
  OPT_gcodeview = 1983,                      /* -gcodeview */
  OPT_gcoff = 1984,                          /* -gcoff */
  OPT_gcoff1 = 1985,                         /* -gcoff1 */
  OPT_gcoff2 = 1986,                         /* -gcoff2 */
  OPT_gcoff3 = 1987,                         /* -gcoff3 */
  OPT_gcolumn_info = 1988,                   /* -gcolumn-info */
  OPT_gctf = 1989,                           /* -gctf */
  OPT_gdescribe_dies = 1990,                 /* -gdescribe-dies */
  OPT_gdwarf = 1991,                         /* -gdwarf */
  OPT_gdwarf_ = 1992,                        /* -gdwarf- */
  OPT_gdwarf32 = 1993,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1994,                       /* -gdwarf64 */
  OPT_gen_decls = 1995,                      /* -gen-decls */
  OPT_ggdb = 1996,                           /* -ggdb */
  OPT_ggnu_pubnames = 1997,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1998,                   /* -gimple-stats */
  OPT_ginline_points = 1999,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 2000, /* -ginternal-reset-location-views */
  OPT_gnat = 2001,                           /* -gnat */
  OPT_gnatO = 2002,                          /* -gnatO */
  OPT_gno_ = 2003,                           /* -gno- */
  OPT_gno_pubnames = 2004,                   /* -gno-pubnames */
  OPT_gprune_btf = 2005,                     /* -gprune-btf */
  OPT_gpubnames = 2006,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2007,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2008,                   /* -gsplit-dwarf */
  OPT_gstabs = 2009,                         /* -gstabs */
  OPT_gstabs_ = 2010,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2011,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2012,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2013,                        /* -gtoggle */
  OPT_gvariable_location_views = 2014,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2015,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2016,                           /* -gvms */
  OPT_gxcoff = 2017,                         /* -gxcoff */
  OPT_gxcoff_ = 2018,                        /* -gxcoff+ */
  OPT_gz = 2019,                             /* -gz */
  OPT_gz_ = 2020,                            /* -gz= */
  OPT_h = 2021,                              /* -h */
  OPT_help = 2022,                           /* -help */
  OPT_idirafter = 2023,                      /* -idirafter */
  OPT_imacros = 2024,                        /* -imacros */
  OPT_imultiarch = 2025,                     /* -imultiarch */
  OPT_imultilib = 2026,                      /* -imultilib */
  OPT_include = 2027,                        /* -include */
  OPT_iplugindir_ = 2028,                    /* -iplugindir= */
  OPT_iprefix = 2029,                        /* -iprefix */
  OPT_iquote = 2030,                         /* -iquote */
  OPT_isysroot = 2031,                       /* -isysroot */
  OPT_isystem = 2032,                        /* -isystem */
  OPT_iwithprefix = 2033,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2034,              /* -iwithprefixbefore */
  OPT_k8 = 2035,                             /* -k8 */
  OPT_l = 2036,                              /* -l */
  OPT_lang_asm = 2037,                       /* -lang-asm */
  OPT_list = 2038,                           /* -list */
  OPT_m64 = 2039,                            /* -m64 */
  OPT_main = 2040,                           /* -main */
  OPT_main_ = 2041,                          /* -main= */
  OPT_malias = 2042,                         /* -malias */
  /* OPT_march_map_sm_30 = 2043, */          /* -march-map=sm_30 */
  /* OPT_march_map_sm_32 = 2044, */          /* -march-map=sm_32 */
  /* OPT_march_map_sm_35 = 2045, */          /* -march-map=sm_35 */
  /* OPT_march_map_sm_37 = 2046, */          /* -march-map=sm_37 */
  /* OPT_march_map_sm_50 = 2047, */          /* -march-map=sm_50 */
  /* OPT_march_map_sm_52 = 2048, */          /* -march-map=sm_52 */
  /* OPT_march_map_sm_53 = 2049, */          /* -march-map=sm_53 */
  /* OPT_march_map_sm_60 = 2050, */          /* -march-map=sm_60 */
  /* OPT_march_map_sm_61 = 2051, */          /* -march-map=sm_61 */
  /* OPT_march_map_sm_62 = 2052, */          /* -march-map=sm_62 */
  /* OPT_march_map_sm_70 = 2053, */          /* -march-map=sm_70 */
  /* OPT_march_map_sm_72 = 2054, */          /* -march-map=sm_72 */
  /* OPT_march_map_sm_75 = 2055, */          /* -march-map=sm_75 */
  /* OPT_march_map_sm_80 = 2056, */          /* -march-map=sm_80 */
  /* OPT_march_map_sm_86 = 2057, */          /* -march-map=sm_86 */
  /* OPT_march_map_sm_87 = 2058, */          /* -march-map=sm_87 */
  /* OPT_march_map_sm_89 = 2059, */          /* -march-map=sm_89 */
  /* OPT_march_map_sm_90 = 2060, */          /* -march-map=sm_90 */
  /* OPT_march_map_sm_90a = 2061, */         /* -march-map=sm_90a */
  /* OPT_march_ = 2062, */                   /* -march= */
  OPT_mexperimental = 2063,                  /* -mexperimental */
  OPT_mfake_exceptions = 2064,               /* -mfake-exceptions */
  OPT_mfake_ptx_alloca = 2065,               /* -mfake-ptx-alloca */
  OPT_mgomp = 2066,                          /* -mgomp */
  OPT_minit_regs_ = 2067,                    /* -minit-regs= */
  OPT_misa_ = 2068,                          /* -misa= */
  OPT_mmainkernel = 2069,                    /* -mmainkernel */
  OPT_moptimize = 2070,                      /* -moptimize */
  OPT_mptx_comment = 2071,                   /* -mptx-comment */
  OPT_mptx_ = 2072,                          /* -mptx= */
  OPT_msoft_stack = 2073,                    /* -msoft-stack */
  OPT_msoft_stack_reserve_local_ = 2074,     /* -msoft-stack-reserve-local= */
  OPT_muniform_simt = 2075,                  /* -muniform-simt */
  OPT_n = 2076,                              /* -n */
  OPT_name_sort = 2077,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2078,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2079,              /* -no-integrated-cpp */
  OPT_no_pie = 2080,                         /* -no-pie */
  OPT_nocpp = 2081,                          /* -nocpp */
  OPT_nodefaultlibs = 2082,                  /* -nodefaultlibs */
  OPT_nolibc = 2083,                         /* -nolibc */
  OPT_nomain = 2084,                         /* -nomain */
  OPT_nophoboslib = 2085,                    /* -nophoboslib */
  OPT_nostartfiles = 2086,                   /* -nostartfiles */
  OPT_nostdinc = 2087,                       /* -nostdinc */
  OPT_nostdinc__ = 2088,                     /* -nostdinc++ */
  OPT_nostdlib = 2089,                       /* -nostdlib */
  OPT_nostdlib__ = 2090,                     /* -nostdlib++ */
  OPT_o = 2091,                              /* -o */
  OPT_objects = 2092,                        /* -objects */
  OPT_p = 2093,                              /* -p */
  OPT_pass_exit_codes = 2094,                /* -pass-exit-codes */
  /* OPT_pedantic = 2095, */                 /* -pedantic */
  OPT_pedantic_errors = 2096,                /* -pedantic-errors */
  OPT_pg = 2097,                             /* -pg */
  OPT_pie = 2098,                            /* -pie */
  OPT_pipe = 2099,                           /* -pipe */
  OPT_preprocess = 2100,                     /* -preprocess */
  OPT_print_file_name_ = 2101,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2102,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2103,          /* -print-multi-directory */
  OPT_print_multi_lib = 2104,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2105,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2106,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2107,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2108,               /* -print-prog-name= */
  OPT_print_search_dirs = 2109,              /* -print-search-dirs */
  OPT_print_sysroot = 2110,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2111,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2112,                    /* -print-value */
  OPT_quiet = 2113,                          /* -quiet */
  OPT_r = 2114,                              /* -r */
  OPT_remap = 2115,                          /* -remap */
  OPT_reverse_sort = 2116,                   /* -reverse-sort */
  OPT_s = 2117,                              /* -s */
  OPT_save_temps = 2118,                     /* -save-temps */
  OPT_save_temps_ = 2119,                    /* -save-temps= */
  OPT_shared = 2120,                         /* -shared */
  OPT_shared_libgcc = 2121,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2122,               /* -shared-libphobos */
  OPT_size_sort = 2123,                      /* -size-sort */
  /* OPT_specs = 2124, */                    /* -specs */
  OPT_specs_ = 2125,                         /* -specs= */
  OPT_static = 2126,                         /* -static */
  OPT_static_libasan = 2127,                 /* -static-libasan */
  OPT_static_libgcc = 2128,                  /* -static-libgcc */
  OPT_static_libgcobol = 2129,               /* -static-libgcobol */
  OPT_static_libgfortran = 2130,             /* -static-libgfortran */
  OPT_static_libgm2 = 2131,                  /* -static-libgm2 */
  OPT_static_libgo = 2132,                   /* -static-libgo */
  OPT_static_libhwasan = 2133,               /* -static-libhwasan */
  OPT_static_liblsan = 2134,                 /* -static-liblsan */
  OPT_static_libmpx = 2135,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2136,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2137,               /* -static-libphobos */
  OPT_static_libquadmath = 2138,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2139,               /* -static-libstdc++ */
  OPT_static_libtsan = 2140,                 /* -static-libtsan */
  OPT_static_libubsan = 2141,                /* -static-libubsan */
  OPT_static_pie = 2142,                     /* -static-pie */
  /* OPT_std_c__03 = 2143, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2144, */                /* -std=c++0x */
  OPT_std_c__11 = 2145,                      /* -std=c++11 */
  OPT_std_c__14 = 2146,                      /* -std=c++14 */
  OPT_std_c__17 = 2147,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2148, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2149, */                /* -std=c++1z */
  OPT_std_c__20 = 2150,                      /* -std=c++20 */
  OPT_std_c__23 = 2151,                      /* -std=c++23 */
  OPT_std_c__26 = 2152,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2153, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2154, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2155, */                /* -std=c++2c */
  OPT_std_c__98 = 2156,                      /* -std=c++98 */
  OPT_std_c11 = 2157,                        /* -std=c11 */
  OPT_std_c17 = 2158,                        /* -std=c17 */
  /* OPT_std_c18 = 2159, */                  /* -std=c18 */
  /* OPT_std_c1x = 2160, */                  /* -std=c1x */
  OPT_std_c23 = 2161,                        /* -std=c23 */
  /* OPT_std_c2x = 2162, */                  /* -std=c2x */
  OPT_std_c2y = 2163,                        /* -std=c2y */
  /* OPT_std_c89 = 2164, */                  /* -std=c89 */
  OPT_std_c90 = 2165,                        /* -std=c90 */
  OPT_std_c99 = 2166,                        /* -std=c99 */
  /* OPT_std_c9x = 2167, */                  /* -std=c9x */
  OPT_std_f2003 = 2168,                      /* -std=f2003 */
  OPT_std_f2008 = 2169,                      /* -std=f2008 */
  OPT_std_f2008ts = 2170,                    /* -std=f2008ts */
  OPT_std_f2018 = 2171,                      /* -std=f2018 */
  OPT_std_f2023 = 2172,                      /* -std=f2023 */
  OPT_std_f202y = 2173,                      /* -std=f202y */
  OPT_std_f95 = 2174,                        /* -std=f95 */
  OPT_std_gnu = 2175,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2176, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2177, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2178,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2179,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2180,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2181, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2182, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2183,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2184,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2185,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2186, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2187, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2188, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2189,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2190,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2191,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2192, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2193, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2194,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2195, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2196,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2197, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2198,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2199,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2200, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2201, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2202,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2203, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2204, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2205, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2206, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2207, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2208, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2209,                     /* -std=legacy */
  OPT_stdlib_ = 2210,                        /* -stdlib= */
  OPT_symbol_ = 2211,                        /* -symbol= */
  OPT_symbolic = 2212,                       /* -symbolic */
  OPT_t = 2213,                              /* -t */
  OPT_time = 2214,                           /* -time */
  OPT_time_ = 2215,                          /* -time= */
  OPT_traditional = 2216,                    /* -traditional */
  OPT_traditional_cpp = 2217,                /* -traditional-cpp */
  OPT_tree_stats = 2218,                     /* -tree-stats */
  OPT_trigraphs = 2219,                      /* -trigraphs */
  OPT_truncate = 2220,                       /* -truncate */
  OPT_type_stats = 2221,                     /* -type-stats */
  OPT_u = 2222,                              /* -u */
  OPT_undef = 2223,                          /* -undef */
  OPT_v = 2224,                              /* -v */
  OPT_version = 2225,                        /* -version */
  OPT_w = 2226,                              /* -w */
  OPT_wrapper = 2227,                        /* -wrapper */
  OPT_x = 2228,                              /* -x */
  OPT_z = 2229,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
