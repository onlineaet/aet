...
static rtx skip_consecutive_labels (rtx label_or_return)
{
   ...
   for (insn = label; insn != 0 && !INSN_P (insn) && !BARRIER_P (insn); insn = NEXT_INSN (insn))
      if (LABEL_P (insn))
         label = insn;
...
#define unfilled_slots_base   \
  ((rtx_insn **) obstack_base (&self->unfilled_slots_obstack))

#define unfilled_slots_next   \
  ((rtx_insn **) obstack_next_free (&self->unfilled_slots_obstack))
...
static bool        resource_conflicts_p (ReorgResources/*!struct resources*/ *res1, ReorgResources/*!struct resources*/ *res2);
static bool        insn_references_resource_p (MtcsReorg *self,rtx insn,
                        ReorgResources/*!struct resources*/ *res,bool include_delayed_effects);
static bool        insn_sets_resource_p (MtcsReorg *self,rtx, struct resources *, bool);
static rtx_code_label *find_end_label (MtcsReorg *self,rtx);
static rtx_insn *  emit_delay_sequence (MtcsReorg *self,rtx_insn *, const vec<rtx_insn *> &,int);
static void        add_to_delay_list (MtcsReorg *self,rtx_insn *, vec<rtx_insn *> *);
static rtx_insn   *delete_from_delay_slot (MtcsReorg *self,rtx_insn *);
static void        delete_scheduled_jump (MtcsReorg *self,rtx_insn *);
static void        note_delay_statistics (MtcsReorg *self,int, int);
static int         get_jump_flags (MtcsReorg *self,const rtx_insn *, rtx);
static int         mostly_true_jump (rtx);
static rtx         get_branch_condition (MtcsReorg *self,const rtx_insn *, rtx);
static bool        condition_dominates_p (rtx, const rtx_insn *);
static bool        redirect_with_delay_slots_safe_p (MtcsReorg *self,rtx_insn *, rtx, rtx);
static bool        redirect_with_delay_list_safe_p (MtcsReorg *self,rtx_insn *, rtx,
                                                      const vec<rtx_insn *> &);
static bool        check_annul_list_true_false (bool, const vec<rtx_insn *> &);
static void        steal_delay_list_from_target (MtcsReorg *self,rtx_insn *, rtx, rtx_sequence *,
                                                  vec<rtx_insn *> *,
                                                  ReorgResources  *,
                                                  ReorgResources  *,
                                                  ReorgResources  *,
                                                  int, int *, bool *,
                                                  rtx *);
static void        steal_delay_list_from_fallthrough (MtcsReorg *self,rtx_insn *, rtx, rtx_sequence *,
                                                 vec<rtx_insn *> *,
                                                 ReorgResources  *,
                                                 ReorgResources  *,
                                                 ReorgResources  *,
                                                 int, int *, bool *);
static void        try_merge_delay_insns (MtcsReorg *self,rtx_insn *, rtx_insn *);
static rtx_insn   *redundant_insn (MtcsReorg *self,rtx, rtx_insn *, const vec<rtx_insn *> &);
static bool        own_thread_p (rtx, rtx, bool);
static void        update_block (MtcsReorg *self,rtx_insn *, rtx_insn *);
static bool        reorg_redirect_jump (MtcsReorg *self,rtx_jump_insn *, rtx);
static void        update_reg_dead_notes (MtcsReorg *self,rtx_insn *, rtx_insn *);
static void        fix_reg_dead_note (MtcsReorg *self,rtx_insn *, rtx);
static void        update_reg_unused_notes (MtcsReorg *self,rtx_insn *, rtx);
static void        fill_simple_delay_slots (MtcsReorg *self,bool);
static void        fill_slots_from_thread (MtcsReorg *self,rtx_jump_insn *, rtx, rtx, rtx,
                     bool, bool, bool, int, int *, vec<rtx_insn *> *);
static void        fill_eager_delay_slots (MtcsReorg *self);
static void        relax_delay_slots (MtcsReorg *self,rtx_insn *);
static void        make_return_insns (MtcsReorg *self,rtx_insn *);
...
{
  return (JUMP_P (insn)  && (simplejump_p (as_a <rtx_insn *> (insn)) || ANY_RETURN_P (PATTERN (insn))));
}
...
static bool stop_search_p (rtx_insn *insn, bool labels_p)
{
   if (insn == 0)
      return true;
...
static bool resource_conflicts_p (ReorgResources/*!struct resources*/ *res1, ReorgResources/*!struct resources*/ *res2)
{
  ...
  return mtcs_reg_hard_reg_set_intersect_p/*!hard_reg_set_intersect_p*/(&res1->regs, &res2->regs);
}
...
static bool insn_references_resource_p (MtcsReorg *self,rtx insn,
      ReorgResources/*!struct resources*/ *res,bool include_delayed_effects)
{
   MtcsResource *mtcsResource=self->mtcsResource;
   ReorgResources/*!struct resources*/ insn_res;

   mtcs_resources_clean/*!CLEAR_RESOURCE*/(&insn_res);
   mtcs_resource_mark_referenced_resources/*!mark_referenced_resources*/(mtcsResource,insn, &insn_res, include_delayed_effects);
...
static bool insn_sets_resource_p (MtcsReorg *self,rtx insn, ReorgResources *res, bool include_delayed_effects)
{
   MtcsResource *mtcsResource=self->mtcsResource;

   ReorgResources insn_sets;

   mtcs_resources_clean/*!CLEAR_RESOURCE*/(&insn_sets);
   mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,insn, &insn_sets,
         0,(include_delayed_effects ? MARK_SRC_DEST_CALL: MARK_SRC_DEST));
...
static rtx_code_label *find_end_label (MtcsReorg *self,rtx kind)
{
   ...
   if (kind == ret_rtx)
      plabel = &self->function_return_label;
   else {
      gcc_assert (kind == simple_return_rtx);
      plabel = &self->function_simple_return_label;
   }
   ...
   while (NOTE_P (insn) || (NONJUMP_INSN_P (insn)
   ...
   if (BARRIER_P (insn) && JUMP_P (PREV_INSN (insn))  && PATTERN (PREV_INSN (insn)) == kind){
      rtx_insn *temp = PREV_INSN (PREV_INSN (insn));
      rtx_code_label *label =mtcs_rtl_gen_label_rtx/*!gen_label_rtx*/(mtcsRTL);
      LABEL_NUSES (label) = 0;
      ...
      mtcs_emit_emit_label_after/*!emit_label_after*/(mtcsEmit,label, temp);
      *plabel = label;
      ...
      *plabel = as_a <rtx_code_label *> (insn);
      ...
      if (insn){
         ...
         mtcs_emit_emit_label_after/*!emit_label_after*/(mtcsEmit,label, insn);
      }else{
         if (target_rtx_have_epilogue/*!targetm.have_epilogue*/(mtcsMachine->tmrtx)
               && ! target_rtx_have_return/*!targetm.have_return*/(mtcsMachine->tmrtx))
         ...
         if (target_rtx_have_return/*!targetm.have_return*/(mtcsMachine->tmrtx)){
            /* The return we make may have delay slots too.  */
            rtx_insn *pat = target_rtx_gen_return/*!targetm.gen_return*/(mtcsMachine->tmrtx);
            rtx_insn *insn =mtcs_emit_emit_jump_insn/*!emit_jump_insn*/(mtcsEmit,pat);
            set_return_jump_label (insn);//声明 funciton.h funciton.cc
            mtcs_emit_emit_barrier/*!emit_barrier*/(mtcsEmit);
            if (mtcs_insn_attr_num_delay_slots/*!num_delay_slots*/(mtcsInsnAttr,insn) > 0)
               obstack_ptr_grow (&self->unfilled_slots_obstack, insn);
         }
      }
      *plabel = label;
   }
...
static rtx_insn *emit_delay_sequence (MtcsReorg *self,rtx_insn *insn, const vec<rtx_insn *> &list, int length)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsReg *mtcsReg=mtcs_target_get_reg(mtcsTarget);
   ...
   rtx_insn *seq_insn = mtcs_emit_make_insn_raw/*!make_insn_raw*/(mtcsEmit,seq);
   ...
   XVECEXP (seq, 0, 0) = mtcs_emit_emit_insn/*!emit_insn*/(mtcsEmit,insn);
   ...
   for (unsigned int i = 0; i < delay_insns; i++){
      ...
      XVECEXP (seq, 0, i + 1) = mtcs_emit_emit_insn/*!emit_insn*/(mtcsEmit,tem);
      ...
      for (note = REG_NOTES (tem); note; note = next){
         ...
         switch (REG_NOTE_KIND (note)){
            case REG_DEAD:
               ...
               mtcs_rtlanal_remove_note/*!remove_note*/(mtcsRtlanal,tem, note);
               break;
   ...
   mtcs_emit_add_insn_after/*!add_insn_after*/(mtcsEmit,seq_insn, after, NULL);
   return seq_insn;
}
...
static void add_to_delay_list (MtcsReorg *self,rtx_insn *insn, vec<rtx_insn *> *delay_list)
{
   MtcsResource *mtcsResource=self->mtcsResource;
   /* If INSN has its block number recorded, clear it since we may
   be moving the insn to a new block.  */
   mtcs_resource_clear_hashed_info_for_insn/*!clear_hashed_info_for_insn*/(mtcsResource,insn);
   delay_list->safe_push (insn);
}

/* Delete INSN from the delay slot of the insn that it is in, which may
   produce an insn with no delay slots.  Return the new insn.  */
static rtx_insn *delete_from_delay_slot (MtcsReorg *self,rtx_insn *insn)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   for (trial = insn; PREV_INSN (NEXT_INSN (trial)) == trial; trial = NEXT_INSN (trial))
      ;
   ...
   if (seq->len () > 2)
      for (i = 1; i < seq->len (); i++)
         if (seq->insn (i) != insn)
            add_to_delay_list(self,seq->insn (i), &delay_list);
   ...
   trial = seq->insn (0);
   mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,seq_insn);
   mtcs_emit_add_insn_after/*!add_insn_after*/(mtcsEmit,trial, prev, NULL);

   /* If there was a barrier after the old SEQUENCE, remit it.  */
   if (had_barrier)
      mtcs_emit_emit_barrier_after/*!emit_barrier_after*/(mtcsEmit,trial);

   /* If there are any delay insns, remit them.  Otherwise clear the
   annul flag.  */
   if (!delay_list.is_empty ())
      trial = emit_delay_sequence(self,trial, delay_list, XVECLEN (seq, 0) - 2);
   else if (JUMP_P (trial))
      INSN_ANNULLED_BRANCH_P (trial) = 0;

   INSN_FROM_TARGET_P (insn) = 0;
   /* Show we need to fill this insn again.  */
   obstack_ptr_grow (&self->unfilled_slots_obstack, trial);
...
static void delete_scheduled_jump (MtcsReorg *self,rtx_insn *insn)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsDojump  *mtcsDojump=mtcs_target_get_dojump(mtcsTarget);
   mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,insn);
}
...
static void note_delay_statistics (MtcsReorg *self,int slots_filled, int index)
{
   self->num_insns_needing_delays[index][self->reorg_pass_number]++;
   if (slots_filled > MTCS_MAX_DELAY_HISTOGRAM)
      slots_filled = MTCS_MAX_DELAY_HISTOGRAM;
   self->num_filled_delays[index][slots_filled][self->reorg_pass_number]++;
}
...
static void optimize_skip (MtcsReorg *self,rtx_jump_insn *insn, vec<rtx_insn *> *delay_list)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsInsnAttr *mtcsInsnAttr=mtcs_target_get_insn_attr(mtcsTarget);
   ...
   flags = get_jump_flags(self,insn, JUMP_LABEL (insn));

   if (trial == 0
   || !NONJUMP_INSN_P (trial)
   || GET_CODE (PATTERN (trial)) == SEQUENCE
   || mtcs_recog_recog_memoized/*!recog_memoized*/(mtcsRecog,trial) < 0
   || (! mtcs_insn_attr_eligible_for_annul_false/*!eligible_for_annul_false*/(mtcsInsnAttr,insn, 0, trial, flags)
   && ! mtcs_insn_attr_eligible_for_annul_true/*!eligible_for_annul_true*/(mtcsInsnAttr,insn, 0, trial, flags))
   ...
   && JUMP_LABEL (insn) == JUMP_LABEL (next_trial))){
      if (mtcs_insn_attr_eligible_for_annul_false/*!eligible_for_annul_false*/(mtcsInsnAttr,insn, 0, trial, flags)){
         if (mtcs_dojump_invert_jump/*!invert_jump*/(mtcsDojump,insn, JUMP_LABEL (insn), 1))
            INSN_FROM_TARGET_P (trial) = 1;
         else if (! mtcs_insn_attr_eligible_for_annul_true/*!eligible_for_annul_true*/(mtcsInsnAttr,insn, 0, trial, flags))
            return;
      }

      add_to_delay_list(self,trial, delay_list);
      next_trial = next_active_insn (trial);
      update_block(self,trial, trial);
      mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,trial);
      ...
      if (next_trial && simplejump_or_return_p (next_trial)){
         ...
         if (ANY_RETURN_P (target_label))
            target_label = find_end_label(self,target_label);
         ...
         if (target_label){
            ...
            flags = get_jump_flags(self,insn, target_label);
            if (mtcs_insn_attr_eligible_for_annul_true/*!eligible_for_annul_true*/(mtcsInsnAttr,insn, 0, trial, flags))
               reorg_redirect_jump(self,insn, target_label);
         }
      }
...
static int get_jump_flags (MtcsReorg *self,const rtx_insn *insn, rtx label)
{
   int flags;
   ...
   && !ANY_RETURN_P (label)
   && INSN_UID (insn) <= self->max_uid
   && INSN_UID (label) <= self->max_uid)
      flags = (self->uid_to_ruid[INSN_UID (label)] >
         self->uid_to_ruid[INSN_UID (insn)]) ? ATTR_FLAG_forward : ATTR_FLAG_backward;
...
static int mostly_true_jump (rtx jump_insn)
{
   ...
   if (note){
      int prob = profile_probability::from_reg_br_prob_note (XINT (note, 0)).to_reg_br_prob_base ();
...
static rtx get_branch_condition (MtcsReorg *self,const rtx_insn *insn, rtx target)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsDojump  *mtcsDojump=mtcs_target_get_dojump(mtcsTarget);
   ...
   || (ANY_RETURN_P (XEXP (src, 2)) && XEXP (src, 2) == target))){
      enum rtx_code rev;
      rev = mtcs_dojump_reversed_comparison_code/*!reversed_comparison_code*/(mtcsDojump,XEXP (src, 0), insn);
      if (rev != UNKNOWN)
...
static bool condition_dominates_p (MtcsReorg *self,rtx condition, const rtx_insn *insn)
{
  rtx other_condition = get_branch_condition(self,insn, JUMP_LABEL (insn));
...
static int  getDelaySlotsCondition(MtcsReorg *self,rtx_insn *jump,rtx_sequence *pat,int i,int flags)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsInsnAttr *mtcsInsnAttr=mtcs_target_get_insn_attr(mtcsTarget);

   bool cdn1=INSN_ANNULLED_BRANCH_P (jump)  && INSN_FROM_TARGET_P (pat->insn (i));
   bool cdn2=INSN_ANNULLED_BRANCH_P (jump)  && ! INSN_FROM_TARGET_P (XVECEXP (pat, 0, i));
   int annulfalse=mtcs_insn_attr_get_ANNUL_IFFALSE_SLOTS(mtcsInsnAttr)/*!ANNUL_IFFALSE_SLOTS*/;
   int annultrue=mtcs_insn_attr_get_ANNUL_IFTRUE_SLOTS(mtcsInsnAttr)/*!ANNUL_IFTRUE_SLOTS*/;
   int ret1=mtcs_insn_attr_eligible_for_annul_false/*!eligible_for_annul_false*/(mtcsInsnAttr,jump, i - 1, pat->insn (i), flags) ;
   int ret2=mtcs_insn_attr_eligible_for_annul_true/*!eligible_for_annul_true*/(mtcsInsnAttr,jump, i - 1, pat->insn (i), flags);
   int ret3=mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,jump, i - 1, pat->insn (i), flags);
   int result=0;
   if(annulfalse && annultrue){
      result=cdn1?ret1:(cdn2?ret2:ret3);
   }else if(annulfalse && !annultrue){
      result=cdn1?ret1:ret3;
   }else if(!annulfalse && annultrue){
      result=cdn2?ret2:ret3;
   }else{
      result=ret3;
   }
   return result;
...
static bool redirect_with_delay_slots_safe_p (MtcsReorg *self,rtx_insn *jump, rtx newlabel, rtx seq)
{
  int flags, i;
  ...
  flags = get_jump_flags(self,jump, newlabel);
  for (i = 1; i < pat->len (); i++)
    if (!(getDelaySlotsCondition(self,jump,pat,i,flags)))
       /*!
       if (! (
...
static int  getDelaySlotsCondition(MtcsReorg *self,rtx_insn *jump,rtx_insn  *delay,int i,int flags)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsInsnAttr *mtcsInsnAttr=mtcs_target_get_insn_attr(mtcsTarget);

   bool cdn1=INSN_ANNULLED_BRANCH_P (jump)  && INSN_FROM_TARGET_P (delay);
   bool cdn2=INSN_ANNULLED_BRANCH_P (jump)  && ! INSN_FROM_TARGET_P (delay);
   int annulfalse=mtcs_insn_attr_get_ANNUL_IFFALSE_SLOTS(mtcsInsnAttr)/*!ANNUL_IFFALSE_SLOTS*/;
   int annultrue=mtcs_insn_attr_get_ANNUL_IFTRUE_SLOTS(mtcsInsnAttr)/*!ANNUL_IFTRUE_SLOTS*/;
   int ret1=mtcs_insn_attr_eligible_for_annul_false/*!eligible_for_annul_false*/(mtcsInsnAttr,jump, i, delay, flags) ;
   int ret2=mtcs_insn_attr_eligible_for_annul_true/*!eligible_for_annul_true*/(mtcsInsnAttr,jump, i, delay, flags);
   int ret3=mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,jump, i, delay, flags);
   int result=0;
   if(annulfalse && annultrue){
      result=cdn1?ret1:(cdn2?ret2:ret3);
   }else if(annulfalse && !annultrue){
...
static bool redirect_with_delay_list_safe_p (MtcsReorg *self,rtx_insn *jump, rtx newlabel,
             const vec<rtx_insn *> &delay_list)
{
  ...
  int flags = get_jump_flags(self,jump, newlabel);
  unsigned int delay_insns = delay_list.length ();
  unsigned int i = 0;
  for (; i < delay_insns; i++)
     if (!(getDelaySlotsCondition(self,jump,delay_list[i],i,flags)))
     /*!
    if (! (
#if ANNUL_IFFALSE_SLOTS
      (INSN_ANNULLED_BRANCH_P (jump)
...
static bool check_annul_list_true_false (bool annul_true_p, const vec<rtx_insn *> &delay_list)
{
   rtx_insn *trial;
   unsigned int i;
   FOR_EACH_VEC_ELT (delay_list, i, trial)
   if ((annul_true_p && INSN_FROM_TARGET_P (trial)) || (!annul_true_p && !INSN_FROM_TARGET_P (trial)))
      return false;
...
static void steal_delay_list_from_target (MtcsReorg *self,rtx_insn *insn, rtx condition, rtx_sequence *seq,
               vec<rtx_insn *> *delay_list,
               ReorgResources *sets,
               ReorgResources *needed,
               ReorgResources *other_needed,
               ...
               bool *pannul_p, rtx *pnew_thread)
{
   ...
   mtcs_resources_clean/*!CLEAR_RESOURCE*/(&cc_set);

   rtx_insn *trial;
   FOR_EACH_VEC_ELT (*delay_list, i, trial) {
      mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,trial, &cc_set, 0, MARK_SRC_DEST_CALL);
      if (insn_references_resource_p(self,seq->insn (0), &cc_set, false))
         return;
   }

   if (XVECLEN (seq, 0) - 1 > slots_remaining
   || ! condition_dominates_p(self,condition, seq->insn (0))
   ...
   this.  */
   if (! mtcsTarget/*!targetm.can_follow_jump*/->can_follow_jump(mtcsTarget,insn, seq->insn (0)))
      return;
   ...
   for (i = 1; i < seq->len (); i++){
      ...
      if (insn_references_resource_p(self,trial, sets, false)
      || insn_sets_resource_p(self,trial, needed, false)
      || insn_sets_resource_p(self,trial, sets, false)
      ...
      redundant[i] = redundant_insn(self,trial, insn, new_delay_list);
      if (redundant[i])
         continue;

      /* We will end up re-vectoring this branch, so compute flags
      based on jumping to the new label.  */
      flags = get_jump_flags(self,insn, JUMP_LABEL (seq->insn (0)));

      if (! must_annul  && ((condition == const_true_rtx  || (! insn_sets_resource_p(self,trial, other_needed, false)
      && ! mtcs_rtlanal_may_trap_or_fault_p/*!may_trap_or_fault_p*/(mtcsRtlanal,PATTERN (trial)))))
      ? mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,insn, total_slots_filled, trial, flags)
      : (must_annul || (delay_list->is_empty () && new_delay_list.is_empty ()))
      && (must_annul = true, check_annul_list_true_false (false, *delay_list)
      && check_annul_list_true_false (false, new_delay_list)
      && mtcs_insn_attr_eligible_for_annul_false/*!eligible_for_annul_false*/(mtcsInsnAttr,
            insn, total_slots_filled,trial, flags))){
         if (must_annul){
         ...
         add_to_delay_list(self,temp, &new_delay_list);
         total_slots_filled++;
   ...
   for (i = 1; i < seq->len (); i++)
      if (redundant[i]){
         fix_reg_dead_note(self,redundant[i], insn);
         update_block(self,seq->insn (i), insn);
      }
   ...
   *pslots_filled = total_slots_filled;
   ...
   FOR_EACH_VEC_ELT (new_delay_list, i, temp)
      add_to_delay_list(self,temp, delay_list);
}
...
static void steal_delay_list_from_fallthrough (MtcsReorg *self,rtx_insn *insn, rtx condition,
               rtx_sequence *seq,
               vec<rtx_insn *> *delay_list,
               ReorgResources *sets,
               ReorgResources *needed,
               ...
               bool *pannul_p)
{
   ...
   for (i = 1; i < seq->len (); i++){
      ...
      if ((prior_insn = redundant_insn(self,trial, insn, *delay_list))){
         fix_reg_dead_note(self,prior_insn, insn);
         update_block(self,trial, insn);
         delete_from_delay_slot(self,trial);
         continue;
      }

      if (! must_annul
      && ((condition == const_true_rtx
      || (! insn_sets_resource_p(self,trial, other_needed, false)
      && ! mtcs_rtlanal_may_trap_or_fault_p/*!may_trap_or_fault_p*/(mtcsRtlanal,PATTERN (trial)))))
      ? mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,insn, *pslots_filled, trial, flags)
      : (must_annul || delay_list->is_empty ()) && (must_annul = true,
      check_annul_list_true_false (true, *delay_list)
      && mtcs_insn_attr_eligible_for_annul_true/*!eligible_for_annul_true*/(mtcsInsnAttr,
            insn, *pslots_filled, trial, flags))){
         if (must_annul)
            used_annul = true;
         delete_from_delay_slot(self,trial);
         add_to_delay_list(self,trial, delay_list);
...
static void try_merge_delay_insns (MtcsReorg *self,rtx_insn *insn, rtx_insn *thread)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsDojump  *mtcsDojump=mtcs_target_get_dojump(mtcsTarget);
   ...
   ReorgResources set, needed, modified;
   auto_vec<std::pair<rtx_insn *, bool>, 10> merged_insns;
   int flags;

   flags = get_jump_flags(self,delay_insn, JUMP_LABEL (delay_insn));

   mtcs_resources_clean/*!CLEAR_RESOURCE*/(&needed);
   mtcs_resources_clean/*!CLEAR_RESOURCE*/(&set);
   ...
   if (! annul_p)
      for (int i = 1; i < num_slots; i++)
         if (XVECEXP (PATTERN (insn), 0, i))
            mtcs_resource_mark_referenced_resources/*!mark_referenced_resources*/(mtcsResource,
                  XVECEXP (PATTERN (insn), 0, i), &needed,true);
   ...
   for (trial = thread; !stop_search_p (trial, true); trial = next_trial){
      ...
      if (NONJUMP_INSN_P (trial)  && (GET_CODE (pat) == USE || GET_CODE (pat) == CLOBBER))
         continue;

      if (GET_CODE (next_to_match) == GET_CODE (trial)
      && ! insn_references_resource_p(self,trial, &set, true)
      && ! insn_sets_resource_p(self,trial, &set, true)
      && ! insn_sets_resource_p(self,trial, &needed, true)
      && (trial = mtcs_emit_try_split/*!try_split*/(mtcsEmit,pat, trial, 0)) != 0
      ...
      && mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,delay_insn, slot_number - 1, trial, flags)){

         if (! annul_p){
            update_block(self,trial, thread);
            if (trial == thread)
      ...
      mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,trial, &set, 0, MARK_SRC_DEST_CALL);
      mtcs_resource_mark_referenced_resources/*!mark_referenced_resources*/(mtcsResource,trial, &needed, true);
   }
   ...
   && INSN_ANNULLED_BRANCH_P (XVECEXP (PATTERN (trial), 0, 0)))){
      ...
      mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,filled_insn, &set, 0, MARK_SRC_DEST_CALL);
      mtcs_resource_mark_referenced_resources/*!mark_referenced_resources*/(mtcsResource,filled_insn, &needed, true);

      for (int i = 1; i < pat->len (); i++){
         rtx_insn *dtrial = pat->insn (i);

         mtcs_resources_clean/*!CLEAR_RESOURCE*/(&modified);
         ...
         for (int j = 1; slot_number + j < num_slots; j++)
            mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,XVECEXP (PATTERN (insn), 0, slot_number + j),&modified, 0, MARK_SRC_DEST_CALL);
         /* Account for resources set by the insn before DTRIAL and inside
         TRIAL's delay list. */
         for (int j = 1; j < i; j++)
            mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,XVECEXP (pat, 0, j), &modified, 0, MARK_SRC_DEST_CALL);
         if (! insn_references_resource_p(self,dtrial, &set, true)
         && ! insn_sets_resource_p(self,dtrial, &set, true)
         && ! insn_sets_resource_p(self,dtrial, &needed, true)
         ...
         this line) */
         && ! insn_references_resource_p(self,dtrial, &modified, true)
         && mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,delay_insn, slot_number - 1, dtrial, flags)){
            if (! annul_p){
               rtx_insn *new_rtx;

               update_block(self,dtrial, thread);
               new_rtx = delete_from_delay_slot(self,dtrial);
               if (thread->deleted ())
                  thread = new_rtx;
               INSN_FROM_TARGET_P (next_to_match) = 0;
            }else
               merged_insns.safe_push (std::pair<rtx_insn *, bool> (dtrial,true));
            ...
            mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,dtrial, &set, 0, MARK_SRC_DEST_CALL);
            mtcs_resource_mark_referenced_resources/*!mark_referenced_resources*/(mtcsResource,dtrial, &needed, true);
         }
      }
   }
   ...
   if (slot_number == num_slots && annul_p){
      ...
      for (unsigned int i = len - 1; i < len; i--)
         if (merged_insns[i].second){
            update_block(self,merged_insns[i].first, thread);
            rtx_insn *new_rtx = delete_from_delay_slot(self,merged_insns[i].first);
            if (thread->deleted ())
               thread = new_rtx;
         }else{
            update_block(self,merged_insns[i].first, thread);
            mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,merged_insns[i].first);
         }
...
/* See if INSN is redundant with an insn in front of TARGET.  Often this
   ...
   gain in rare cases.  */
static rtx_insn *redundant_insn (MtcsReorg *self,rtx insn, rtx_insn *target, const vec<rtx_insn *> &delay_list)
{
   MtcsResource *mtcsResource=self->mtcsResource;
   ...
   for (trial = PREV_INSN (target),insns_to_search = param_max_delay_slot_insn_search;
         trial && insns_to_search > 0; trial = PREV_INSN (trial)){
   ...
   mtcs_resources_clean/*!CLEAR_RESOURCE*/(&needed);
   mtcs_resources_clean/*!CLEAR_RESOURCE*/(&set);
   mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,insn, &set, 0, MARK_SRC_DEST_CALL);
   mtcs_resource_mark_referenced_resources/*!mark_referenced_resources*/(mtcsResource,insn, &needed, true);
   ...
   INSN.  */
   || insn_sets_resource_p(self,target_main, &needed, true)
   || insn_sets_resource_p(self,target_main, &set, true))
      return 0;
   ...
   FOR_EACH_VEC_ELT (delay_list, j, temp)
      if (insn_sets_resource_p(self,temp, &needed, true))
         return 0;

   if (NONJUMP_INSN_P (target) && GET_CODE (PATTERN (target)) == SEQUENCE)
      for (i = 1; i < XVECLEN (PATTERN (target), 0); i++)
         if (insn_sets_resource_p(self,XVECEXP (PATTERN (target), 0, i), &needed,true))
            return 0;
   ...
   for (trial = PREV_INSN (target), insns_to_search = param_max_delay_slot_insn_search;
         trial && !LABEL_P (trial) && insns_to_search > 0; trial = PREV_INSN (trial)){
      if (!INSN_P (trial))
         continue;
      --insns_to_search;
      ...
      if (rtx_sequence *seq = dyn_cast <rtx_sequence *> (pat)){
         ...
         for (i = seq->len () - 1; i > 0; i--){
            ...
            if (rtx_equal_p (PATTERN (candidate), ipat) && ! (annul_p && INSN_FROM_TARGET_P (candidate))){
            ...
            if ((!annul_p || !INSN_FROM_TARGET_P (candidate)) && insn_sets_resource_p(self,candidate, &needed, true))
               return 0;
         }

         /* If the insn requiring the delay slot conflicts with INSN, we
         must stop.  */
         if (insn_sets_resource_p(self,control, &needed, true))
            return 0;
      }else{
         ...
         if (insn_sets_resource_p(self,trial, &needed, true))
            return 0;
      }
   }
...
static bool own_thread_p (rtx thread, rtx label, bool allow_fallthrough)
{
   ...
   for (insn = thread_insn; insn != active_insn; insn = NEXT_INSN (insn))
      if (LABEL_P (insn)  && (insn != label || LABEL_NUSES (insn) != 1))
         return false;
   ...
   for (insn = prev_nonnote_insn (thread_insn);  insn == 0 || !BARRIER_P (insn); insn = prev_nonnote_insn (insn))
      if (insn == 0 || LABEL_P (insn) || (NONJUMP_INSN_P (insn)
      && GET_CODE (PATTERN (insn)) != USE  && GET_CODE (PATTERN (insn)) != CLOBBER))
         return false;
...
static void update_block (MtcsReorg *self,rtx_insn *insn, rtx_insn *where)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   mtcs_emit_emit_insn_before/*!emit_insn_before*/(mtcsEmit,gen_rtx_USE (VOIDmode, insn), where);
  /* INSN might be making a value live in a block where it didn't use to
     be.  So recompute liveness information for this block.  */
   mtcs_resource_incr_ticks_for_insn/*!incr_ticks_for_insn*/(mtcsResource,insn);
}

/* Similar to REDIRECT_JUMP except that we update the BB_TICKS entry for
   the basic block containing the jump.  */
static bool reorg_redirect_jump (MtcsReorg *self,rtx_jump_insn *jump, rtx nlabel)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsDojump *mtcsDojump=mtcs_target_get_dojump(mtcsTarget);
   ...
   mtcs_resource_incr_ticks_for_insn/*!incr_ticks_for_insn*/(mtcsResource,jump);
   return mtcs_dojump_redirect_jump/*!redirect_jump*/(mtcsDojump,jump, nlabel, 1);
}
...
static void update_reg_dead_notes (MtcsReorg *self,rtx_insn *insn, rtx_insn *delayed_insn)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlanal *mtcsRtlanal=mtcs_target_get_rtlanal(mtcsTarget);
   ...
   for (p = next_nonnote_insn (insn); p != delayed_insn; p = next_nonnote_insn (p))
      for (link = REG_NOTES (p); link; link = next){
         ...
         if (mtcs_rtlanal_reg_referenced_p/*!reg_referenced_p*/(mtcsRtlanal,XEXP (link, 0), PATTERN (insn))){
            /* Move the REG_DEAD note from P to INSN.  */
            mtcs_rtlanal_remove_note/*!remove_note*/(mtcsRtlanal,p, link);
...
static void fix_reg_dead_note (MtcsReorg *self,rtx_insn *start_insn, rtx stop_insn)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlanal *mtcsRtlanal=mtcs_target_get_rtlanal(mtcsTarget);
   ...
   for (p = next_nonnote_insn (start_insn); p != stop_insn; p = next_nonnote_insn (p))
      for (link = REG_NOTES (p); link; link = next){
         next = XEXP (link, 1);
         ...
         if (mtcs_rtlanal_reg_set_p/*!reg_set_p*/(mtcsRtlanal,XEXP (link, 0), PATTERN (start_insn))){
            mtcs_rtlanal_remove_note/*!remove_note*/(mtcsRtlanal,p, link);
            return;
         }
      }
...
static void update_reg_unused_notes (MtcsReorg *self,rtx_insn *insn, rtx other_insn)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlanal *mtcsRtlanal=mtcs_target_get_rtlanal(mtcsTarget);
   ...
   for (link = REG_NOTES (insn); link; link = next){
      ...
      if (!find_regno_note (other_insn, REG_UNUSED, REGNO (XEXP (link, 0))))
         mtcs_rtlanal_remove_note/*!remove_note*/(mtcsRtlanal,insn, link);
   }
}
...
/* Return the label before INSN, or put a new label there.  If SIBLING is
   ...
   the new label.  */
static rtx_insn *get_label_before (MtcsReorg *self,rtx_insn *insn, rtx sibling)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsEmit *mtcsEmit=mtcs_target_get_emit(mtcsTarget);
   ...
   if (label == 0 || !LABEL_P (label)){
      ...
      mtcs_emit_emit_label_after/*!emit_label_after*/(mtcsEmit,label, prev);
      LABEL_NUSES (label) = 0;
      if (sibling){
         self->sibling_labels.safe_push (label);
         self->sibling_labels.safe_push (sibling);
      }
   }
   return label;
}
...
static void fill_simple_delay_slots (MtcsReorg *self,bool non_jumps_p)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsReg *mtcsReg=mtcs_target_get_reg(mtcsTarget);
   ...
   for (i = 0; i < num_unfilled_slots; i++){
      ...
      if (insn == 0 || insn->deleted () || (NONJUMP_INSN_P (insn)   && GET_CODE (PATTERN (insn)) == SEQUENCE)
      || (JUMP_P (insn) && non_jumps_p)  || (!JUMP_P (insn) && ! non_jumps_p))
         continue;
      ...
      slots_to_fill = mtcs_insn_attr_num_delay_slots/*!num_delay_slots*/(mtcsInsnAttr,insn);
      ...
      if (JUMP_P (insn))
         ...
         flags = get_jump_flags(self,insn, NULL_RTX);

      if ((trial = next_active_insn (insn))
      && JUMP_P (trial)
      && simplejump_p (trial)
      && mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,insn, slots_filled, trial, flags)
      ...
      if (slots_filled < slots_to_fill){
         ...
         bool filter_flags = (slots_to_fill == 1
         && mtcsTarget/*!targetm.flags_regnum*/->flags_regnum != INVALID_REGNUM
         && find_regno_note (insn, REG_DEAD,  mtcsTarget/*!targetm.flags_regnum*/->flags_regnum));
         ReorgResources fset;
         mtcs_resources_clean/*!CLEAR_RESOURCE*/(&needed);
         mtcs_resources_clean/*!CLEAR_RESOURCE*/(&set);
         mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,insn, &set, 0, MARK_SRC_DEST);
         if (filter_flags){
            mtcs_resources_clean/*!CLEAR_RESOURCE*/(&fset);
            mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,insn, &fset, 0, MARK_SRC_DEST);
         }
         mtcs_resource_mark_referenced_resources/*!mark_referenced_resources*/(mtcsResource,insn, &needed, false);

         for (trial = prev_nonnote_insn (insn); ! stop_search_p (trial, true); trial = next_trial){
            ...
            splitting.  */
            if (! insn_references_resource_p(self,trial, &set, true)
            && ! insn_sets_resource_p(self,trial,filter_flags ? &fset : &set,true)
            && ! insn_sets_resource_p(self,trial, &needed, true)
            && ! can_throw_internal (trial)){
               trial = mtcs_emit_try_split/*!try_split*/(mtcsEmit,pat, trial, 1);
               next_trial = prev_nonnote_insn (trial);
               if (mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,insn, slots_filled, trial, flags)){
                  ...
                  update_reg_dead_notes(self,trial, insn);
            ...
            mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,trial, &set, 0, MARK_SRC_DEST_CALL);
            if (filter_flags){
               mtcs_resource_mark_set_resources/*!mark_set_resources*/(mtcsResource,trial, &fset, 0, MARK_SRC_DEST_CALL);
               ...
               if (mtcs_reg_test_hard_reg_bit/*!TEST_HARD_REG_BIT*/(
                     &fset.regs, mtcsTarget/*!targetm.flags_regnum*/->flags_regnum)){
                  mtcs_reg_clear_hard_reg_bit/*!CLEAR_HARD_REG_BIT*/(mtcsReg,
                        &needed.regs, mtcsTarget/*!targetm.flags_regnum*/->flags_regnum);
                  mtcs_reg_clear_hard_reg_bit/*!CLEAR_HARD_REG_BIT*/(mtcsReg,
                        &fset.regs, mtcsTarget/*!targetm.flags_regnum*/->flags_regnum);
               }
            }
            mtcs_resource_mark_referenced_resources/*!mark_referenced_resources*/(mtcsResource,trial, &needed, true);
         }//end for (trial = prev_nonnote_insn (insn); ! stop_search_p (trial, true); trial = next_trial){
      }//end    if (slots_filled < slots_to_fill){

      /* If all needed slots haven't been filled, we come here.  */

      /* Try to optimize case of jumping around a single insn.  */
      if ((mtcs_insn_attr_get_ANNUL_IFTRUE_SLOTS(mtcsInsnAttr)/*!ANNUL_IFTRUE_SLOTS*/
            || mtcs_insn_attr_get_ANNUL_IFFALSE_SLOTS(mtcsInsnAttr)/*!ANNUL_IFFALSE_SLOTS*/)
      && slots_filled != slots_to_fill
      && delay_list.is_empty ()
      && JUMP_P (insn)
      && (condjump_p (insn) || condjump_in_parallel_p (insn))
      && !ANY_RETURN_P (JUMP_LABEL (insn))){
         optimize_skip(self,as_a <rtx_jump_insn *> (insn), &delay_list);
         if (!delay_list.is_empty ())
            slots_filled += 1;
      }
      ...
      && ! can_throw_internal (insn) && !JUMP_P (insn)){
         ...
         for (trial = next_nonnote_insn (insn); !stop_search_p (trial, true);trial = next_trial){
            next_trial = next_nonnote_insn (trial);
            ...
            && ! insn_sets_resource_p(self,trial, &set, true)
            && ! insn_sets_resource_p(self,trial, &needed, true)
            && ! (maybe_never && mtcs_rtlanal_may_trap_or_fault_p/*!may_trap_or_fault_p*/(mtcsRtlanal,pat))
            && (trial = mtcs_emit_try_split/*!try_split*/(mtcsEmit,pat, trial, 0))
            && mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,insn, slots_filled, trial, flags)
            && ! can_throw_internal (trial)){
               next_trial = next_nonnote_insn (trial);
               add_to_delay_list(self,trial, &delay_list);
            ...
            if (CALL_P (trial_delay))
               maybe_never = true;
         }//end    for (trial = next_nonnote_insn (insn); !stop_search_p (trial, true);trial = next_trial){
         ...
         && !JUMP_P (next_trial)
         && ! insn_references_resource_p(self,next_trial, &set, true)
         && ! insn_sets_resource_p(self,next_trial, &set, true)
         && ! insn_sets_resource_p(self,next_trial, &needed, true)
         && ! (maybe_never && mtcs_rtlanal_may_trap_or_fault_p/*!may_trap_or_fault_p*/(mtcsRtlanal,PATTERN (next_trial)))
         && (next_trial = mtcs_emit_try_split/*!try_split*/(mtcsEmit,PATTERN (next_trial), next_trial, 0))
         && mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,insn, slots_filled, next_trial, flags)
         && ! can_throw_internal (trial)){
            ...
            if (new_label != 0)
               new_label = get_label_before(self,new_label, JUMP_LABEL (trial));
            else
               new_label = find_end_label(self,simple_return_rtx);

            if (new_label){
               add_to_delay_list(self,copy_delay_slot_insn (next_trial), &delay_list);
               slots_filled++;
               reorg_redirect_jump(self,as_a <rtx_jump_insn *> (trial),new_label);
            }
         }
      }//end    if (slots_filled != slots_to_fill
      ...
      if ((jump_insn = dyn_cast <rtx_jump_insn *> (insn)) && simplejump_p (jump_insn) && slots_filled != slots_to_fill)
         fill_slots_from_thread(self,jump_insn, const_true_rtx, next_active_insn (JUMP_LABEL_AS_INSN (insn)),
               NULL, 1, 1, own_thread_p (JUMP_LABEL (insn), JUMP_LABEL (insn), false), slots_to_fill, &slots_filled, &delay_list);

      if (!delay_list.is_empty ())
         unfilled_slots_base[i] = emit_delay_sequence(self,insn, delay_list, slots_filled);

      if (slots_to_fill == slots_filled)
         unfilled_slots_base[i] = 0;

      note_delay_statistics(self,slots_filled, 0);
   }
}
...
static rtx follow_jumps (MtcsReorg *self,rtx label, rtx_insn *jump, bool *crossing)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   ...
   *crossing = false;
   ...
   for (depth = 0; (depth < 10
   && (insn = next_active_insn (value)) != 0
   && JUMP_P (insn)
   && JUMP_LABEL (insn) != NULL_RTX
   && ((any_uncondjump_p (insn) && onlyjump_p (insn)) || ANY_RETURN_P (PATTERN (insn)))
   && (next = NEXT_INSN (insn))
   && BARRIER_P (next)); depth++){
      ...
      if (NEXT_INSN (this_label)   && JUMP_TABLE_DATA_P (NEXT_INSN (this_label)))
         break;

      if (!mtcsTarget/*!targetm.can_follow_jump*/->can_follow_jump(mtcsTarget,jump, insn))
         break;
      if (!*crossing)
...
static void fill_slots_from_thread (MtcsReorg *self,rtx_jump_insn *insn, rtx condition,
         ...
         int *pslots_filled, vec<rtx_insn *> *delay_list)
{
   ...
   rtx new_thread;
   ReorgResources opposite_needed, set, needed;
   rtx_insn *trial;
   bool lose = false;
   ...
   if (condition == const_true_rtx)
      mtcs_resources_clean/*!CLEAR_RESOURCE*/(&opposite_needed);
   else
      mtcs_resource_mark_target_live_regs/*!mark_target_live_regs*/(mtcsResource,
            mtcs_rtl_data_get_insns/*!get_insns*/(mtcsRtlData), opposite_thread, &opposite_needed);
   ...
   new_thread = thread = mtcs_emit_try_split/*!try_split*/(mtcsEmit,PATTERN (thread), thread, 0);
   ...
   bool filter_flags = (slots_to_fill == 1 && mtcsTarget/*!targetm.flags_regnum*/->flags_regnum != INVALID_REGNUM
         && find_regno_note (insn, REG_DEAD, targetm.flags_regnum));
   ReorgResources fset;
   ReorgResources flags_res;
   if (filter_flags){
      mtcs_resources_clean/*!CLEAR_RESOURCE*/(&fset);
      mtcs_resources_clean/*!CLEAR_RESOURCE*/(&flags_res);
      mtcs_reg_set_hard_reg_bit/*!SET_HARD_REG_BIT*/(mtcsReg,
            &flags_res.regs, mtcsTarget/*!targetm.flags_regnum*/->flags_regnum);
   }
   ...
   for (trial = thread; ! stop_search_p (trial, ! thread_if_true)
               && (! lose || own_thread); trial = next_nonnote_insn (trial)){
      rtx pat, old_trial;
      ...
      && (! filter_flags
      || ! insn_sets_resource_p(self,trial, &flags_res, true)
      || find_regno_note (trial, REG_UNUSED, targetm.flags_regnum)
      || ! mtcs_reg_test_hard_reg_bit/*!TEST_HARD_REG_BIT*/(&set.regs, mtcsTarget/*!targetm.flags_regnum*/->flags_regnum))
      && ! can_throw_internal (trial)){
         rtx_insn *prior_insn;
         ...
         if ((prior_insn = redundant_insn(self,trial, insn, *delay_list))){
            ...
            if (own_thread){
               ...
               update_reg_unused_notes(self,prior_insn, trial);
      ...
      || (! insn_sets_resource_p(self,trial, &opposite_needed, true)
      && ! mtcs_rtlanal_may_trap_or_fault_p/*!may_trap_or_fault_p*/(mtcsRtlanal,pat)
      && ! RTX_FRAME_RELATED_P (trial)))){
         old_trial = trial;
         trial = mtcs_emit_try_split/*!try_split*/(mtcsEmit,pat, trial, 0);
         ...
         if (thread == old_trial)
            thread = trial;
         pat = PATTERN (trial);
         if (mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,insn, *pslots_filled, trial, flags))
            goto winner;
         }else if (!RTX_FRAME_RELATED_P (trial)  && ((mtcs_insn_attr_get_ANNUL_IFTRUE_SLOTS(mtcsInsnAttr)/*!ANNUL_IFTRUE_SLOTS*/
               && ! thread_if_true)
               || (mtcs_insn_attr_get_ANNUL_IFFALSE_SLOTS(mtcsInsnAttr)/*!ANNUL_IFFALSE_SLOTS*/ && thread_if_true))){
            old_trial = trial;
            trial = mtcs_emit_try_split/*!try_split*/(mtcsEmit,pat, trial, 0);
            if (new_thread == old_trial)
               new_thread = trial;
...
winner:
               ...
               if (own_thread){
                  ...
                  for (note = REG_NOTES (trial); note != NULL_RTX; note = XEXP (note, 1))
                     if (REG_NOTE_KIND (note) == REG_LABEL_OPERAND  || REG_NOTE_KIND (note) == REG_LABEL_TARGET){
               ...
               if (slots_to_fill == ++(*pslots_filled)){
                  ...
                  && ! insn_sets_resource_p(self,new_thread, &set, true)
                  && ! insn_sets_resource_p(self,new_thread, &needed,true)
                  && ! insn_references_resource_p(self,new_thread,&set, true)
                  && (prior_insn  = redundant_insn(self,new_thread, insn, *delay_list))){
                     /* We know we do not own the thread, so no need
                     to call update_block and delete_insn.  */
                     fix_reg_dead_note(self,prior_insn, insn);
                     update_reg_unused_notes(self,prior_insn, new_thread);
                     new_thread  = next_active_insn (as_a<rtx_insn *> (new_thread));
                  }
                  break;
               }
      ...
      if (filter_flags){
         ...
         mtcs_reg_clear_hard_reg_bit/*!CLEAR_HARD_REG_BIT*/(mtcsReg,&needed.regs, mtcsTarget/*!targetm.flags_regnum*/->flags_regnum);
         mtcs_reg_clear_hard_reg_bit/*!CLEAR_HARD_REG_BIT*/(mtcsReg,&fset.regs, mtcsTarget/*!targetm.flags_regnum*/->flags_regnum);
      }
      ...
      && REG_P (SET_SRC (pat))
      && REG_P (SET_DEST (pat))
      && !mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,SET_DEST (pat), SET_SRC (pat))){
         rtx_insn *next = next_nonnote_insn (trial);

         if (next && NONJUMP_INSN_P (next)
         && GET_CODE (PATTERN (next)) != USE
         && ! mtcs_rtlanal_reg_set_p/*!reg_set_p*/(mtcsRtlanal,SET_DEST (pat), next)
         && ! mtcs_rtlanal_reg_set_p/*!reg_set_p*/(mtcsRtlanal,SET_SRC (pat), next)
         && mtcs_rtlanal_reg_referenced_p/*!reg_referenced_p*/(mtcsRtlanal,SET_DEST (pat), PATTERN (next))
         && ! mtcs_rtlanal_modified_in_p/*!modified_in_p*/(mtcsRtlanal,SET_DEST (pat), next))
            mtcs_recog_validate_replace_rtx/*!validate_replace_rtx*/(mtcsRecog,SET_DEST (pat), SET_SRC (pat), next);
      }
   }//end for
   ...
   && JUMP_P (XVECEXP (PATTERN (trial), 0, 0))){
      ...
      if (thread_if_true && trial == new_thread){
         steal_delay_list_from_target(self,insn, condition, sequence,
         ...
         steal_delay_list_from_fallthrough(self,insn, condition, sequence,
               delay_list, &set, &needed,&opposite_needed, slots_to_fill,pslots_filled, &must_annul);
   }
   ...
   && asm_noperands (PATTERN (new_thread)) < 0){
      ...
      || GET_CODE (pat) != SET
      || ! mtcs_insn_attr_eligible_for_delay/*!eligible_for_delay*/(mtcsInsnAttr,insn, 0, trial, flags)
      || can_throw_internal (trial))
         return;
      ...
      && (!mtcs_mode_is_float_p/*!FLOAT_MODE_P*/(mtcsMode,GET_MODE (src))
      || mtcsOptionsItem->x_flag_unsafe_math_optimizations)
      && ! mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,dest, XEXP (src, 1))
      && ! side_effects_p (pat)){
         ...
         if (CONST_INT_P (other))
            new_arith = gen_rtx_fmt_ee (GET_CODE (src), GET_MODE (src), dest,
                  mtcs_expmed_negate_rtx/*!negate_rtx*/(mtcsExpmed,GET_MODE (src), other));
         else
            new_arith = gen_rtx_fmt_ee (GET_CODE (src) == PLUS ? MINUS : PLUS,GET_MODE (src), dest, other);

         ninsn = mtcs_emit_emit_insn_after/*!emit_insn_after*/(mtcsEmit,gen_rtx_SET (dest, new_arith), insn);

         if (mtcs_recog_recog_memoized/*!recog_memoized*/(mtcsRecog,ninsn) < 0
         || (mtcs_recog_extract_insn/*!extract_insn*/(mtcsRecog,ninsn),
         !mtcs_recog_constrain_operands/*!constrain_operands*/(mtcsRecog,1,
         mtcs_recog_get_preferred_alternatives/*!get_preferred_alternatives*/(mtcsRecog,ninsn)))){
            mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,ninsn);
            return;
         }
         ...
         ninsn = own_thread ? trial : mtcs_emit_copy_delay_slot_insn/*!copy_delay_slot_insn*/(mtcsEmit,trial);
         if (thread_if_true)
            INSN_FROM_TARGET_P (ninsn) = 1;

         add_to_delay_list(self,ninsn, delay_list);
         (*pslots_filled)++;
      }
   }
   ...
   if (new_thread != thread){
      ...
      && redirect_with_delay_list_safe_p(self,insn,JUMP_LABEL (new_thread),*delay_list))
         new_thread = follow_jumps(self,JUMP_LABEL (new_thread), insn, &crossing);

      if (!new_thread)
         label = find_end_label(self,simple_return_rtx);
      else if (ANY_RETURN_P (new_thread))
         label = find_end_label(self,new_thread);
      else if (LABEL_P (new_thread))
         label = new_thread;
      else
         label = get_label_before(self,as_a <rtx_insn *> (new_thread),JUMP_LABEL (insn));

      if (label){
         reorg_redirect_jump(self,insn, label);
         if (crossing)
...
static void fill_eager_delay_slots (MtcsReorg *self)
{
   ...
   for (i = 0; i < num_unfilled_slots; i++){
      ...
      slots_to_fill = mtcs_insn_attr_num_delay_slots/*!num_delay_slots*/(mtcsInsnAttr,jump_insn);
      /* Some machine description have defined instructions to have
      delay slots only in certain circumstances which may depend on
      nearby insns (which change due to reorg's actions).
      ...
      condition = get_branch_condition(self,jump_insn, target_label);
      ...
      if (condition == const_true_rtx){
         ...
         own_fallthrough = own_thread_p (NEXT_INSN (jump_insn),NULL_RTX, true);
      ...
      if (prediction > 0){
         fill_slots_from_thread(self,jump_insn, condition, insn_at_target,
               fallthrough_insn, prediction == 2, true, own_target, slots_to_fill, &slots_filled, &delay_list);
         ...
         if (delay_list.is_empty () && own_fallthrough){
            ...
            fill_slots_from_thread(self,jump_insn, condition, fallthrough_insn,
                  insn_at_target, false, false, own_fallthrough, slots_to_fill,&slots_filled, &delay_list);
         }
      }else{
         if (own_fallthrough)
            fill_slots_from_thread(self,jump_insn, condition, fallthrough_insn,
         ...
         if (delay_list.is_empty ())
            fill_slots_from_thread(self,jump_insn, condition, insn_at_target,
                  next_active_insn (insn), false, true,own_target, slots_to_fill, &slots_filled, &delay_list);
      }

      if (!delay_list.is_empty ())
         unfilled_slots_base[i]= emit_delay_sequence(self,jump_insn, delay_list, slots_filled);

      if (slots_to_fill == slots_filled)
         unfilled_slots_base[i] = 0;

      note_delay_statistics(self,slots_filled, 1);
   }
}

static void delete_computation (MtcsReorg *self,rtx_insn *insn);

/* Recursively delete prior insns that compute the value (used only by INSN
   which the caller is deleting) stored in the register mentioned by NOTE
   which is a REG_DEAD note associated with INSN.  */
static void delete_prior_computation (MtcsReorg *self,rtx note, rtx_insn *insn)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsInsnAttr *mtcsInsnAttr=mtcs_target_get_insn_attr(mtcsTarget);
   ...
   for (our_prev = prev_nonnote_insn (insn); our_prev && (NONJUMP_INSN_P (our_prev)
   || CALL_P (our_prev)); our_prev = prev_nonnote_insn (our_prev)){
      rtx pat = PATTERN (our_prev);

      /* If we reach a CALL which is not calling a const function
      or the callee pops the arguments, then give up.  */
      if (CALL_P (our_prev)  && (! RTL_CONST_CALL_P (our_prev)
      ...
      if (GET_CODE (pat) == USE && NONJUMP_INSN_P (XEXP (pat, 0)))
         /* reorg creates USEs that look like this.  We leave them
         alone because reorg needs them for its own purposes.  */
         break;

      if (mtcs_rtlanal_reg_set_p/*!reg_set_p*/(mtcsRtlanal,reg, pat)){
         ...
         if (GET_CODE (pat) == PARALLEL){
            ...
            for (i = 0; i < XVECLEN (pat, 0); i++){
               ...
               if (GET_CODE (part) == SET && SET_DEST (part) != reg)
                  break;
            }

            if (i == XVECLEN (pat, 0))
               delete_computation(self,our_prev);
            ...
            if (dest_regno >= regno  && dest_endregno <= endregno)
               delete_computation(self,our_prev);
            ...
            needed.  */
            else if (dest_regno <= regno && dest_endregno >= endregno){
               int i;
      ...
      if (mtcs_rtlanal_reg_overlap_mentioned_p/*!reg_overlap_mentioned_p*/(mtcsRtlanal,reg, pat)){
...
static void delete_computation (MtcsReorg *self,rtx_insn *insn)
{
   ...
   for (note = REG_NOTES (insn); note; note = next){
      ...
      delete_prior_computation(self,note, insn);
   }
   mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,insn);
}
...
static void delete_jump (MtcsReorg *self,rtx_insn *insn)
{
  rtx set = single_set (insn);
  if (set && GET_CODE (SET_DEST (set)) == PC)
    delete_computation(self,insn);
}

static rtx_insn * label_before_next_insn (rtx_insn *x, rtx scan_limit)
{
...
/* Once we have tried two ways to fill a delay slot, make a pass over the
   ...
   threading.  */
static void relax_delay_slots (MtcsReorg *self,rtx_insn *first)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsDojump  *mtcsDojump=mtcs_target_get_dojump(mtcsTarget);
   ...
   for (insn = first; insn; insn = next){
      ...
      && !ANY_RETURN_P (target_label = JUMP_LABEL (insn))){
         ...
         target_label  = skip_consecutive_labels (follow_jumps(self,target_label, jump_insn, &crossing));
         if (ANY_RETURN_P (target_label))
            target_label = find_end_label(self,target_label);
         ...
         && ! (next && switch_text_sections_between_p (jump_insn, next))){
            ...
            if (BARRIER_P (prev) && LABEL_NUSES (direct_label) == 1){
               mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,prev);
               ...
               mtcs_resource_clear_hashed_info_until_next_barrier/*!clear_hashed_info_until_next_barrier*/(mtcsResource,direct_label);
            }

            delete_jump(self,jump_insn);
            continue;
         }

         if (target_label && target_label != JUMP_LABEL (jump_insn)){
            reorg_redirect_jump(self,jump_insn, target_label);
            if (crossing)
         ...
         && target_label
         && (next_active_insn (as_a<rtx_insn *> (target_label)) == next_active_insn (next))
         && no_labels_between_p (jump_insn, next)  && targetm.can_follow_jump (jump_insn, next)){
            ...
            if (mtcs_dojump_invert_jump/*!invert_jump*/(mtcsDojump,jump_insn, label, 1)){
               rtx_insn *from = mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,next);
            ...
            if (--LABEL_NUSES (target_label) == 0)
               mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,target_label);
      ...
      && mostly_true_jump (other) < 0){
         ...
         if (mtcs_dojump_invert_jump/*!invert_jump*/(mtcsDojump,as_a <rtx_jump_insn *> (other), target_label, 0))
            reorg_redirect_jump(self,as_a <rtx_jump_insn *> (insn), other_target);
      }
      ...
      if ((prior_insn = redundant_insn(self,pat->insn (1), delay_insn, vNULL))){
         fix_reg_dead_note(self,prior_insn, insn);
         update_block(self,pat->insn (1), insn);
         delete_from_delay_slot(self,pat->insn (1));
      ...
      && PATTERN (next) == PATTERN (delay_insn)){
         ...
         mtcs_emit_add_insn_after/*!add_insn_after*/(mtcsEmit,delay_insn, prev, NULL);
         after = delay_insn;
         for (i = 1; i < pat->len (); i++)
            after = mtcs_emit_emit_copy_of_insn_after/*!emit_copy_of_insn_after*/(mtcsEmit,pat->insn (i), after);
         delete_scheduled_jump(self,delay_insn);
         continue;
      }
      ...
      if (! delay_jump_insn || !(condjump_p (delay_jump_insn) || condjump_in_parallel_p (delay_jump_insn)))
         continue;
      ...
      rtx trial = skip_consecutive_labels (follow_jumps(self,target_label,delay_jump_insn,&crossing));
      if (ANY_RETURN_P (trial))
         trial = find_end_label(self,trial);

      if (trial && trial != target_label && redirect_with_delay_slots_safe_p(self,delay_jump_insn, trial, insn)){
         reorg_redirect_jump(self,delay_jump_insn, trial);
         target_label = trial;
         if (crossing)
      ...
      && redundant_insn(self,trial, insn, vNULL)
      && ! can_throw_internal (trial)){
         /* Figure out where to emit the special USE insn so we don't
         later incorrectly compute register live/death info.  */
         rtx_insn *tmp = next_active_insn (as_a<rtx_insn *> (trial));
         if (tmp == 0)
            tmp = find_end_label(self,simple_return_rtx);

         if (tmp){
            /* Insert the special USE insn and update dataflow info.
            We know "trial" is an insn here as it is the output of
            next_real_nondebug_insn () above.  */
            update_block(self,as_a <rtx_insn *> (trial), tmp);

            /* Now emit a label before the special USE insn, and
            redirect our jump to the new label.  */
            target_label = get_label_before(self,PREV_INSN (tmp), target_label);
            reorg_redirect_jump(self,delay_jump_insn, target_label);
            next = insn;
            continue;
         }
      }
      ...
      && redundant_insn(self,trial_seq->insn (1), insn, vNULL)){
         rtx temp_label = JUMP_LABEL (trial_seq->insn (0));
         if (ANY_RETURN_P (temp_label))
            temp_label = find_end_label(self,temp_label);

         if (temp_label
         && redirect_with_delay_slots_safe_p(self,delay_jump_insn,
         temp_label, insn)){
            update_block(self,trial_seq->insn (1), insn);
            reorg_redirect_jump(self,delay_jump_insn, temp_label);
            next = insn;
            continue;
         }
      }
      ...
      && !BARRIER_P (prev_nonnote_insn (as_a<rtx_insn *> (target_label)))){
         ...
         mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,insn);
         gcc_assert (GET_CODE (pat) == SEQUENCE);
         mtcs_emit_add_insn_after/*!add_insn_after*/(mtcsEmit,delay_jump_insn, prev, NULL);
         after = delay_jump_insn;
         for (i = 1; i < pat->len (); i++)
            after = mtcs_emit_emit_copy_of_insn_after/*!emit_copy_of_insn_after*/(mtcsEmit,pat->insn (i), after);
         delete_scheduled_jump(self,delay_jump_insn);
         continue;
      }
      ...
      && no_labels_between_p (insn, next)){
         ...
         if (ANY_RETURN_P (label))
            label = find_end_label(self,label);
         ...
         label, insn)){
            ...
            if (mtcs_dojump_invert_jump/*!invert_jump*/(mtcsDojump,delay_jump_insn, label, 1)){
            ...
            if (old_label && --LABEL_NUSES (old_label) == 0)
               mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,old_label);
            continue;
         }
      }
      ...
      if (INSN_FROM_TARGET_P (pat->insn (1)) && own_thread_p (NEXT_INSN (insn), 0, true))
         try_merge_delay_insns(self,insn, next);
      else if (! INSN_FROM_TARGET_P (pat->insn (1)) && own_thread_p (target_label, target_label, false))
         try_merge_delay_insns(self,insn,next_active_insn (as_a<rtx_insn *> (target_label)));
...
/* Look for filled jumps to the end of function label.  We can try to convert
   ...
   RETURN as well.  */
static void make_return_insns (MtcsReorg *self,rtx_insn *first)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsReg *mtcsReg=mtcs_target_get_reg(mtcsTarget);
   ...
   rtx_insn *insn;
   rtx_jump_insn *jump_insn;
   rtx real_return_label = self->function_return_label;
   rtx real_simple_return_label = self->function_simple_return_label;
   int slots, i;
   ...
   for (insn = first; insn; insn = NEXT_INSN (insn))
      if (JUMP_P (insn) && ANY_RETURN_P (PATTERN (insn))){
         rtx t = get_label_before(self,insn, NULL_RTX);
   ...
   obstack_free (&self->unfilled_slots_obstack, self->unfilled_firstobj);
   ...
   for (insn = first; insn; insn = NEXT_INSN (insn)){
      ...
      if (JUMP_LABEL (pat->insn (0)) == self->function_return_label){
         kind = ret_rtx;
         real_label = real_return_label;
      }else if (JUMP_LABEL (pat->insn (0)) == self->function_simple_return_label){
      ...
      if (!reorg_redirect_jump(self,jump_insn, kind)){
         /* Make sure redirecting the jump will not invalidate the delay
         slot insns.  */
         if (redirect_with_delay_slots_safe_p(self,jump_insn, real_label, insn))
            reorg_redirect_jump(self,jump_insn, real_label);
         continue;
      }
      ...
      flags = get_jump_flags(self,jump_insn, JUMP_LABEL (jump_insn));
      slots = mtcs_insn_attr_num_delay_slots/*!num_delay_slots*/(mtcsInsnAttr,jump_insn);
      if (slots >= XVECLEN (pat, 0) - 1){
         for (i = 1; i < XVECLEN (pat, 0); i++)
            if (!(getDelaySlotsCondition(self,jump_insn,pat,i,flags)))
               break;
      /*
      if (! (
      #if ANNUL_IFFALSE_SLOTS
      ...
      && INSN_FROM_TARGET_P (pat->insn (i)))
      ? mtcs_insn_attr_eligible_for_annul_false(mtcsInsnAttr,jump_insn, i - 1,
      pat->insn (i), flags) :
      #endif
      #if ANNUL_IFTRUE_SLOTS
      (INSN_ANNULLED_BRANCH_P (jump_insn)
      && ! INSN_FROM_TARGET_P (pat->insn (i)))
      ? mtcs_insn_attr_eligible_for_annul_true(mtcsInsnAttr,jump_insn, i - 1,
      pat->insn (i), flags) :
      #endif
      mtcs_insn_attr_eligible_for_delay(mtcsInsnAttr,jump_insn, i - 1,
      pat->insn (i), flags)))
      break;
      */
      }else
      ...
      if (ANY_RETURN_P (PATTERN (jump_insn))){
         ...
         for (i = 1; i < pat->len (); i++)
            after = mtcs_emit_emit_copy_of_insn_after/*!emit_copy_of_insn_after*/(mtcsEmit,pat->insn (i), after);
         mtcs_emit_add_insn_after/*!add_insn_after*/(mtcsEmit,insn, after, NULL);
         ...
         reorg_redirect_jump(self,jump_insn, real_label);
   }//end    for (insn = first; insn; insn = NEXT_INSN (insn)){

   /* Now delete REAL_RETURN_LABEL if we never used it.  Then try to fill any
   new delay slots we have created.  */
   if (real_return_label != NULL_RTX && --LABEL_NUSES (real_return_label) == 0)
      mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,real_return_label);
   if (real_simple_return_label != NULL_RTX && --LABEL_NUSES (real_simple_return_label) == 0)
      mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,real_simple_return_label);

   fill_simple_delay_slots(self,true);
   fill_simple_delay_slots(self,false);
}

/* Try to find insns to place in delay slots.  */

static void dbr_schedule (MtcsReorg *self,rtx_insn *first)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsInsnAttr *mtcsInsnAttr=mtcs_target_get_insn_attr(mtcsTarget);
   ...
   for (self->max_uid = 0, insn = first; insn; insn = NEXT_INSN (insn)){
      if (INSN_UID (insn) > self->max_uid)
         self->max_uid = INSN_UID (insn);
      if (NOTE_P (insn)  && NOTE_KIND (insn) == NOTE_INSN_EPILOGUE_BEG)
         epilogue_insn = insn;
   }

   self->uid_to_ruid = XNEWVEC (int, self->max_uid + 1);
   for (i = 0, insn = first; insn; i++, insn = NEXT_INSN (insn))
      self->uid_to_ruid[INSN_UID (insn)] = i;

   /* Initialize the list of insns that need filling.  */
   if (self->unfilled_firstobj == 0){
      gcc_obstack_init (&self->unfilled_slots_obstack);
      self->unfilled_firstobj = XOBNEWVAR (&self->unfilled_slots_obstack, rtx, 0);
   }
   ...
   for (insn = next_active_insn (first); insn; insn = next_active_insn (insn)){
      ...
      && (condjump_p (insn) || condjump_in_parallel_p (insn))
      && !ANY_RETURN_P (JUMP_LABEL (insn))
      && ((target = skip_consecutive_labels (JUMP_LABEL (insn)))  != JUMP_LABEL (insn)))
         mtcs_dojump_redirect_jump/*!redirect_jump*/(mtcsDojump,as_a <rtx_jump_insn *> (insn), target, 1);
   }

   mtcs_resource_init_resource_info/*!init_resource_info*/(mtcsResource,epilogue_insn);

   /* Show we haven't computed an end-of-function label yet.  */
   self->function_return_label = self->function_simple_return_label = NULL;

   /* Initialize the statistics for this function.  */
   memset (self->num_insns_needing_delays, 0, sizeof self->num_insns_needing_delays);
   memset (self->num_filled_delays, 0, sizeof self->num_filled_delays);

   /* Now do the delay slot filling.  Try everything twice in case earlier
   changes make more slots fillable.  */

   for (self->reorg_pass_number = 0; self->reorg_pass_number < MTCS_MAX_REORG_PASSES;self->reorg_pass_number++){
      fill_simple_delay_slots(self,true);
      fill_simple_delay_slots(self,false);
      if (!targetm.no_speculation_in_delay_slots_p ())
         fill_eager_delay_slots(self);
      relax_delay_slots(self,first);
   }

   /* If we made an end of function label, indicate that it is now
   safe to delete it by undoing our prior adjustment to LABEL_NUSES.
   If it is now unused, delete it.  */
   if (self->function_return_label && --LABEL_NUSES (self->function_return_label) == 0)
      mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,self->function_return_label);
   if (self->function_simple_return_label
   && --LABEL_NUSES (self->function_simple_return_label) == 0)
      mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,self->function_simple_return_label);

   need_return_insns = false;
   need_return_insns |= target_rtx_have_return/*!targetm.have_return*/(mtcsMachine->tmrtx) && self->function_return_label != 0;
   need_return_insns |= (target_rtx_have_simple_return/*!targetm.have_simple_return*/(mtcsMachine->tmrtx)
         && self->function_simple_return_label != 0);
   if (need_return_insns)
      make_return_insns(self,first);
   ...
   for (insn = first; insn; insn = next){
      ...
      if (NONJUMP_INSN_P (insn) && GET_CODE (PATTERN (insn)) == USE  && INSN_P (XEXP (PATTERN (insn), 0)))
         next = mtcs_dojump_delete_related_insns/*!delete_related_insns*/(mtcsDojump,insn);
   }
   ...
   if (dump_file){
      int i, j, need_comma;
      int total_delay_slots[MTCS_MAX_DELAY_HISTOGRAM + 1];
      int total_annul_slots[MTCS_MAX_DELAY_HISTOGRAM + 1];

      for (self->reorg_pass_number = 0; self->reorg_pass_number < MTCS_MAX_REORG_PASSES; self->reorg_pass_number++){
         fprintf (dump_file, ";; Reorg pass #%d:\n", self->reorg_pass_number + 1);
         for (i = 0; i < MTCS_NUM_REORG_FUNCTIONS; i++){
            need_comma = 0;
            fprintf (dump_file, ";; Reorg function #%d\n", i);

            fprintf (dump_file, ";; %d insns needing delay slots\n;; ",self->num_insns_needing_delays[i][self->reorg_pass_number]);

            for (j = 0; j < MTCS_MAX_DELAY_HISTOGRAM + 1; j++)
               if (self->num_filled_delays[i][j][self->reorg_pass_number]){
                  if (need_comma)
                     fprintf (dump_file, ", ");
                  need_comma = 1;
                  fprintf (dump_file, "%d got %d delays",self->num_filled_delays[i][j][self->reorg_pass_number], j);
               }
            fprintf (dump_file, "\n");
         }
      }
      ...
      for (insn = first; insn; insn = NEXT_INSN (insn)){
         ...
         && GET_CODE (PATTERN (insn)) != CLOBBER){
            if (GET_CODE (PATTERN (insn)) == SEQUENCE){
               ...
               if (j > MTCS_MAX_DELAY_HISTOGRAM)
                  j = MTCS_MAX_DELAY_HISTOGRAM;
               control = XVECEXP (PATTERN (insn), 0, 0);
               if (JUMP_P (control) && INSN_ANNULLED_BRANCH_P (control))
                  total_annul_slots[j]++;
               else
                  total_delay_slots[j]++;
            }else if (mtcs_insn_attr_num_delay_slots/*!num_delay_slots*/(mtcsInsnAttr,insn) > 0)
               total_delay_slots[0]++;
         }
      }
   ...
   if (!self->sibling_labels.is_empty ()){
      update_alignments (self->sibling_labels);
      self->sibling_labels.release ();
   }

   free_resource_info ();
   free (self->uid_to_ruid);
   mtcsRtlData/*!crtl*/->dbr_scheduled_p = true;
}

/* Run delay slot optimization.  */
static void rest_of_handle_delay_slots (MtcsReorg *self)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsInsnAttr *mtcsInsnAttr=mtcs_target_get_insn_attr(mtcsTarget);
   ...
   if (mtcs_insn_attr_get_delay_slots/*!DELAY_SLOTS*/(mtcsInsnAttr))
      dbr_schedule(self,mtcs_rtl_data_get_insns/*!get_insns*/(mtcsRtlData));
}

static void mtcsReorgInit(MtcsReorg *self)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(self);
   self->mtcsResource=mtcs_resource_new(mtcsMode);
}

MtcsReorg *mtcs_reorg_new(MtcsMode *mtcsMode)
{
     MtcsReorg *self = n_slice_alloc0 (sizeof(MtcsReorg));
...
/*********************************以下是基于MtcsReorg的2个rtl pass ********************************/

//原型 NEXT_PASS (pass_machine_reorg, 1);  RTL_PASS reog.cc  mach   y  有条件执行 targetm.machine_dependent_reorg != 0; targetm.machine_dependent_reorg ();
static nboolean mach_gate_cb(MtcsPass *mtcsPass,function *fun)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(mtcsPass);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   return mtcsTarget/*!targetm.machine_dependent_reorg*/->machine_dependent_reorg != 0;
}

static nuint mach_execute_cb(MtcsPass *mtcsPass,function *func)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(mtcsPass);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   mtcsTarget/*!targetm.machine_dependent_reorg*/->machine_dependent_reorg(mtcsTarget);
   return 0;
}

static void mtcsPassMachInit(MtcsPassMach *self)
{
   MtcsPass *mtcsPass= (MtcsPass *)self;
   mtcsPass->execute =mach_execute_cb;
   mtcsPass->gate =mach_gate_cb;
...
{
   MtcsPassMach *self = n_slice_alloc0 (sizeof(MtcsPassMach));
   mtcs_component_set_mode((MtcsComponent*)self,mtcsMode);
   mtcs_pass_init((MtcsPass *)self,RTL_PASS,"mach");
   mtcsPassMachInit(self);
   return self;
}

//原型 NEXT_PASS (pass_delay_slots, 1);  RTL_PASS reorg.cc  dbr   y  有条件执行 DELAY_SLOTS   rest_of_handle_delay_slots
static nboolean delay_slots_gate_cb(MtcsPass *mtcsPass,function *fun)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(mtcsPass);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsInsnAttr *mtcsInsnAttr=mtcs_target_get_insn_attr(mtcsTarget);
   ...
   if (mtcs_insn_attr_get_delay_slots/*!DELAY_SLOTS*/(mtcsInsnAttr))
      return mtcsOptionsItem->x_optimize > 0 && mtcsOptionsItem->x_flag_delayed_branch && !mtcsRtlData/*!crtl*/->dbr_scheduled_p;
   return false;
}

static nuint delay_slots_execute_cb(MtcsPass *mtcsPass,function *func)
{
   MtcsMode *mtcsMode=MTCS_GET_MODE_OBJECT(mtcsPass);
   MtcsTarget *mtcsTarget=(MtcsTarget *)mtcsMode->target;
   MtcsRtlPassMgr *mtcsRtlPassMgr = mtcs_target_get_rtl_pass_mgr(mtcsTarget);
   MtcsReorg *mtcsReorg = mtcs_rtl_pass_mgr_get_reorg(mtcsRtlPassMgr);

   rest_of_handle_delay_slots (mtcsReorg);
   return 0;
}

static void mtcsPassDelaySlotsInit(MtcsPassDelaySlots *self)
{
   MtcsPass *mtcsPass= (MtcsPass *)self;
   mtcsPass->execute =delay_slots_execute_cb;
   mtcsPass->gate =delay_slots_gate_cb;
   mtcs_pass_set_properties(mtcsPass,
...
{
   MtcsPassDelaySlots *self = n_slice_alloc0 (sizeof(MtcsPassDelaySlots));
   mtcs_component_set_mode((MtcsComponent*)self,mtcsMode);
   mtcs_pass_init((MtcsPass *)self,RTL_PASS,"dbr");
   mtcsPassDelaySlotsInit(self);
   return self;
}
