...
public:
  ...
  const mtcs_predefined_function_abi *abi () const { return m_abi; }
...
private:
  ebb_call_clobbers_info (const mtcs_predefined_function_abi *);

  // The values returned by the accessors above.
  ebb_call_clobbers_info *m_next;
  const mtcs_predefined_function_abi *m_abi;
};

// A list of ebb_call_clobbers_infos.
using ebb_call_clobbers_iterator = list_iterator<ebb_call_clobbers_info, &ebb_call_clobbers_info::next>;
...
}//end namespace mtcs_rtl_ssa

//void mtcs_rtl_ssa_dump (FILE *, const mtcs_rtl_ssa::bb_info *);
//void mtcs_rtl_ssa_dump (FILE *, const mtcs_rtl_ssa::ebb_call_clobbers_info *);
//void mtcs_rtl_ssa_dump (FILE *, const mtcs_rtl_ssa::ebb_info *);
//
//void DEBUG_FUNCTION mtcs_rtl_ssa_debug (const mtcs_rtl_ssa::bb_info *);
//void DEBUG_FUNCTION mtcs_rtl_ssa_debug (const mtcs_rtl_ssa::ebb_call_clobbers_info *);
//void DEBUG_FUNCTION mtcs_rtl_ssa_debug (const mtcs_rtl_ssa::ebb_info *);

void dump (FILE *, const mtcs_rtl_ssa::bb_info *);
void dump (FILE *, const mtcs_rtl_ssa::ebb_call_clobbers_info *);
void dump (FILE *, const mtcs_rtl_ssa::ebb_info *);

void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::bb_info *);
void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::ebb_call_clobbers_info *);
void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::ebb_info *);
