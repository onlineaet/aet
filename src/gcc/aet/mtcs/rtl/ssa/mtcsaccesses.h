...
void dump (FILE *, mtcs_rtl_ssa::resource_info);
void dump (FILE *, const mtcs_rtl_ssa::access_info *,
      unsigned int flags = mtcs_rtl_ssa::PP_ACCESS_DEFAULT);
void dump (FILE *, mtcs_rtl_ssa::access_array,
      unsigned int flags = mtcs_rtl_ssa::PP_ACCESS_DEFAULT);
void dump (FILE *, const mtcs_rtl_ssa::def_node *);
void dump (FILE *, mtcs_rtl_ssa::def_mux);
void dump (FILE *, mtcs_rtl_ssa::def_lookup);
void dump (FILE *, mtcs_rtl_ssa::def_splay_tree);

void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::resource_info *);
void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::access_info *);
void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::access_array);
void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::def_node *);
void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::def_mux &);
void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::def_lookup &);
void DEBUG_FUNCTION debug (const mtcs_rtl_ssa::def_splay_tree &);
