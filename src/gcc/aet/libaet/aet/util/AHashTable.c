...
#undef EVICT_KEYVAL
   ...
   */
   ...
   static aboolean aulongEqual(aconstpointer v1,aconstpointer v2){
      return *((const aulong*) v1) == *((const aulong*) v2);
   }

   static auint aulongHash(aconstpointer v){
      return (auint) *(const aulong*) v;
   }

   static aboolean auint64Equal(const auint64 *v1,const auint64 *v2){
      return *v1==*v2;
   }

   static auint auint64Hash(const auint64 *v1){
      return *v1;
   }
